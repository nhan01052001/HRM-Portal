...
export default class SalChangePassword extends Component {
    constructor(porps) {
        super(porps);
    ...
    onSubmitNewPass = () => {
        ...
        HttpService.Post('[URI_SYS]/Sys_GetData/ConfirmChangePasswordPayslip', data).then(res => {
            VnrLoadingSevices.hide();
            if (res) {
                if (res.Success) {
                    ...
                    ToasterSevice.showError(res.Messenger, 3000);
                }
            } else {
                                ...
                                <View style={styles.formControl}>
                                    <View style={styles.control}>
                                        <TextInput
                                            ...
                                            //autoFocus={true}
                                            placeholder={translate('HRM_System_ChanPaySPass_OldPass')}
                                ...
                                <View style={styles.formControl}>
                                    <View style={styles.control}>
                                        <TextInput
                                            ...
                                            autoCapitalize={'none'}
                                            placeholder={translate('HRM_System_ChanPaySPass_ReType')}
                                            style={[styleSheets.text, styles.inputStyle]}
