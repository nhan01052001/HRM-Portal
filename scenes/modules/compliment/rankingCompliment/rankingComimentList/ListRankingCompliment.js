...
import ItemRankingCompliment from './ItemRankingCompliment';
import ItemRankingCriteriaComCompliment from './ItemRankingCriteriaComCompliment';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
import BottomAction from './BottomAction';

const heightActionBottom = 45;

export default class ListRankingCompliment extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                            ...
                            >
                                <View style={styles.styleViewBorderButtom}>
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {this.props?.detail?.screenName === ScreenName.RankingCriteria ? (
                                            <ItemRankingCriteriaComCompliment
                                                key={index}
                                                ...
                                                screenName={this.props?.detail?.screenName}
