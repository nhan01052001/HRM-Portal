...
let configList = null,
    enumName = null,
    taxSubmitTaxInformationRegister = null,
    taxSubmitTaxInformationRegisterAddOrEdit = null,
    taxSubmitTaxInformationRegisterViewDetail = null,
    taxSubmitTaxInformationRegisterTask = null,
    pageSizeList = 20;

class TaxSubmitTaxInformationRegister extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (paramsFilter) => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: taxSubmitTaxInformationRegisterTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!configList[taxSubmitTaxInformationRegister]) {
            configList[taxSubmitTaxInformationRegister] = {
                Api: {
        ...
        const _configList = configList[taxSubmitTaxInformationRegister],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == taxSubmitTaxInformationRegisterTask) {
    ...
    componentDidMount() {
        ...
        taxSubmitTaxInformationRegisterViewDetail = ScreenName.TaxSubmitTaxInformationRegisterViewDetail;

        taxSubmitTaxInformationRegisterTask = EnumTask.KT_TaxSubmitTaxInformationRegister;

        TaxSubmitTaxInformationRegisterBusinessFunction.setThisForBusiness(this);
    ...
    render() {
        ...
        return (
            <SafeAreaView {...styleSafeAreaView}>
                {taxSubmitTaxInformationRegister && taxSubmitTaxInformationRegisterViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <TaxInformationRegisterList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: taxSubmitTaxInformationRegisterViewDetail,
                                        screenName: taxSubmitTaxInformationRegister
                                    }}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={taxSubmitTaxInformationRegisterTask}
                            ...
                            {PermissionForAppMobile &&
                                ...
                                <VnrBtnCreate
                                    onAction={() => {
                                        DrawerServices.navigate(taxSubmitTaxInformationRegisterAddOrEdit, {
                                            reload: () => this.reload()
                                        });
                                    }}
                                />
...
export default connect(mapStateToProps, null)(TaxSubmitTaxInformationRegister);
