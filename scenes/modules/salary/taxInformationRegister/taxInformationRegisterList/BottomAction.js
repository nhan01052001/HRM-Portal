...
import { Colors, styleVnrListItem, styleSheets } from '../../../../../constants/styleConfig';
        ...
        return (
            <View style={[BottomActions.actionHeader, { minHeight: this.props.heightAction }]}>
                <View style={BottomActions.itemaACtionleft}>
                    {/* <View style={isCheck.disable ? { opacity: .5 } : { opacity: 1 }}>
                        <TouchableHighlight activeOpacity={isCheck.disable ? 1 : .8}
                            ...
                            {
                                !isCheck.value ? (<VnrText style={[styleSheets.text, { color: Colors.gray_10 }]} i18nKey={"SELECT_ALL"} value={"select all"} />)
                                    : (<VnrText style={[styleSheets.text, { color: Colors.gray_10 }]} i18nKey={"UNSELECT_ALL"} value={"Unselect all"} />)
                            }
                        </TouchableHighlight>
                    </View> */}
                    <View style={isCheckServer.disable ? styleSheets.opacity05 : styleSheets.opacity1}>
                        <TouchableHighlight
