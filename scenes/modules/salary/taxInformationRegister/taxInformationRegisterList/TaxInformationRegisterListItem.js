...
export default class TaxInformationRegisterListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        viewRate = (
            <View style={[styles.lineLeft, styles.styViewRateBorder]}>
                <View style={styles.line_date_row}>
                    <VnrText
                        i18nKey={'HRM_Attendance_RegisterVehicle_RegisterPurpose'}
                        style={[styleSheets.text, styles.line_lable, styles.styTextWitdh]}
                    />
                    <View style={[styles.line_time_wrap, styles.styTextWitdh]}>
                        <Text style={[styleSheets.text, styles.line_text, styles.styTxtAlign]} numberOfLines={2}>
                            {dataItem.PurposeRegisterName ? dataItem.PurposeRegisterName : ''}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.line_date_row}>
                    <VnrText
                        i18nKey={'HRM_Attendance_RegisterVehicle_PlaceFrom'}
                    ...
                    <View style={styles.line_time_wrap}>
                        <Text style={[styleSheets.text, styles.line_text]} numberOfLines={1}>
                            {dataItem.PlaceFrom ? dataItem.PlaceFrom : ''}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.line_date_row}>
                    <VnrText
                        i18nKey={'HRM_Attendance_RegisterVehicle_PlaceTo'}
                        style={[styleSheets.text, styles.line_lable]}
                    />
                    <View style={styles.line_time_wrap}>
                        <Text style={[styleSheets.text, styles.line_text]} numberOfLines={1}>
                            {dataItem.PlaceTo ? dataItem.PlaceTo : ''}
                        </Text>
                    </View>
                </View>
                ...
                {/* Thời gian */}
                <View style={styles.line_date_row}>
                    <VnrText i18nKey={'HRM_ProfileMoreInfo_Time'} style={[styleSheets.text, styles.line_lable]} />
                    <View style={styles.line_time_wrap}>
                        <Text style={[styleSheets.text, styles.line_text]} numberOfLines={1}>
                            {textFieldDate}
                        </Text>
            ...
            >
                ...
                >
                    ...
                    <View style={[styles.container]} key={index}>
                        <View style={styles.Line}>{viewRate}</View>
                        <View style={styles.viewReason}>
                            <Text numberOfLines={2} style={[styleSheets.textItalic, styles.viewReason_text]}>
                                {dataItem.Note !== null
                                    ? `${translate('HRM_Attendance_RegisterVehicle_Note')}: ${dataItem.Note}`
                                    : `${translate('HRM_Attendance_RegisterVehicle_Note')}: Gặp khách hàng`}
                            </Text>
                        </View>
...
const styles = StyleSheet.create({
    styIsSelected: { borderColor: Colors.primary, borderWidth: 1 },
    styTxtAlign: { textAlign: 'right' },
    styTextWitdh: { width: '50%' },
    styViewRateBorder: { borderRightWidth: 0 },
    swipeable: {
        flex: 1,
