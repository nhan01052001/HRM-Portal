...
import SalPITAmountListItem from './SalPITAmountListItem';
import { EnumName } from '../../../../../assets/constant';

export default class SalPITAmountList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            itemSelected: [],
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (
            ...
            nextState.footerLoading !== this.state.footerLoading
        ) {
            return true;
        }
    }
                ...
                {isLoading ? (
                    ...
                    <FlatList
                        ...
                        renderItem={({ item, index }) => (
                            <View style={[styles.styViewItemList]}>
                                <View style={CustomStyleSheet.flex(1)}>
                                    <SalPITAmountListItem
                                        ...
                                        moveToDetail={() => this.moveToDetail(item)}
                                        rowActions={
...
const styles = StyleSheet.create({
    styViewItemList: { flex: 1, flexDirection: 'row' },
    styLoadingView: { flex: 1, marginBottom: 60 }
});
