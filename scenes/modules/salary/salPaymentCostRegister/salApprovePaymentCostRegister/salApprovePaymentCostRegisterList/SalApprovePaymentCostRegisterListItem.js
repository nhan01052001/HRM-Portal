...
export default class SalApprovePaymentCostRegisterListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        const configShowData = [
            ...
            {
                DisplayKey: 'HRM_PortalApp_TotalAmount',
                Value: 'TotalAmount'
            }
        ];
