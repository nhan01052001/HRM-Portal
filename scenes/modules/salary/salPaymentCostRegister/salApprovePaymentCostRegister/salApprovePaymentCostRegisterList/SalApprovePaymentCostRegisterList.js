...
import SalApprovePaymentCostRegisterListItem from './SalApprovePaymentCostRegisterListItem';
import Vnr_Services from '../../../../../../utils/Vnr_Services';
const heightActionBottom = 45;

export default class SalApprovePaymentCostRegisterList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                ...
                .then((resData) => {
                    ...
                    if (res && res !== EnumName.E_EMPTYDATA) {
                        ...
                        data.map((item) => {
                            ...
                            if (detail?.screenName === ScreenName.SalWaitApprovePaymentCostRegister) {
                                item.BusinessAllowAction = 'E_APPROVE, E_REJECT, E_FEECHECK';
                            }
                        });
            ...
            contentList = (
                <FlatList
                    ...
                    contentContainerStyle={
                        isOpenAction ? CustomStyleSheet.paddingTop(0) : { paddingTop: Size.defineHalfSpace }
                    }
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        <SalApprovePaymentCostRegisterListItem
