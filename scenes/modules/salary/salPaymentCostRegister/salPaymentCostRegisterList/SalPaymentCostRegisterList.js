...
import SalPaymentCostRegisterListItem from './SalPaymentCostRegisterListItem';
const heightActionBottom = 45;

export default class SalPaymentCostRegisterList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        <SalPaymentCostRegisterListItem
