...
export default class SalPaymentCostRegisterListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            >
                <View
                    style={[
                        ...
                        (dataItem.WarningViolation || dataItem.IsExistPaymentCost === 'False') && { borderColor: Colors.red, borderWidth: 1 }
                    ]}
                >
                    {isOpenAction && (
                    ...
                    <View style={[styles.container]}>
                        <View style={styles.Line}>
                            <View style={styles.lineLeft}>
                                <View style={styles.line_date_row}>
                                    <VnrText
                                        i18nKey={'HRM_Sal_PaymentCostRegister_RequestPeriod'}
                                    ...
                                    <View style={styles.line_time_wrap}>
                                        <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                            {dataItem.RequestPeriodName != null ? dataItem.RequestPeriodName : ''}
                                        </Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.line_date_row}>
                                    <VnrText
                                        i18nKey={'HRM_Sal_PaymentCostRegister_PayPeriod'}
                                        style={[styleSheets.text, styles.line_value_lable]}
                                    />
                                    <View style={styles.line_time_wrap}>
                                        <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                            {dataItem.PaymentPeriodName != null ? dataItem.PaymentPeriodName : ''}
                                        </Text>
                                    </View>
                                </View>
                            </View>
                            ...
                            <View style={styles.lineRight}>
                                <View style={styles.line_date_row}>
                                    <View style={styles.line_time_wrap}>
                                        <VnrText
                                            i18nKey={'SumAmount'}
                                            style={[styleSheets.text, styles.line_cost_lable]}
                                        />
                                    </View>
                                </View>
                        ...
                        {dataItem.DataNote != null && dataItem.DataNote !== '' && (
