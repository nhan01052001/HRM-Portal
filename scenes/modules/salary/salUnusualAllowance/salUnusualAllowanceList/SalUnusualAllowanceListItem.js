    ...
    render() {
        ...
        return (
            ...
            >
                    ...
                    <View style={[styles.container]} key={index}>
                        <View style={styles.line}>
                            <View style={styles.line_date_row}>
                                <VnrText
                                    i18nKey={'HRM_Payroll_UnusualED_UnusualEDTypeID'}
                                ...
                                <View style={styles.line_time_wrap}>
                                    <Text style={[styleSheets.text, styles.line_text]} numberOfLines={1}>
                                        {dataItem.UnusualAllowanceCfgName ? dataItem.UnusualAllowanceCfgName : ''}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.line_date_row}>
                                <VnrText
                                    i18nKey={'HRM_Payroll_UnusualED_MonthStart'}
                                    style={[styleSheets.text, styles.line_date_text]}
                                />

                                <View style={styles.line_time_wrap}>
                                    <Text style={[styleSheets.text, styles.line_text]}>
                                        {dataItem.MonthStart ? moment(dataItem.MonthStart).format('MM/YYYY') : ''}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.line_date_row}>
                                <VnrText
                                    i18nKey={'HRM_Category_UsualAllowanceLevel_Amount'}
                                    style={[styleSheets.text, styles.line_date_text]}
                                />
                                <Text style={[styleSheets.text, styles.line_text]}>
                                    {dataItem.Amount != null && dataItem.CurrencyName != null
                                        ? `${format('#,###.#', dataItem.Amount)} ${dataItem.CurrencyName}`
                                        : ''}
                                </Text>
                            </View>
                        </View>
                ...
                {
                  listConfigRoster.map(item => (
                    <View style={styles.styRosterItem}>
                      <VnrText
                        i18nKey={item.DisplayKey}
                        style={[styleSheets.text, styles.styRosterItem_lable]}
                      />

                      <Text style={[styleSheets.text, styles.styRosterItem_text]} numberOfLines={1} >
                        ...
                        <View style={styles.viewStatusBottom}>
                            ...
                            >
                                ...
                                >
                                    {dataItem.StatusTranslateView ? dataItem.StatusTranslateView : ''}
                                </Text>
                            </View>
                        </View>
                    </View>
