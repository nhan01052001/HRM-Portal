...
import SalUnusualAllowanceListItem from './SalUnusualAllowanceListItem';
const heightActionBottom = 45;

export default class SalUnusualAllowanceList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
