...
export default class SalApprovedPITFinalizationViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (E_KEEP_FILTER, actionIsDelete) => {
        ...
        if (actionIsDelete) {
            DrawerServices.navigate(ScreenName.SalApprovedPITFinalization);
        } else {
    ...
    componentDidMount() {
        SalApprovedPITFinalizationBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
