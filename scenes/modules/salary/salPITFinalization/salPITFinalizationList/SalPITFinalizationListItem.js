...
export default class SalApprovePITFinalizationListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        viewRate = (
            <View style={[styles.lineLeft, styles.styViewRateLineExtend]}>
                <View style={styles.line_date_row}>
                    ...
                    <View style={[styles.line_time_wrap]}>
                        <Text style={[styleSheets.text, styles.line_text, styles.styTextAlignRight]} numberOfLines={1}>
...
const styles = StyleSheet.create({
    ...
    styViewRateLineExtend: { borderRightWidth: 0 },
    swipeable: {
        flex: 1,
