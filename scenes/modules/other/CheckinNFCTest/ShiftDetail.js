            ...
            <SafeAreaView {...styleSafeAreaView}>
                        ...
                        <View style={styles.container}>
                            ...
                            <View style={styles.ShiftTotalView}>
                                ...
                                <View style={styles.viewValueTotalHour}>
                                    <Text style={[styleSheets.lable, styles.styTextValueToTalHour]}>
                                        {valueHoursTotal}
                                    </Text>
                                    <VnrText style={styleSheets.text} i18nKey={'E_IMPORT_FILE_HOUR'} />
                                    <Text style={[styleSheets.lable, styles.styTextMinutesTotalValue]}>
                                        {valueMinutesTotal}
                                    </Text>
                ...
                >
                    <View style={styles.viewEditModal}>
                        <SafeAreaView {...styleSafeAreaView} style={styles.stySafeAreaViewEx}>
                            <KeyboardAwareScrollView
                                keyboardShouldPersistTaps={'handled'}
                                contentContainerStyle={CustomStyleSheet.flexGrow(1)}
                                enableOnAndroid={false}
                            >
                                ...
                                <View style={CustomStyleSheet.flex(1)}>
                                    ...
                                    <View style={styles.styleViewHoursContentModal}>
                                        ...
                                        />
                                        <View style={styles.viewValueTotalHour}>
                                            <Text style={[styleSheets.lable, styles.styTextTotalUpdatehours]}>
                                                {valueHoursTotalUpdate}
                                            </Text>
                                            <VnrText style={styleSheets.text} i18nKey={'E_IMPORT_FILE_HOUR'} />
                                            <Text style={[styleSheets.lable, styles.styTextTotalUpdateMinutes]}>
                                                {valueMinutesTotalUpdate}
                                            </Text>
                                            <VnrText style={styleSheets.text} i18nKey={'E_IMPORT_FILE_MINUTE'} />
                                        </View>
...
const styles = StyleSheet.create({
    ...
    stySafeAreaViewEx: { flex: 1, borderTopLeftRadius: 15, borderTopRightRadius: 15 },
    styTextTotalUpdateMinutes: { fontSize: Size.text + 3, paddingLeft: 5, paddingBottom: 0 },
    styTextTotalUpdatehours: { fontSize: Size.text + 3, paddingBottom: 0 },
    styTextValueToTalHour: { fontSize: Size.text + 3, paddingBottom: 0 },
    container: {
        flex: 1,
