...
const arrImageLangVN = [
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Vào <Text style={[styles.styTextImage]}>cài đặt</Text> tại giao diện chính của điện thoại.
            </Text>
        ),
    ...
    },
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Chọn <Text style={[styles.styTextImage]}>quyền riêng tư</Text>{' '}
            </Text>
        ),
    ...
    },
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Chọn <Text style={[styles.styTextImage]}>dịch vụ định vị</Text> {'->'} Kéo để bật lên.{' '}
            </Text>
        ),
    ...
    },
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Chọn <Text style={[styles.styTextImage]}>ứng dụng</Text> {'->'} cho phép{' '}
                <Text style={[styles.styTextImage]}>VnResource HRM Pro</Text> cập nhật vị trí{' '}
            </Text>
        ),
...
const styles = StyleSheet.create({
    styTextImage: { fontWeight: 'bold', fontSize: Size.text + 2 },
    cardItem: {
