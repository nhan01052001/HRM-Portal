...
const arrImageLangEN = [
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Go to <Text style={[styles.styTextImage]}>settings</Text> at the main interface of the phone
            </Text>
        ),
    ...
    },
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Choose <Text style={[styles.styTextImage]}>Privacy</Text>{' '}
            </Text>
        ),
    ...
    },
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Choose <Text style={[styles.styTextImage]}>Location services</Text> {'->'} Drag to turn on.{' '}
            </Text>
        ),
    ...
    },
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Choose <Text style={[styles.styTextImage]} /> {'->'} allow VnResource HRM Pro to update location{' '}
            </Text>
        ),
