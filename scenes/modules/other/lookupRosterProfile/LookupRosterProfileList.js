...
import LookupRosterProfileItem from './LookupRosterProfileItem';
import { EnumStatus } from '../../../../assets/constant';
import VnrLoadingScreen from '../../../../components/VnrLoading/VnrLoadingScreen';

export default class LookupRosterProfileList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            itemSelected: [],
