...
import LookupProfileItem from './LookupProfileItem';
import { EnumStatus } from '../../../../assets/constant';
import VnrLoadingScreen from '../../../../components/VnrLoading/VnrLoadingScreen';

export default class LookupProfileList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            itemSelected: [],
    ...
    _renderLoading = () => {
        return (
            <View style={styles.styLoadingRender}>
...
const styles = StyleSheet.create({
    ...
    styLoadingRender: { flex: 1, paddingVertical: styleSheets.p_10 }
});
