...
let chOrgProfileChart = null,
    chOrgProfileChartKeyTask = null;

class ChOrgProfileChart extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (paramsFilter) => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: chOrgProfileChartKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == chOrgProfileChartKeyTask) {
    ...
    componentDidMount() {
        chOrgProfileChart = ScreenName.ChOrgProfileChart;
        chOrgProfileChartKeyTask = EnumTask.KT_ChOrgProfileChart;
        //set by config
    ...
    render() {
        const { dataBody, keyQuery, isLazyLoading, isRefreshList, dataChange } = this.state;
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {chOrgProfileChart && chOrgProfileChartKeyTask && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <ChWebViewChart
                                    ...
                                    keyDataLocal={chOrgProfileChartKeyTask}
...
export default connect(mapStateToProps, null)(ChOrgProfileChart);
