...
export default class ChEmployeeEarly extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
    ...
    render() {
        const configEmployeeAge = ConfigChart.value['ChEmployeeEarly'],
            { api } = configEmployeeAge;
        return (
            <SafeAreaView {...styleSafeAreaView}>
                <VnrChartPie api={api} groupFeild={'Status_Out'} />
            </SafeAreaView>
        );
    }
}
