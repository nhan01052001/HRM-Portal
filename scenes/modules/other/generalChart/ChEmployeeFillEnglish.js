...
export default class ChEmployeeFillEnglish extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
    ...
    render() {
        const configEmployeeAge = ConfigChart.value['ChEmployeeFillEnglish'],
            { api } = configEmployeeAge;
        return (
            <SafeAreaView {...styleSafeAreaView}>
                <VnrChartPie api={api} groupFeild={'TrangThai'} />
            </SafeAreaView>
        );
    }
}
