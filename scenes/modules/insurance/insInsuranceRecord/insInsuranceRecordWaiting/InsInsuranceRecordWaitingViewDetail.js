...
export default class InsInsuranceRecordWaitingViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
                ...
                <View style={styleSheets.container}>
                    <ScrollView style={CustomStyleSheet.flexGrow(1)}>
                        <View
                            style={[
                                containerItemDetail,
                                dataItem.isGroup && styles.styIsGroupExtend
                            ]}
                        >
...
const styles = StyleSheet.create({
    styIsGroupExtend: { paddingHorizontal: 0,
