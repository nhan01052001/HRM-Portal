                    ...
                    <View style={[styles.container]} key={index}>
                        <View style={styles.Line}>
                            <View style={styles.lineLeft}>
                                {dataItem.InsuranceTypeView != null && (
                                    <View style={styles.line_date_row}>
                                        <VnrText
                                            i18nKey={'HRM_Insurance_InsuranceRecord_InsuranceType'}
                        ...
                        <View style={styles.viewStatusBottom}>
                            ...
                            >
                                ...
                                >
                                    {dataItem.DocumentStatusView ? dataItem.DocumentStatusView : ''}
                                </Text>
                            </View>
                        </View>
