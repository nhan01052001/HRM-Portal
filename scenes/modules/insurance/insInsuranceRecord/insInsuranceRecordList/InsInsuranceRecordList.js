...
import InsInsuranceRecordListItem from './InsInsuranceRecordListItem';
import InsInsuranceRecordWaitingListItem from './InsInsuranceRecordWaitingListItem';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class InsInsuranceRecordList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    _renderFooterLoading = () => {
        return (
            <View style={styles.styViewFooterLoading}>
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.InsInsuranceRecordWaiting ? EnumStatus.E_APPROVE : EnumStatus.E_SUBMIT;
            contentList = (
                <VnrLoadingScreen
                    size="large"
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.InsInsuranceRecordWaiting ? (
                                            <InsInsuranceRecordWaitingListItem
