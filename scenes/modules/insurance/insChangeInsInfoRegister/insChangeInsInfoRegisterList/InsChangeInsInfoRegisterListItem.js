...
export default class InsInsuranceRecordListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                >
                    {isOpenAction && (
                        <View style={[styles.selectView, isDisable ? styleSheets.opacity05 : styleSheets.opacity1]}>
                            ...
                            >
                                <View
                                    style={[styles.selectViewCircle, !this.props.isSelect && styles.styIsSelectedView]}
                                >
                                    {this.props.isSelect && (
                        ...
                        <View style={styles.Line}>
                            <View style={styles.lineLeft}>
                                <View style={styles.line_date_row}>
                                    <VnrText
                                        i18nKey={'HRM_Attendance_Overtime_DurationType'}
