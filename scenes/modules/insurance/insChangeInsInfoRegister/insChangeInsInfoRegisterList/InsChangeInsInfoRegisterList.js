...
import InsChangeInsInfoRegisterListItem from './InsChangeInsInfoRegisterListItem';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class InsChangeInsInfoRegisterList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {/* {
                                            (detail.screenName == ScreenName.HreApproveEvaluationDoc ||
                                                detail.screenName == ScreenName.HreApprovedEvaluationDoc)
                                                ?
                                                (
                                                    <InsChangeInsInfoRegisterListItemApprove
                                                        currentDetail={detail}
                                                        onClick={() => { isOpenAction == true ? this.addItemChecked(index) : null }}
                                                ...
                                                : ( */}
                                        <InsChangeInsInfoRegisterListItem
                                            currentDetail={detail}
                                            onClick={() => {
