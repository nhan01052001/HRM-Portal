...
export default class AttDelegationApprovalListItem extends VnrRenderListItem {
    ...
    renderProfileView = (dataItem, itemConfig, renderConfig) => {
        let isHaveAvatar = dataItem?.UserDelegateName ? true : false;
                    ...
                    <View>
                        {isHaveAvatar
                            && Vnr_Function.renderAvatarCricleByName(
                                dataItem?.ImagePath,
                                dataItem?.UserDelegateName,
                                38
                            )}
                    </View>

                    <View style={[CustomStyleSheet.marginLeft(6), CustomStyleSheet.justifyContent('center')]}>
                        <Text numberOfLines={2} style={[styleSheets.lable, CustomStyleSheet.fontSize(16)]}>{dataItem?.UserDelegateName}</Text>
                        <Text numberOfLines={2} style={styleSheets.text}>{dataItem?.E_DEPARTMENT}</Text>
                    </View>
                </View>
