...
export default class AttDelegationApprovalListItemApprove extends VnrRenderListItem {
    ...
    renderProfileView = (dataItem, itemConfig, renderConfig) => {
        let isHaveAvatar = false,
            subProfile = [];
        isHaveAvatar = dataItem?.UserName ? true : false;
                    ...
                    itemConfig?.TypeView === 'E_PROFILE' && (
                        <View style={[styles.wh69]}>
                            ...
                            <View style={[CustomStyleSheet.marginLeft(6), CustomStyleSheet.justifyContent('center')]}>
                                <Text numberOfLines={2} style={[styleSheets.lable, CustomStyleSheet.fontSize(16)]}>{dataItem?.UserName}</Text>
