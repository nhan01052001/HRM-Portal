...
let configList = null,
    enumName = null,
    attConfirmedDelegationApproval = null,
...
class AttConfirmedDelegationApproval extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttConfirmDelegationApprovalBusiness.checkForReLoadScreen[attConfirmedDelegationApproval]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttConfirmDelegationApprovalBusiness.checkForReLoadScreen[attConfirmedDelegationApproval] = false;
    ...
    paramsDefault = () => {
        if (!attConfirmedDelegationApproval) {
            attConfirmedDelegationApproval = ScreenName.AttConfirmedDelegationApproval;
        }
        if (!configList[attConfirmedDelegationApproval]) {
            configList[attConfirmedDelegationApproval] = {
                Api: {
        ...
        const _configList = configList[attConfirmedDelegationApproval],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        dataRowActionAndSelected = generateRowActionAndSelected(attConfirmedDelegationApproval);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttConfirmedDelegationApproval;
        AttConfirmDelegationApprovalBusiness.checkForReLoadScreen[attConfirmedDelegationApproval] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attConfirmedDelegationApproval && attConfirmDelegationApprovalViewDetail && enumName && (
