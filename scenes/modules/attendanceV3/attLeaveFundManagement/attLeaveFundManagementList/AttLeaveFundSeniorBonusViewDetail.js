...
let configList = null,
    enumName = null,
    attLeaveFundSeniorBonusViewDetail = null,
    attLeaveFundSeniorBonusViewDetailKeyTask = null,
    pageSizeList = 20;

class AttLeaveFundSeniorBonusViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (paramsFilter) => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: attLeaveFundSeniorBonusViewDetailKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    remoteData = (isLazyLoading) => {
        ...
        getDataLocal(EnumTask.KT_AttLeaveFundSeniorBonusViewDetail)
            .then((resData) => {
    ...
    paramsDefault = () => {
        const _configList = configList[attLeaveFundSeniorBonusViewDetail],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        const { keyQuery } = this.state;
        if (nextProps.reloadScreenName == attLeaveFundSeniorBonusViewDetailKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.AttLeaveFundSeniorBonusViewDetail]) {
            ConfigList.value[ScreenName.AttLeaveFundSeniorBonusViewDetail] = {
                Order: [
                    {
                        field: 'TimeLog',
                        dir: 'desc'
                ...
                Row: [
                    {
                        TypeView: 'E_COMMON',
                        Name: 'SeniorityYears',
                        DisplayKey: 'HRM_PortalApp_AttLeaveFund_SeniorityYears',
                        DataType: 'string'
                    },
                    {
                        TypeView: 'E_COMMON',
                        Name: 'Used',
                        DisplayKey: 'HRM_PortalApp_AttLeaveFund_UsedDate',
                        DataType: 'string'
                    },
                    {
                        TypeView: 'E_COMMON',
                        Name: 'SeniorityDate',
                        DisplayKey: 'HRM_PortalApp_AttLeaveFund_SeniorityDate',
                        DataType: 'datetime',
                    ...
                    },
                    {
                        TypeView: 'E_COMMON',
                        Name: 'Remain',
                        DisplayKey: 'HRM_PortalApp_AttLeaveFund_RemainSenior',
                        DataType: 'string'
                    },
                    {
                        TypeView: 'E_COMMON',
                        Name: 'ExpiryDate',
                        DisplayKey: 'HRM_PortalApp_AttLeaveFund_ExpiryDate',
                        DataType: 'datetime',
                        DataFormat: 'DD/MM/YYYY'
                    },
                    {
                        TypeView: 'E_COMMON',
                        Name: 'AnlLeaveDays',
                        DisplayKey: 'HRM_PortalApp_AttLeaveFund_AnlLeaveDays',
                        DataType: 'string'
                    },
                    {
                        TypeView: 'E_COMMON',
                        Name: 'DateReceived',
                        DisplayKey: 'HRM_PortalApp_AttLeaveFund_DateReceived',
                        DataType: 'datetime',
                        DataFormat: 'DD/MM/YYYY'
                    }
                ],
        ...
        attLeaveFundSeniorBonusViewDetail = ScreenName.AttLeaveFundSeniorBonusViewDetail;
        attLeaveFundSeniorBonusViewDetailKeyTask = EnumTask.KT_AttLeaveFundSeniorBonusViewDetail;
        //set by config
    ...
    render() {
        const { totalLeave, leaveReman, leaveTaken, dataSource, renderRow, isLoading } = this.state;
                    ...
                    {dataSource.length > 0 && (
                        <View style={[CustomStyleSheet.flex(1)]}>
                            <View style={styles.titleDetail}>
                                ...
                                >
                                    {translate('HRM_PortalApp_TerminationOfWork_DetailedInformation')}
                                </Text>
                            </View>
                                ...
                                return (
                                    ...
                                    >
                                        {renderRow.map((item, i) => {
                                            return (
                                                <View key={i} style={[CustomStyleSheet.paddingRight(16)]}>
...
const styles = StyleSheet.create({
    styItemRow: { backgroundColor: Colors.white,
...
export default connect(mapStateToProps, null)(AttLeaveFundSeniorBonusViewDetail);
