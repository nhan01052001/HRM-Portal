...
import { generateRowActionAndSelected, AttApproveWorkingOvertimeBusiness } from '../AttApproveWorkingOvertimeBusiness';
...
let configList = null,
    enumName = null,
    attAllWorkingOvertime = null,
    attApproveWorkingOvertime = null,
    attApproveWorkingOvertimeViewDetail = null,
    keyListTask = null,
    pageSizeList = 20;

class AttAllWorkingOvertime extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveWorkingOvertimeBusiness.checkForReLoadScreen[attAllWorkingOvertime]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttApproveWorkingOvertimeBusiness.checkForReLoadScreen[attAllWorkingOvertime] = false;
    ...
    paramsDefault = () => {
        if (!attAllWorkingOvertime) {
            attAllWorkingOvertime = ScreenName.AttAllWorkingOvertime;
        }
        if (!configList[attAllWorkingOvertime]) {
            configList[attAllWorkingOvertime] = {
                Api: {
                    urlApi: '[URI_CENTER]/api/Att_OvertimePlan/New_PlanOvertimeApproveAndAfterBrowsing_App',
                    type: 'POST',
                    pageSize: 20
                },
                Order: [
                ...
                BusinessAction: [
                    ...
                    },
                    {
                        Type: 'E_CANCEL',
                        Resource: {
                            Name: 'New_Att_PlanOvertimeWaitingApprove_New_Index_btnCancel',
                            Rule: 'View'
                        },
                        Confirm: {
                            isInputText: true,
        ...
        const _configList = configList[attAllWorkingOvertime],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attAllWorkingOvertime);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttAllWorkingOvertime;
        AttApproveWorkingOvertimeBusiness.checkForReLoadScreen[attAllWorkingOvertime] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attAllWorkingOvertime && attApproveWorkingOvertimeViewDetail && enumName && (
