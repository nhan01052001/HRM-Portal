...
export default class AttApproveWorkingOvertimeViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
            configListDetail: null,
            dataRowActionAndSelected: generateRowActionAndSelected(ScreenName.AttApproveWorkingOvertime),
    ...
    getDataItem = async () => {
        try {
            const _params = this.props.navigation.state.params,
                ...
                _configListDetail = ConfigListDetail.value[ScreenName.AttApproveWorkingOvertime]
                    ? ConfigListDetail.value[ScreenName.AttApproveWorkingOvertime]
                    : configDefault;
