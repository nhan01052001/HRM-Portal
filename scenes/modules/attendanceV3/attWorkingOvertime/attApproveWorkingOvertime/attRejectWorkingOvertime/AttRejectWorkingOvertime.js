...
let configList = null,
    enumName = null,
    attRejectWorkingOvertime = null,
    attApproveWorkingOvertime = null,
    attApproveWorkingOvertimeViewDetail = null,
    keyListTask = null,
    pageSizeList = 20;

class AttRejectWorkingOvertime extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveWorkingOvertimeBusiness.checkForReLoadScreen[attRejectWorkingOvertime]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttApproveWorkingOvertimeBusiness.checkForReLoadScreen[attRejectWorkingOvertime] = false;
    ...
    paramsDefault = () => {
        if (!attRejectWorkingOvertime) {
            attRejectWorkingOvertime = ScreenName.AttRejectWorkingOvertime;
        }
        if (!configList[attRejectWorkingOvertime]) {
            configList[attRejectWorkingOvertime] = {
                Api: {
        ...
        const _configList = configList[attRejectWorkingOvertime],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attRejectWorkingOvertime);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttRejectWorkingOvertime;
        AttApproveWorkingOvertimeBusiness.checkForReLoadScreen[attRejectWorkingOvertime] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attRejectWorkingOvertime && attApproveWorkingOvertimeViewDetail && enumName && (
