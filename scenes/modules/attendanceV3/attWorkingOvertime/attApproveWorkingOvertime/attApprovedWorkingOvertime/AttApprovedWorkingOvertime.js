...
class AttApprovedWorkingOvertime extends Component {
    ...
    reload = paramsFilter => {
        ...
        AttApproveWorkingOvertimeBusiness.checkForReLoadScreen[attApprovedWorkingOvertime] = false;
    ...
    paramsDefault = () => {
        if (!attApprovedWorkingOvertime) {
            attApprovedWorkingOvertime = ScreenName.AttApprovedWorkingOvertime;
        }
        if (!configList[attApprovedWorkingOvertime]) {
            configList[attApprovedWorkingOvertime] = {
                Api: {
        ...
        const _configList = configList[attApprovedWorkingOvertime],
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttApprovedWorkingOvertime;
        AttApproveWorkingOvertimeBusiness.checkForReLoadScreen[attApprovedWorkingOvertime] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attApprovedWorkingOvertime && attApproveWorkingOvertimeViewDetail && enumName && (
