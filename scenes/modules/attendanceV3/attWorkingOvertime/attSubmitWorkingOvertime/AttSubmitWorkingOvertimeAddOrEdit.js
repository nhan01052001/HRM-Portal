...
export default class AttSubmitWorkingOvertimeAddOrEdit extends Component {
  ...
  GetHighSupervior = (OrgStructureTransID = null) => {
      const { Profile } = this.state;
      let params = {};
          ...
          return (
              ...
              DateFromTo.value.length > 0
                  ...
                  DateFromTo.value.length > 1
                          ...
                          value={item === 1 ? (DateFromTo.value ? DateFromTo.value : {}) : [item]}
                          ...
                          onGetHighSupervisorFromOrgStructureTransID={(OrgStructureTransID) => {
                              if (IsHasFormulaTotal) {
                                  this.GetHighSupervior(OrgStructureTransID);
                              }
                          }}
                      />
                  )}
