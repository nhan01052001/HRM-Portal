...
import { generateRowActionAndSelected, AttSubmitTakeDailyTaskBusiness } from './AttSubmitTakeDailyTaskBusiness';
...
const configDefault = [
    ...
    },
    {
        TypeView: 'E_COMMON',
        Name: 'WorkDate',
        DisplayKey: 'HRM_Attendance_Overtime_WorkDate',
        DataType: 'datetime',
    ...
    },
    {
        TypeView: 'E_COMMON',
        Name: 'JobTypeName',
        DisplayKey: 'HRM_Tas_Task_TypeView',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
    ...
    },
    {
        TypeView: 'E_COMMON',
        Name: 'ShopTransName',
        DisplayKey: 'HRM_PortalApp_TransferShopName',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'ActualHours',
        DisplayKey: 'HRM_PortalApp_WorkingHrs',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'OvertimeTypeID1Name',
        DisplayKey: 'HRM_Att_ProfileTimeSheet_OvertimeHours1',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'OvertimeTypeID2Name',
        DisplayKey: 'HRM_Att_ProfileTimeSheet_OvertimeHours2',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'OvertimeTypeID3Name',
        DisplayKey: 'HRM_Att_ProfileTimeSheet_OvertimeHours3',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'Note',
        DisplayKey: 'HRM_PortalApp_ReasonNote',
        DataType: 'string'
    },
    {
...
export default class AttSubmitTakeDailyTaskViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
    ...
    getDataItem = async () => {
        try {
            ...
            if (id) {
                const response = await HttpService.Get(`[URI_CENTER]/api/Att_Roster/GetProfileTimeSheetByID?ID=${id}`);
        ...
        if (dataItem && configListDetail) {
            contentViewDetail = (
                <View style={styleSheets.container}>
                    <AttSubmitTakeDailyTaskAddOrEdit ref={(refs) => (this.AttSubmitTakeDailyTaskAddOrEdit = refs)} />
