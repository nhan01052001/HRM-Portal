...
let configList = null,
    enumName = null,
    attApproveSubmitTakeDailyTask = null,
...
class AttApproveSubmitTakeDailyTask extends Component {
    ...
    reload = paramsFilter => {
        ...
        AttSubmitTakeDailyTaskBusiness.checkForReLoadScreen[attApproveSubmitTakeDailyTask] = false;

        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: attApproveSubmitTakeDailyTaskKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!attApproveSubmitTakeDailyTask) {
            attApproveSubmitTakeDailyTask = ScreenName.AttApproveSubmitTakeDailyTask;
        }
        if (!configList[attApproveSubmitTakeDailyTask]) {
            configList[attApproveSubmitTakeDailyTask] = {
                Api: {
        ...
        const _configList = configList[attApproveSubmitTakeDailyTask],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == attApproveSubmitTakeDailyTaskKeyTask) {
    ...
    componentDidMount() {
        ...
        attApproveSubmitTakeDailyTaskKeyTask = EnumTask.KT_AttApproveSubmitTakeDailyTask;
        AttSubmitTakeDailyTaskBusiness.checkForReLoadScreen[attApproveSubmitTakeDailyTask] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attApproveSubmitTakeDailyTask && attSubmitTakeDailyTaskViewDetail && enumName && (
                            ...
                            {keyQuery && (
                                <AttTakeDailyTaskList
                                    detail={{
                                        ...
                                        screenName: attSubmitTakeDailyTask,
                                        screenNameRender: attApproveSubmitTakeDailyTask
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={attApproveSubmitTakeDailyTaskKeyTask}
