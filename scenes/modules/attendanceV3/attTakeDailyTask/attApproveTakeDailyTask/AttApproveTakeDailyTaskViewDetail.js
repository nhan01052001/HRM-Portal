...
import { generateRowActionAndSelected, AttApproveTakeDailyTaskBusiness } from './AttApproveTakeDailyTaskBusiness';
...
export default class AttApproveTakeDailyTaskViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
            configListDetail: null,
            dataRowActionAndSelected: generateRowActionAndSelected(ScreenName.AttApproveTakeDailyTask),
    ...
    getDataItem = async () => {
        try {
            const _params = this.props.navigation.state.params,
                ...
                _configListDetail = ConfigListDetail.value[ScreenName.AttApproveTakeDailyTask]
                    ? ConfigListDetail.value[ScreenName.AttApproveTakeDailyTask]
                    : configDefault;
