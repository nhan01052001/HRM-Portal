...
class AttCanceledTakeDailyTask extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveTakeDailyTaskBusiness.checkForReLoadScreen[attCanceledTakeDailyTask]) {
                this.reload();
            }
        });
    }
    ...
    paramsDefault = () => {
        if (!attCanceledTakeDailyTask) {
            attCanceledTakeDailyTask = ScreenName.AttCanceledTakeDailyTask;
        }
        if (!configList[attCanceledTakeDailyTask]) {
            configList[attCanceledTakeDailyTask] = {
                Api: {
        ...
        const _configList = configList[attCanceledTakeDailyTask],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attCanceledTakeDailyTask);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attCanceledTakeDailyTask && attApproveTakeDailyTaskViewDetail && enumName && (
