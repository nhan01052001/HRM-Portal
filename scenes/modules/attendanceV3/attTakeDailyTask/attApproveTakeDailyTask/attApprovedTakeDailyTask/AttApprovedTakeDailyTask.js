...
class AttApprovedTakeDailyTask extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveTakeDailyTaskBusiness.checkForReLoadScreen[attApprovedTakeDailyTask]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttApproveTakeDailyTaskBusiness.checkForReLoadScreen[attApprovedTakeDailyTask] = false;
    ...
    paramsDefault = () => {
        if (!attApprovedTakeDailyTask) {
            attApprovedTakeDailyTask = ScreenName.AttApprovedTakeDailyTask;
        }
        if (!configList[attApprovedTakeDailyTask]) {
            configList[attApprovedTakeDailyTask] = {
                Api: {
                    urlApi: '[URI_CENTER]/api/Att_OvertimePlan/New_PlanGetOvertimeApprovedByFilterHandle_App',
                    type: 'POST',
                    pageSize: 20
                },
                Order: [
        ...
        const _configList = configList[attApprovedTakeDailyTask],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attApprovedTakeDailyTask);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttApprovedTakeDailyTask;
        AttApproveTakeDailyTaskBusiness.checkForReLoadScreen[attApprovedTakeDailyTask] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attApprovedTakeDailyTask && attApproveTakeDailyTaskViewDetail && enumName && (
