...
let configList = null,
    enumName = null,
    attRejectTakeDailyTask = null,
    attApproveTakeDailyTask = null,
    attApproveTakeDailyTaskViewDetail = null,
    keyListTask = null,
    pageSizeList = 20;

class AttRejectTakeDailyTask extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveTakeDailyTaskBusiness.checkForReLoadScreen[attRejectTakeDailyTask]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttApproveTakeDailyTaskBusiness.checkForReLoadScreen[attRejectTakeDailyTask] = false;
    ...
    paramsDefault = () => {
        if (!attRejectTakeDailyTask) {
            attRejectTakeDailyTask = ScreenName.AttRejectTakeDailyTask;
        }
        if (!configList[attRejectTakeDailyTask]) {
            configList[attRejectTakeDailyTask] = {
                Api: {
        ...
        const _configList = configList[attRejectTakeDailyTask],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attRejectTakeDailyTask);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttRejectTakeDailyTask;
        AttApproveTakeDailyTaskBusiness.checkForReLoadScreen[attRejectTakeDailyTask] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attRejectTakeDailyTask && attApproveTakeDailyTaskViewDetail && enumName && (
