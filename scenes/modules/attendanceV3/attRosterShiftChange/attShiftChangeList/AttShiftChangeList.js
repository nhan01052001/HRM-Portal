...
export default class AttShiftChangeList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
            ...
            getDataLocal(keyDataLocal)
                .then(resData => {
                    ...
                    if (res && res !== EnumName.E_EMPTYDATA) {
                        ...
                        if (detail?.screenName === ScreenName.AttApproveShiftChange) {
                            data.map(item => {
                                item.isSelect = false;
                        ...
                        } else if (detail?.screenName == ScreenName.AttApprovedShiftChange) {
                            data.map(item => {
                                item.isSelect = false;
    ...
    render() {
        ...
        let isShowBtn =
            ...
            (detail.screenNameRender === ScreenName.AttSubmitShiftChange ||
                detail.screenNameRender === ScreenName.AttSaveTempSubmitShiftChange);
        return (
            <View
                style={[
