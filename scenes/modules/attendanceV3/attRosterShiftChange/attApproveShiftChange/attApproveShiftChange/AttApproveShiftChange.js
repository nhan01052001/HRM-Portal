...
class AttApproveShiftChange extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveShiftChangeBusiness.checkForReLoadScreen[attApproveShiftChange]) {
                this.reload();
            }
        });
    }
    ...
    paramsDefault = () => {
        if (!attApproveShiftChange) {
            attApproveShiftChange = ScreenName.AttApproveShiftChange;
        }
        if (!configList[attApproveShiftChange] || 1 === 1) {
            configList[attApproveShiftChange] = {
                Api: {
        ...
        const _configList = configList[attApproveShiftChange],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify(),
            groupField = _configList[enumName.E_Field_Group] ? _configList[enumName.E_Field_Group] : null;

        dataRowActionAndSelected = generateRowActionAndSelected(attApproveShiftChange);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttApproveShiftChange;
        AttApproveShiftChangeBusiness.setThisForBusiness(this, false, dataRowActionAndSelected?.rowActions);
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attApproveShiftChange && attApproveShiftChangeViewDetail && enumName && (
                            ...
                            {keyQuery && (
                                <AttShiftChangeList
                                    detail={{
                                        ...
                                        screenName: attApproveShiftChange,
                                        screenNameRender: ScreenName.AttApproveShiftChange
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
