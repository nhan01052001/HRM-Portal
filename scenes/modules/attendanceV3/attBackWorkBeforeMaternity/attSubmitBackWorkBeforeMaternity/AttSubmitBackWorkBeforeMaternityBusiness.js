...
let enumName = EnumName,
    attSubmitBackWorkBeforeMaternity = ScreenName.AttSubmitBackWorkBeforeMaternity;
...
export const generateRowActionAndSelected = (screenName = attSubmitBackWorkBeforeMaternity) => {
    _rowActions = [];
    _selected = [];
            ...
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    onPress: (item, dataBody) =>
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.businessModifyRecord(
        ...
        if (actionSendMailPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_SENDMAIL,
                    onPress: (item, dataBody) =>
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.businessSendMailRecords(
                            Array.isArray(item) ? item : [{ ...item }],
                            dataBody
                        ),
                    ...actionSendMail
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    onPress: (items, dataBody) =>
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.businessSendMailRecords(items, dataBody),
                    ...actionSendMail
                }
            ];
        }
        ...
        if (actionDeletePer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_DELETE,
                    onPress: (item, dataBody) =>
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.businessDeleteRecords(
                            Array.isArray(item) ? item : [{ ...item }],
                            dataBody
                        ),
                    ...actionDelete
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    type: E_DELETE,
                    onPress: (item, dataBody) =>
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.businessDeleteRecords(item, dataBody),
                    ...actionDelete
                }
            ];
        }
        ...
        if (actionCancelPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_CANCEL,
                    onPress: (item, dataBody) =>
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.businessCancelRecords(
                            Array.isArray(item) ? item : [{ ...item }],
                            dataBody
                        ),
                    ...actionCancel
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    type: E_CANCEL,
                    onPress: (item, dataBody) =>
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.businessCancelRecords(item, dataBody),
                    ...actionCancel
                }
            ];
        }
...
export const AttSubmitBackWorkBeforeMaternityBusinessFunction = {
    checkForReLoadScreen: {
        AttSubmitBackWorkBeforeMaternity: false,
        AttSaveTempSubmitBackWorkBeforeMaternity: false,
        AttCanceledSubmitBackWorkBeforeMaternity: false,
        AttApproveSubmitBackWorkBeforeMaternity: false,
        AttApprovedSubmitBackWorkBeforeMaternity: false,
        AttRejectSubmitBackWorkBeforeMaternity: false
    },
    ...
    businessDeleteRecords: (items, dataBody) => {
        if (items.length === 0 && !dataBody) {
            ...
            HttpService.Post('[URI_CENTER]/api/Att_BackWorkBeforeMaternity/CheckStatusBackWorkBeforeMaternityForDelete', {
                ...
                if (res && res.Status == EnumName.E_SUCCESS) {
                    if (res.Data && res.Data.length > 0) {
                        ...
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.confirmDelete({
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.setDelete(objValid);
                    }
                }
            });
        } else {
    ...
    setDelete: objValid => {
        VnrLoadingSevices.show();
        HttpService.Post('[URI_CENTER]/api/Att_BackWorkBeforeMaternity/DeleteBackWorkBeforeMaternityHandle', {
            ...
            try {
                if (res && res.Status == EnumName.E_SUCCESS) {
                    ...
                    AttSubmitBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[
                        ScreenName.AttSubmitBackWorkBeforeMaternity
                    ] = true;
    ...
    businessSendMailRecords: (items, dataBody) => {
        ...
        if (items.length === 0 && !dataBody) {
            ...
            if (selectedID.length == 0) {
                ...
                AttSubmitBackWorkBeforeMaternityBusinessFunction.setSendMail({
    ...
    setSendMail: objValid => {
        ...
        VnrLoadingSevices.show();
        HttpService.Post('[URI_CENTER]/api/Att_BackWorkBeforeMaternity/ProcessingSendMailBackWorkBeforeMaternity', {
            ListRecordID: objValid.strResultID,
            UserLogin: dataVnrStorage.currentUser.headers.userlogin,
            UserProcessID: dataVnrStorage.currentUser.headers.userid,
            Host: _uriPor
            ...
            if (res && res.Status == EnumName.E_SUCCESS) {
                ...
                AttSubmitBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[
                    ScreenName.AttApproveSubmitBackWorkBeforeMaternity
                ] = true;
                AttSubmitBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[
                    ScreenName.AttSaveTempSubmitBackWorkBeforeMaternity
                ] = true;
            } else if (res && res.Message && typeof res.Message == 'string') {
                ToasterSevice.showError(res.Message, 4000);
            } else {
    ...
    businessCancelRecords: (items, dataBody) => {
        if (items.length === 0 && !dataBody) {
            ...
            HttpService.MultiRequest([
                ...
                HttpService.Get('[URI_CENTER]/api/Att_GetData/GetConfigNoteValidate?business=E_BACKWORKBEFOREMATERNITY')
            ]).then(resAll => {
                VnrLoadingSevices.hide();
                ...
                if (res && res.Status == EnumName.E_SUCCESS) {
                    if (res.Data && res.Data.length > 0) {
                        ...
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.confirmCancel({
                            strResultID: res.Data,
                            message: keyTrans.replace('[E_NUMBER]', numberRow)
                        }, isNote);
                    } else {
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        AttSubmitBackWorkBeforeMaternityBusinessFunction.setCancel({ ...objValid, Comment: reason });
                    }
                }
            });
        } else {
            AttSubmitBackWorkBeforeMaternityBusinessFunction.setCancel(objValid);
        }
    },

    setCancel: objValid => {
        VnrLoadingSevices.show();
        HttpService.Post('[URI_CENTER]/api/Att_BackWorkBeforeMaternity/SetCancelBackWorkBeforeMaternityInPortal', {
            ...
            if (res && res.Status == EnumName.E_SUCCESS) {
                ToasterSevice.showSuccess(res.Message, 4000);
                _this.reload('E_KEEP_FILTER', true);
                AttSubmitBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[ScreenName.AttSubmitBackWorkBeforeMaternity] = true;
                AttSubmitBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[
                    ScreenName.AttCanceledSubmitBackWorkBeforeMaternity
                ] = true;
            } else if (res && res.Message && typeof res.Message == 'string') {
                ToasterSevice.showError(res.Message, 4000);
            } else {
    ...
    businessModifyRecord: (item, dataBody, itemRoot) => {
        ...
        if (itemRoot) {
            if (
                ...
                if (ID) {
                    VnrLoadingSevices.show();
                    HttpService.Get(`[URI_CENTER]/api/Att_BackWorkBeforeMaternity/GetDetailBackWorkBeforeMaternityById?ID=${ID}`)
                        .then(res => {
                            VnrLoadingSevices.hide();
