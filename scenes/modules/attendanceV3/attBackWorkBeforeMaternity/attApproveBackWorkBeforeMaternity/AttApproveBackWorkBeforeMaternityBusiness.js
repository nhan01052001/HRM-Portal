...
let enumName = EnumName,
    ...
    attApproveBackWorkBeforeMaternity = ScreenName.AttApproveBackWorkBeforeMaternity,
    apiConfig = null,
    headers = null;
            ...
            _rowActions = [
                {
                    ...
                    onPress: (item, dataBody) =>
                        AttApproveBackWorkBeforeMaternityBusinessFunction.businessApproveRecords(
            ...
            _selected = [
                {
                    ...
                    type: E_APPROVE,
                    onPress: (item, dataBody) =>
                        AttApproveBackWorkBeforeMaternityBusinessFunction.businessApproveRecords(item, dataBody),
                    ...actionApprove
                }
            ];
        }
        ...
        if (actionRejectPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_REJECT,
                    onPress: (item, dataBody) =>
                        AttApproveBackWorkBeforeMaternityBusinessFunction.businessRejectRecords(
                            Array.isArray(item) ? item : [{ ...item }],
                            dataBody
                        ),
                    ...actionReject
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    type: E_REJECT,
                    onPress: (item, dataBody) =>
                        AttApproveBackWorkBeforeMaternityBusinessFunction.businessRejectRecords(item, dataBody),
                    ...actionReject
                }
            ];
        }
        ...
        if (actionCancelPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_CANCEL,
                    onPress: (item, dataBody) =>
                        AttApproveBackWorkBeforeMaternityBusinessFunction.businessCancelRecords(
                            Array.isArray(item) ? item : [{ ...item }],
                            dataBody
                        ),
                    ...actionCancel
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    onPress: (items, dataBody) =>
                        AttApproveBackWorkBeforeMaternityBusinessFunction.businessCancelRecords(items, dataBody),
                    ...actionCancel
                }
            ];
        }
...
export const AttApproveBackWorkBeforeMaternityBusinessFunction = {
    // Đối tượng checkForReLoadScreen để check có refresh AttApprovedBackWorkBeforeMaternity không
    checkForReLoadScreen: {
        [ScreenName.AttApprovedBackWorkBeforeMaternity]: false,
        AttRejectBackWorkBeforeMaternity: false,
        AttCanceledBackWorkBeforeMaternity: false,
        AttAllBackWorkBeforeMaternity: false
    },
    ...
    checkRequireNote: async (field) => {
        try {
            const res = await HttpService.Get(
                '[URI_CENTER]/api/Att_GetData/GetConfigNoteValidate?business=E_BACKWORKBEFOREMATERNITY'
            );
    ...
    businessApproveRecords: (items, dataBody) => {
        if (items.length === 0 && !dataBody) {
            ...
            if (arrValid.length > 0) {
                ...
                // AttApproveBackWorkBeforeMaternityBusinessFunction.confirmApprove({ ListRecord, message });
                AttApproveBackWorkBeforeMaternityBusinessFunction.validateApproveBackWorkBeforeMaternity({
                    ListRecord: arrValid,
                    message,
    ...
    validateApproveBackWorkBeforeMaternity: objValid => {
        ...
        if (objValid && Array.isArray(objValid?.ListRecord) && objValid?.ListRecord.length > 0) {
            ...
            HttpService.Post('[URI_CENTER]/api/Att_BackWorkBeforeMaternity/ValidateApproveBackWorkBeforeMaternity', {
                ...
                .then(res => {
                    ...
                    if (res) {
                        if (res.Status === 'SUCCESS' && res.Data && Array.isArray(res.Data) && res.Data.length > 0) {
                            AttApproveBackWorkBeforeMaternityBusinessFunction.confirmApprove({
                                ListRecord: {
                                    RecordID: res.Data,
                                    Comment: '',
                                    Type: 'E_APPROVED'
    ...
    confirmApprove: async (objValid) => {
        ...
        const isNote = await AttApproveBackWorkBeforeMaternityBusinessFunction.checkRequireNote('IsRequiredApproveNote');
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        //     return item;
                        // });
                        HttpService.Post('[URI_CENTER]/api/Att_BackWorkBeforeMaternity/SetApproveBackWorkBeforeMaternityInPortal', {
                            Host: apiConfig.uriPor,
                            ...
                            try {
                                if (res) {
                                    if (res.Status === 'SUCCESS') {
                                        ...
                                        // set true để refresh AttApprovedBackWorkBeforeMaternity
                                        AttApproveBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[
                                            ScreenName.AttApproveBackWorkBeforeMaternity
                                        ] = true;
                                        AttApproveBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[
                                            ScreenName.AttApprovedBackWorkBeforeMaternity
                                        ] = true;
                                        ...
                                        if (!_isOnScreenNotification) DrawerServices.navigate('AttApproveBackWorkBeforeMaternity');
                                    } else if (res.Status === 'Locked') {
                                        ToasterSevice.showWarning('Hrm_Locked', 5000);
                                    } else {
                                        ToasterSevice.showWarning(res.Message, 5000);
    ...
    businessRejectRecords: (items, dataBody) => {
        if (items.length === 0 && !dataBody) {
            ...
            if (arrValid.length > 0) {
                ...
                // AttApproveBackWorkBeforeMaternityBusinessFunction.confirmReject({ ListRecord, message });
                AttApproveBackWorkBeforeMaternityBusinessFunction.validateRejectBackWorkBeforeMaternity({
                    ListRecord: arrValid,
                    message,
                    allItems: Array.isArray(items) ? items.length : 0
                });
    ...
    validateRejectBackWorkBeforeMaternity: objValid => {
        if (objValid && Array.isArray(objValid?.ListRecord) && objValid?.ListRecord.length > 0) {
            let listID = [];
            objValid?.ListRecord.map(item => {
                if (item.RecordID) listID.push(item.RecordID);
            ...
            VnrLoadingSevices.show();
            HttpService.Post('[URI_CENTER]/api/Att_BackWorkBeforeMaternity/ValidateRejectBackWorkBeforeMaternity', {
                Host: apiConfig.uriPor,
                ListRecordID: listID,
                UserLogin: headers.userlogin,
                UserProcessID: headers.userid
                ...
                .then(res => {
                    ...
                    if (res) {
                        if (res.Status === 'SUCCESS' && res.Data && Array.isArray(res.Data) && res.Data.length > 0) {
                            AttApproveBackWorkBeforeMaternityBusinessFunction.confirmReject({
                                ListRecord: {
                                    RecordID: res.Data,
                                    Comment: '',
                                    Type: 'E_APPROVED'
    ...
    confirmReject: async (objValid) => {
        let actionCancel = _rowActions.find(item => item.Type === 'E_REJECT'),
            isConfirm = actionCancel['Confirm'];
        const isNote = await AttApproveBackWorkBeforeMaternityBusinessFunction.checkRequireNote('IsRequiredRejectNote');
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        HttpService.Post('[URI_CENTER]/api/Att_BackWorkBeforeMaternity/SetRejectBackWorkBeforeMaternityInPortal', {
                            Host: apiConfig.uriPor,
                            ListRecordID: objValid.ListRecord.RecordID,
                            UserLogin: headers.userlogin,
                            UserProcessID: headers.userid,
                            ...
                            try {
                                if (res) {
                                    if (res.Status === 'SUCCESS') {
                                        ...
                                        AttApproveBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[
                                            ScreenName.AttRejectBackWorkBeforeMaternity
                                        ] = true;
                ...
                try {
                    if (res) {
                        if (res.Status === 'SUCCESS') {
                            ...
                            store.dispatch(badgesNotification.actions.fetchCountNumberApproveInfo());
                            // nếu (duyệt/từ chối) ở màn hình notify thì không chuyển hướng.
                            if (!_isOnScreenNotification) DrawerServices.navigate('AttApprovedBackWorkBeforeMaternity');
                        } else if (res.Status === 'Locked') {
                            ToasterSevice.showWarning('Hrm_Locked', 5000);
                        } else {
                            ToasterSevice.showWarning(res.Message, 5000);
    ...
    businessCancelRecords: (items, dataBody) => {
        if (items.length === 0 && !dataBody) {
            ...
            if (arrValid.length > 0 && ListRecordID.length > 0 && totalList.length > 0) {
                ...
                // AttApproveBackWorkBeforeMaternityBusiness.confirmCancel({ ListRecordID, message });
                AttApproveBackWorkBeforeMaternityBusinessFunction.validateCancleBackWorkBeforeMaternity({ ListRecordID, message, totalList });
            } else {
    ...
    validateCancleBackWorkBeforeMaternity: objValid => {
        if (objValid && Array.isArray(objValid?.ListRecordID) && objValid?.ListRecordID.length > 0) {
            VnrLoadingSevices.show();
            HttpService.Post('[URI_CENTER]/api/Att_BackWorkBeforeMaternity/ValidateCancelBackWorkBeforeMaternity', {
                Host: apiConfig.uriPor,
                ...
                .then(res => {
                    ...
                    if (res) {
                        if (res.Status === 'SUCCESS' && res.Data && Array.isArray(res.Data) && res.Data.length > 0) {
                            AttApproveBackWorkBeforeMaternityBusinessFunction.confirmCancel({
                                ListRecord: {
                                    RecordID: res.Data,
                                    Comment: '',
                                    Type: 'E_CANCEL'
                                },
                                message: translate('HRM_PortalApp_TSL_Cancle').replace(
                                    '[E_NUMBER]',
                                    `${res.Data.length}/${objValid?.totalList.length}`
                                )
                            });
                        } else if (res.Status === 'Locked') {
                            ToasterSevice.showWarning('Hrm_Locked', 5000);
    ...
    confirmCancel: async (objValid) => {
        let actionCancel = _rowActions.find(item => item.Type === 'E_CANCEL'),
            isConfirm = actionCancel['Confirm'];
        const isNote = await AttApproveBackWorkBeforeMaternityBusinessFunction.checkRequireNote('IsRequiredCancelNote');
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        VnrLoadingSevices.show();
                        HttpService.Post('[URI_CENTER]/api/Att_BackWorkBeforeMaternity/SetCancelBackWorkBeforeMaternityInPortalForApproved', {
                            Host: apiConfig.uriPor,
                            ListRecordID: objValid.ListRecord.RecordID,
                            UserLogin: headers.userlogin,
                            UserProcessID: headers.userid,
                            ...
                            try {
                                if (res && res !== '') {
                                    if (res.Status == 'SUCCESS') {
                                        ...
                                        AttApproveBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[
                                            ScreenName.AttCanceledBackWorkBeforeMaternity
                                        ] = true;
                                    } else if (res.Status == 'Locked') {
                                        ToasterSevice.showWarning('Hrm_Locked', 5000);
                                    } else {
                ...
                try {
                    if (res && res !== '') {
                        if (res.Status == 'SUCCESS') {
                            ...
                            _this.reload('E_KEEP_FILTER');
                            AttApproveBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[
                                ScreenName.AttAllBackWorkBeforeMaternity
                            ] = true;
                            AttApproveBackWorkBeforeMaternityBusinessFunction.checkForReLoadScreen[
                                ScreenName.AttCanceledBackWorkBeforeMaternity
                            ] = true;
...
export default {
    ...
    AttApproveBackWorkBeforeMaternityBusinessFunction: AttApproveBackWorkBeforeMaternityBusinessFunction
};
