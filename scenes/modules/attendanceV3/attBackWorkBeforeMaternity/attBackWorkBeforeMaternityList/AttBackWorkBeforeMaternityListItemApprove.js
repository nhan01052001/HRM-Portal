...
export default class AttBackWorkBeforeMaternityListItemApprove extends VnrRenderListItem {
    formatBackWorkInfo = (dataItem) => {
        if (dataItem?.BackWorkReasonName) {
            return (
                <Text style={[styleSheets.lable, styles.styleTextType]} numberOfLines={2}>
                    {dataItem?.BackWorkReasonName}
                </Text>
            );
        }
        return null;
    ...
    render() {
        ...
        let textFieldDate = '',
            textFieldBackWorkInfo = '',
            colorStatusView = null,
            bgStatusView = null,
            isHaveAvatar = false;
        textFieldBackWorkInfo = this.formatBackWorkInfo(dataItem);
                                    ...
                                    <View style={styles.styViewTop}>
                                        ...
                                        <View style={[CustomStyleSheet.width('70%'), styles.styViewHidden]}>
                                            ...
                                            >
                                                ...
                                                {dataItem?.DataRegister?.BackWorkReasonName ? (
                                            ...
                                            <View style={CustomStyleSheet.flex(1)}>
                                                <View style={styles.styleFlex1_row_AlignCenter}>{textFieldBackWorkInfo}</View>
                                            </View>
                                        </View>
