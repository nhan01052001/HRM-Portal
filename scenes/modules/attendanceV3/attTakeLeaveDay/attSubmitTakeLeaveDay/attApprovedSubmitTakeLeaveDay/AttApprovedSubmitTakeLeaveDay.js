...
let configList = null,
    enumName = null,
    attApprovedSubmitTakeLeaveDay = null,
...
class AttApprovedSubmitTakeLeaveDay extends Component {
    ...
    reload = paramsFilter => {
        ...
        AttSubmitTakeLeaveDayBusinessFunction.checkForReLoadScreen[attApprovedSubmitTakeLeaveDay] = false;

        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: attApprovedSubmitTakeLeaveDayKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!attApprovedSubmitTakeLeaveDay) {
            attApprovedSubmitTakeLeaveDay = ScreenName.AttApprovedSubmitTakeLeaveDay;
        }

        if (!configList[attApprovedSubmitTakeLeaveDay]) {
            configList[attApprovedSubmitTakeLeaveDay] = {
                Api: {
        ...
        const _configList = configList[attApprovedSubmitTakeLeaveDay],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == attApprovedSubmitTakeLeaveDayKeyTask) {
    ...
    componentDidMount() {
        ...
        attApprovedSubmitTakeLeaveDayKeyTask = EnumTask.KT_AttApprovedSubmitTakeLeaveDay;
        AttSubmitTakeLeaveDayBusinessFunction.checkForReLoadScreen[attApprovedSubmitTakeLeaveDay] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attApprovedSubmitTakeLeaveDay && attSubmitTakeLeaveDayViewDetail && enumName && (
                            ...
                            {keyQuery && (
                                <AttTakeLeaveDayList
                                    detail={{
                                        ...
                                        screenName: attSubmitTakeLeaveDay,
                                        screenNameRender: attApprovedSubmitTakeLeaveDay
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={attApprovedSubmitTakeLeaveDayKeyTask}
