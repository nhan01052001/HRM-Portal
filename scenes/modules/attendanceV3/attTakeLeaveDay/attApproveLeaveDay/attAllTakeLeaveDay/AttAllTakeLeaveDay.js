...
class AttAllTakeLeaveDay extends Component {
    ...
    reload = paramsFilter => {
        ...
        AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attAllTakeLeaveDay] = false;
    ...
    paramsDefault = () => {
        if (!attAllTakeLeaveDay) {
            attAllTakeLeaveDay = ScreenName.AttAllTakeLeaveDay;
        }
        if (!configList[attAllTakeLeaveDay]) {
            configList[attAllTakeLeaveDay] = {
                Api: {
        ...
        const _configList = configList[attAllTakeLeaveDay],
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttAllTakeLeaveDay;
        AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attAllTakeLeaveDay] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attAllTakeLeaveDay && attApproveTakeLeaveDayViewDetail && enumName && (
