...
let configList = null,
    enumName = null,
    attApprovedTakeLeaveDay = null,
    attApproveTakeLeaveDayViewDetail = null,
    attApproveTakeLeaveDay = null,
    keyListTask = null,
    pageSizeList = 20;

class AttApprovedTakeLeaveDay extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attApprovedTakeLeaveDay]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attApprovedTakeLeaveDay] = false;
    ...
    paramsDefault = () => {
        if (!attApprovedTakeLeaveDay) {
            attApprovedTakeLeaveDay = ScreenName.AttApprovedTakeLeaveDay;
        }
        if (!configList[attApprovedTakeLeaveDay]) {
            configList[attApprovedTakeLeaveDay] = {
                Api: {
                    urlApi: '[URI_CENTER]/api/Att_LeaveDay/New_GetLeaveDayApprovedByFilterHandle_App',
                    type: 'POST',
                    pageSize: 20
                },
                Order: [
                ...
                BusinessAction: [
                    {
                        Type: 'E_CANCEL',
                        Resource: {
                            Name: 'New_Att_WaitingApprovedLeaveday_New_Index_btnCancel',
                            Rule: 'View'
                        },
                        Confirm: {
                            isInputText: true,
        ...
        const _configList = configList[attApprovedTakeLeaveDay],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attApprovedTakeLeaveDay);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttApprovedTakeLeaveDay;
        AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attApprovedTakeLeaveDay] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attApprovedTakeLeaveDay && attApproveTakeLeaveDayViewDetail && enumName && (
