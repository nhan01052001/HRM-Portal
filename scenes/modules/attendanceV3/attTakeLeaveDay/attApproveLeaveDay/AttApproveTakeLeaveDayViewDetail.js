...
export default class AttApproveTakeLeaveDayViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
    ...
    getDataItem = async () => {
        try {
            const _params = this.props.navigation.state.params,
                ...
                _configListDetail =
                    ConfigListDetail.value[ScreenName.AttApproveTakeLeaveDay] !== null
                        ? ConfigListDetail.value[ScreenName.AttApproveTakeLeaveDay]
                        : configDefault;
            ...
            if (id) {
                ...
                const getDetailConfig = await Vnr_Function.HandleConfigListDetailATT(_configListDetail, 'Detail_Approve_LeaveDay');
