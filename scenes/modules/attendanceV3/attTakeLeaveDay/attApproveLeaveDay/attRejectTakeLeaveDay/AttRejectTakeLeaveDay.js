...
let configList = null,
    enumName = null,
    attRejectTakeLeaveDay = null,
    attApproveTakeLeaveDay = null,
    attApproveTakeLeaveDayViewDetail = null,
    keyListTask = null,
    pageSizeList = 20;

class AttRejectTakeLeaveDay extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attRejectTakeLeaveDay]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attRejectTakeLeaveDay] = false;
    ...
    paramsDefault = () => {
        if (!attRejectTakeLeaveDay) {
            attRejectTakeLeaveDay = ScreenName.AttRejectTakeLeaveDay;
        }
        if (!configList[attRejectTakeLeaveDay]) {
            configList[attRejectTakeLeaveDay] = {
                Api: {
        ...
        const _configList = configList[attRejectTakeLeaveDay],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attRejectTakeLeaveDay);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttRejectTakeLeaveDay;
        AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attRejectTakeLeaveDay] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attRejectTakeLeaveDay && attApproveTakeLeaveDayViewDetail && enumName && (
