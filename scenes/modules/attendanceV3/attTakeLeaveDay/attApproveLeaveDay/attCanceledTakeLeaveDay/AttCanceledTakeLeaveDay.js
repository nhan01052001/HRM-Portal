...
let configList = null,
    enumName = null,
    attCanceledTakeLeaveDay = null,
    attApproveTakeLeaveDayViewDetail = null,
    attApproveTakeLeaveDay = null,
    keyListTask = null,
    pageSizeList = 20;

class AttCanceledTakeLeaveDay extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attCanceledTakeLeaveDay]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attCanceledTakeLeaveDay] = false;
    ...
    paramsDefault = () => {
        if (!attCanceledTakeLeaveDay) {
            attCanceledTakeLeaveDay = ScreenName.AttCanceledTakeLeaveDay;
        }
        if (!configList[attCanceledTakeLeaveDay]) {
            configList[attCanceledTakeLeaveDay] = {
                Api: {
        ...
        const _configList = configList[attCanceledTakeLeaveDay],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attCanceledTakeLeaveDay);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttCanceledTakeLeaveDay;
        AttApproveTakeLeaveDayBusinessFunction.checkForReLoadScreen[attCanceledTakeLeaveDay] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attCanceledTakeLeaveDay && attApproveTakeLeaveDayViewDetail && enumName && (
