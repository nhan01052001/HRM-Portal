...
import { Colors, Size, stylesScreenDetailV3, CustomStyleSheet } from '../../../../../constants/styleConfig';
...
export default class AttTakeLeaveDayList extends VnrRenderList {
    remoteData = (param = {}) => {
    ...
    render() {
        ...
        let isShowBtn =
            ...
            (detail.screenNameRender === ScreenName.AttSubmitTakeLeaveDay ||
                detail.screenNameRender === ScreenName.AttSaveTempSubmitTakeLeaveDay) && itemSelected.length === 0;
        return (
            <View
                style={[
