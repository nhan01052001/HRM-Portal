...
export default class BottomAction extends React.Component {
    ...
    render() {
        ...
        const { totalRow, lengthDataSource, numberItemSelected } = this.props;
        ...
        return (
            <View style={[BottomActions.actionHeader, { minHeight: this.props.heightAction }]}>
                <View style={BottomActions.itemaACtionleft}>
                    <View style={isCheck.disable ? { opacity: 0.5 } : { opacity: 1 }}>
                        <TouchableHighlight
                    ...
                    {/* <View style={isCheckServer.disable ? { opacity: .5 } : { opacity: 1 }}>
                        <TouchableHighlight activeOpacity={isCheckServer.disable ? 1 : .8}
                            onPress={() => !isCheckServer.disable ? this.toggleCheckedServer(isCheckServer.value) : null}
