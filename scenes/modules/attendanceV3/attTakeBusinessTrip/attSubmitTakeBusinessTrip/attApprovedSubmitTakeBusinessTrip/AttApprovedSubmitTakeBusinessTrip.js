...
class AttApprovedSubmitTakeBusinessTrip extends Component {
    constructor(props) {
        super(props);
    ...
    reload = paramsFilter => {
        ...
        AttSubmitTakeBusinessTripBusinessFunction.checkForReLoadScreen[attApprovedSubmitTakeBusinessTrip] = false;
        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: attApprovedSubmitTakeBusinessTripKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!attApprovedSubmitTakeBusinessTrip) {
            attApprovedSubmitTakeBusinessTrip = ScreenName.AttRejectSubmitTakeBusinessTrip;
        }
        if (!configList[attApprovedSubmitTakeBusinessTrip]) {
            configList[attApprovedSubmitTakeBusinessTrip] = {
                Api: {
                    urlApi:
        ...
        const _configList = configList[attApprovedSubmitTakeBusinessTrip],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == attApprovedSubmitTakeBusinessTripKeyTask) {
    ...
    componentDidMount() {
        ...
        attApprovedSubmitTakeBusinessTrip = ScreenName.AttApprovedSubmitTakeBusinessTrip;
        attApprovedSubmitTakeBusinessTripKeyTask = EnumTask.KT_AttApprovedSubmitTakeBusinessTrip;
        AttSubmitTakeBusinessTripBusinessFunction.checkForReLoadScreen[attApprovedSubmitTakeBusinessTrip] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attApprovedSubmitTakeBusinessTrip && attSubmitTakeBusinessTripViewDetail && enumName && (
                            ...
                            {keyQuery && (
                                <AttTakeBusinessTripList
                                    detail={{
                                        ...
                                        screenName: attSubmitTakeBusinessTrip,
                                        screenNameRender: attApprovedSubmitTakeBusinessTrip
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={attApprovedSubmitTakeBusinessTripKeyTask}
