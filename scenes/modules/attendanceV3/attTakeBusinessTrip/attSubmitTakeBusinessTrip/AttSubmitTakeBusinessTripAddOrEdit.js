...
class AttSubmitTakeBusinessTripAddOrEdit extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            // isShowModal: false,
                    ...
                    if (data[key]) {
                        ...
                        fieldConfig = {
                            ...
                            [key]: {
                                ...
                                isValid: validation && validation.nullable ? false : true
                            }
                        };
                    }
                });
    ...
    handleSetState = async (response) => {
        ...
        let nextState = {
            ...
            DateFromTo: {
                ...DateFromTo,
                value: {
                    startDate: moment(response.DateFrom).format('YYYY-MM-DD'),
                    endDate: moment(response.DateTo).format('YYYY-MM-DD')
                },
                refresh: !DateFromTo.refresh
            },
            ID: response.ID,
    ...
    onSave = (isSend, isconfirm) => {
        ...
        if (ListBussinessTravelItem.length > 0) {
            ...
            for (let index = 0; index < ListBussinessTravelItem.length; index++) {
                ...
                if (
                    (fieldConfig.BusinessTripTypeID.isValid && item.BusinessTripTypeID == null) ||
                ...
                // if (item.BusinessReason == null || item.BusinessReason == '') {
                //     checkValid = false;
                //     break;
                // }
            }
                        ...
                        <SafeAreaView style={styles.wrapInsideModal}>
                            ...
                            <View style={styles.flRowSpaceBetween}>
                                <VnrText
                                    ...
                                    i18nKey={
                                        this.isModify
                                            ? 'HRM_PortalApp_TakeBusinessTrip_Update'
                                            : 'HRM_PortalApp_TakeBusinessTrip_Create'
                                    }
                                />
...
export default AttSubmitTakeBusinessTripAddOrEdit;