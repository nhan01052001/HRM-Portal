...
import AttConfirmShiftChangeListItem from './AttConfirmShiftChangeListItem';
...
export default class AttConfirmShiftChangelist extends VnrRenderList {
    remoteData = (param = {}) => {
                ...
                .then(resData => {
                    ...
                    if (res && res !== EnumName.E_EMPTYDATA) {
                        ...
                        data.map(item => {
                            ...
                            if (item.Status === 'E_CONFIRM' || item.Status === 'E_SUBMIT_TEMP') {
    ...
    render() {
        ...
        let isShowBtn =
            permissionBtnCreate &&
            (detail.screenNameRender === ScreenName.AttSubmitShiftChange ||
                detail.screenNameRender === ScreenName.AttSaveTempSubmitShiftChange) && itemSelected.length;
        return (
            <View
                style={[
