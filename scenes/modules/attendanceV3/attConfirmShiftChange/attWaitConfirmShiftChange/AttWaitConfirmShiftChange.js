...
let configList = null,
    enumName = null,
    attWaitConfirmShiftChange = null,
    attConfirmShiftChange = null,
    attConfirmShiftChangeViewDetail = null,
    dataRowActionAndSelected = null,
    attWaitConfirmShiftChangeKeyTask = null,
    pageSizeList = 50;

class AttWaitConfirmShiftChange extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttConfirmShiftChangeBusinessFunction.checkForReLoadScreen[attWaitConfirmShiftChange]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttConfirmShiftChangeBusinessFunction.checkForReLoadScreen[attWaitConfirmShiftChange] = false;
        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: attWaitConfirmShiftChangeKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[attWaitConfirmShiftChange],
        ...
        dataRowActionAndSelected = generateRowActionAndSelected(attWaitConfirmShiftChange);
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == attWaitConfirmShiftChangeKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.AttWaitConfirmShiftChange]) {
            ConfigList.value[ScreenName.AttWaitConfirmShiftChange] = {
                Api: {
        ...
        attWaitConfirmShiftChange = ScreenName.AttWaitConfirmShiftChange;
        ...
        attWaitConfirmShiftChangeKeyTask = EnumTask.KT_AttWaitConfirmShiftChange;
        AttConfirmShiftChangeBusinessFunction.checkForReLoadScreen[attWaitConfirmShiftChange] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attWaitConfirmShiftChange && attConfirmShiftChangeViewDetail && enumName && (
                            ...
                            {keyQuery && (
                                <AttConfirmShiftChangeList
                                    detail={{
                                        ...
                                        screenName: attConfirmShiftChange,
                                        screenNameRender: attWaitConfirmShiftChange
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={attWaitConfirmShiftChangeKeyTask}
