...
let configList = null,
    enumName = null,
    attConfirmedShiftChange = null,
    attConfirmShiftChange = null,
    attConfirmShiftChangeViewDetail = null,
    dataRowActionAndSelected = null,
    attConfirmedShiftChangeKeyTask = null,
    pageSizeList = 50;

class AttConfirmedShiftChange extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttConfirmShiftChangeBusinessFunction.checkForReLoadScreen[attConfirmedShiftChange]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttConfirmShiftChangeBusinessFunction.checkForReLoadScreen[attConfirmedShiftChange] = false;
        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: attConfirmedShiftChangeKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[attConfirmedShiftChange],
        ...
        dataRowActionAndSelected = generateRowActionAndSelected(attConfirmedShiftChange);
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == attConfirmedShiftChangeKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.AttConfirmedShiftChange]) {
            ConfigList.value[ScreenName.AttConfirmedShiftChange] = {
                Api: {
        ...
        attConfirmedShiftChange = ScreenName.AttConfirmedShiftChange;
        ...
        attConfirmedShiftChangeKeyTask = EnumTask.KT_AttConfirmedShiftChange;
        AttConfirmShiftChangeBusinessFunction.checkForReLoadScreen[attConfirmedShiftChange] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attConfirmedShiftChange && attConfirmShiftChangeViewDetail && enumName && (
                            ...
                            {keyQuery && (
                                <AttConfirmShiftChangeList
                                    detail={{
                                        ...
                                        screenName: attConfirmShiftChange,
                                        screenNameRender: attConfirmedShiftChange
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={attConfirmedShiftChangeKeyTask}
