...
const configDefault = [
    ...
    },
    {
        TypeView: 'E_MULTI',
        Name: 'ShiftName',
        DisplayKey: 'HRM_PortalApp_TopTab_AttConfirmShiftChange_ShiftChangeShiftNow',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
...
export default class AttConfirmShiftChangeViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
        ...
        try {
            ...
            if (id) {
                ...
                if (response && response.Status == EnumName.E_SUCCESS) {
                    ...
                    if (data.Status === 'E_CONFIRM' || data.Status === 'E_SUBMIT_TEMP') {
    ...
    componentDidMount() {
        AttConfirmShiftChangeBusinessFunction.setThisForBusiness(this);
        this.getDataItem();
    }
