...
class AttApproveSubmitTakeLateEarlyAllowed extends Component {
    constructor(props) {
        super(props);
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: attApproveSubmitTakeLateEarlyAllowedTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!attApproveSubmitTakeLateEarlyAllowed) {
            attApproveSubmitTakeLateEarlyAllowed = ScreenName.AttApproveSubmitTakeLateEarlyAllowed;
        }
        if (!configList[attApproveSubmitTakeLateEarlyAllowed]) {
            configList[attApproveSubmitTakeLateEarlyAllowed] = {
                Api: {
        ...
        const _configList = configList[attApproveSubmitTakeLateEarlyAllowed],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == attApproveSubmitTakeLateEarlyAllowedTask) {
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attApproveSubmitTakeLateEarlyAllowed && attSubmitTakeLateEarlyAllowedViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <AttTakeLateEarlyAllowedList
                                    ...
                                    keyDataLocal={attApproveSubmitTakeLateEarlyAllowedTask}
