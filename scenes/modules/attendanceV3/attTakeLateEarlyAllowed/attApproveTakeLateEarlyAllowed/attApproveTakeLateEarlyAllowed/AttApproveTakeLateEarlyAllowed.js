...
class AttApproveTakeLateEarlyAllowed extends Component {
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: attApproveTakeLateEarlyAllowedKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!attApproveTakeLateEarlyAllowed) {
            attApproveTakeLateEarlyAllowed = ScreenName.AttApproveTakeLateEarlyAllowed;
        }
        if (!configList[attApproveTakeLateEarlyAllowed]) {
            configList[attApproveTakeLateEarlyAllowed] = {
                Api: {
        ...
        const _configList = configList[attApproveTakeLateEarlyAllowed],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == attApproveTakeLateEarlyAllowedKeyTask) {
    ...
    componentDidMount() {
        ...
        attApproveTakeLateEarlyAllowedKeyTask = EnumTask.KT_AttApproveTakeLateEarlyAllowed;
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attApproveTakeLateEarlyAllowed && attApproveTakeLateEarlyAllowedViewDetail && enumName && (
                            ...
                            {keyQuery && (
                                <AttTakeLateEarlyAllowedList
                                    detail={{
                                        ...
                                        screenName: attApproveTakeLateEarlyAllowed,
                                        screenNameRender: ScreenName.AttApproveTakeLateEarlyAllowed
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={attApproveTakeLateEarlyAllowedKeyTask}
