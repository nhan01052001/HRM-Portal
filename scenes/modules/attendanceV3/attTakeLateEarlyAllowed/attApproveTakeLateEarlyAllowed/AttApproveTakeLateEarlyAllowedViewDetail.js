...
export default class AttApproveTakeLateEarlyAllowedViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
            configListDetail: null,
            dataRowActionAndSelected: generateRowActionAndSelected(ScreenName.AttApproveTakeLateEarlyAllowed),
    ...
    getDataItem = async () => {
        try {
            const _params = this.props.navigation.state.params,
                ...
                _configListDetail =
                    ConfigListDetail.value[ScreenName.AttApproveTakeLateEarlyAllowed] && 1 === 2
                        ? ConfigListDetail.value[ScreenName.AttApproveTakeLateEarlyAllowed]
                        : configDefault;
