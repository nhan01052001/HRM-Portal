...
export default class AttTakeLateEarlyAllowedList extends VnrRenderList {
    remoteData = (param = {}) => {
    ...
    render() {
        ...
        let isShowBtn =
            ...
            (detail.screenNameRender === ScreenName.AttSubmitTakeLateEarlyAllowed ||
                detail.screenNameRender === ScreenName.AttSaveTempSubmitTakeLateEarlyAllowed) && itemSelected.length === 0;
        return (
            <View
                style={[
