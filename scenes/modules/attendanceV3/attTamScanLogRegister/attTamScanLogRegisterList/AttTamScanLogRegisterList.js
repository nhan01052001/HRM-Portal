...
export default class AttTamScanLogRegisterList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    _renderFooterLoading = () => {
        return (
            <View accessibilityLabel={'VnrListDataItem-Footer'} style={stylesScreenDetailV3.loadingFooter}>
            ...
            if (
                ...
                dataSource[index].dataGroupMaster.forEach((element) => {
                    ...
                    if (element?.isSelect === true) {
                        itemSelected = itemSelected.concat(element);
                    } else {
                        nextState = {
                            isCheckAll: false
                        };
                        itemSelected = Vnr_Function.removeObjectInArray(itemSelected, element, valueField);
                    }
                });
            }
                        ...
                        >
                            <View
                                style={[
                                    ...
                                    isCheckAll && isCheckAll === true && stylesScreenDetailV3.checkAll
                                ]}
                            >
    ...
    render() {
        ...
        let isShowBtn =
            ...
            (detail.screenNameRender === ScreenName.AttSubmitTamScanLogRegister ||
                detail.screenNameRender === ScreenName.AttSaveTempSubmitTamScanLogRegister);
        return (
            <View
                style={[
