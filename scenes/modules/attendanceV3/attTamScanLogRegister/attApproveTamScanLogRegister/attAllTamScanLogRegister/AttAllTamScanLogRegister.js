...
let configList = null,
    enumName = null,
    attAllTamScanLogRegister = null,
    attApproveTamScanLogRegister = null,
    attApproveTamScanLogRegisterViewDetail = null,
    keyListTask = null,
    pageSizeList = 20;

class AttAllTamScanLogRegister extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attAllTamScanLogRegister]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttApproveTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attAllTamScanLogRegister] = false;
    ...
    paramsDefault = () => {
        if (!attAllTamScanLogRegister) {
            attAllTamScanLogRegister = ScreenName.AttAllTamScanLogRegister;
        }
        if (!configList[attAllTamScanLogRegister]) {
            configList[attAllTamScanLogRegister] = {
                Api: {
                    urlApi:
        ...
        const _configList = configList[attAllTamScanLogRegister],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attAllTamScanLogRegister);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttAllTamScanLogRegister;
        AttApproveTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attAllTamScanLogRegister] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attAllTamScanLogRegister && attApproveTamScanLogRegisterViewDetail && enumName && (
