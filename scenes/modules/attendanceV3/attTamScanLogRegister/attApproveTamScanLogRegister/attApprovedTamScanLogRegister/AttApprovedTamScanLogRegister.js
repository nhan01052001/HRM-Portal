...
let configList = null,
    enumName = null,
    attApprovedTamScanLogRegister = null,
    attApproveTamScanLogRegister = null,
    attApproveTamScanLogRegisterViewDetail = null,
    keyListTask = null,
    pageSizeList = 20;

class AttApprovedTamScanLogRegister extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attApprovedTamScanLogRegister]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttApproveTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attApprovedTamScanLogRegister] = false;
    ...
    paramsDefault = () => {
        if (!attApprovedTamScanLogRegister) {
            attApprovedTamScanLogRegister = ScreenName.AttApprovedTamScanLogRegister;
        }
        if (!configList[attApprovedTamScanLogRegister]) {
            configList[attApprovedTamScanLogRegister] = {
                Api: {
                ...
                BusinessAction: [
                    {
                        Type: 'E_CANCEL',
                        Resource: {
                            Name: 'New_Att_WaitingApprovedTamScanLogRegister_New_Index_btnCancel',
                            Rule: 'View'
                        },
                        Confirm: {
                            isInputText: true,
        ...
        const _configList = configList[attApprovedTamScanLogRegister],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attApprovedTamScanLogRegister);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
            pageSize: pageSizeList,
            Status: 'E_FIRST_APPROVED,E_APPROVED1,E_APPROVED2,E_APPROVED3,E_APPROVED'
        };
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttApprovedTamScanLogRegister;
        AttApproveTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attApprovedTamScanLogRegister] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attApprovedTamScanLogRegister && attApproveTamScanLogRegisterViewDetail && enumName && (
