...
let configList = null,
    enumName = null,
    attRejectTamScanLogRegister = null,
    attApproveTamScanLogRegister = null,
    attApproveTamScanLogRegisterViewDetail = null,
    keyListTask = null,
    pageSizeList = 20;

class AttRejectTamScanLogRegister extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (AttApproveTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attRejectTamScanLogRegister]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        AttApproveTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attRejectTamScanLogRegister] = false;
    ...
    paramsDefault = () => {
        if (!attRejectTamScanLogRegister) {
            attRejectTamScanLogRegister = ScreenName.AttRejectTamScanLogRegister;
        }
        if (!configList[attRejectTamScanLogRegister]) {
            configList[attRejectTamScanLogRegister] = {
                Api: {
        ...
        const _configList = configList[attRejectTamScanLogRegister],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(attRejectTamScanLogRegister);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_AttRejectTamScanLogRegister;
        AttApproveTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attRejectTamScanLogRegister] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attRejectTamScanLogRegister && attApproveTamScanLogRegisterViewDetail && enumName && (
