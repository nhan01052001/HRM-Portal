...
class AttSubmitTamScanLogRegister extends Component {
    ...
    reload = paramsFilter => {
        ...
        AttSubmitTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attSubmitTamScanLogRegister] = false;

        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: attSubmitTamScanLogRegisterKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!attSubmitTamScanLogRegister) {
            attSubmitTamScanLogRegister = ScreenName.AttSubmitTamScanLogRegister;
        }

        if (!configList[attSubmitTamScanLogRegister]) {
            configList[attSubmitTamScanLogRegister] = {
                Api: {
        ...
        const _configList = configList[attSubmitTamScanLogRegister],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == attSubmitTamScanLogRegisterKeyTask) {
    ...
    componentDidMount() {
        ...
        attSubmitTamScanLogRegisterKeyTask = EnumTask.KT_AttSubmitTamScanLogRegister;
        AttSubmitTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attSubmitTamScanLogRegister] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attSubmitTamScanLogRegister && attSubmitTamScanLogRegisterViewDetail && enumName && (
                            ...
                            {keyQuery && (
                                <AttTamScanLogRegisterList
                                    detail={{
                                        ...
                                        screenName: attSubmitTamScanLogRegister,
                                        screenNameRender: ScreenName.AttSubmitTamScanLogRegister
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={attSubmitTamScanLogRegisterKeyTask}
