            ...
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    onPress: (item, dataBody) =>
                        AttSubmitTamScanLogRegisterBusinessFunction.businessModifyRecord({ ...item }, dataBody, item),
                    ...actionEdit
                }
            ];
        }
        ...
        if (actionSendMailPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_SENDMAIL,
                    onPress: (item, dataBody) =>
                        AttSubmitTamScanLogRegisterBusinessFunction.businessSendMailRecords(
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    onPress: (items, dataBody) =>
                        AttSubmitTamScanLogRegisterBusinessFunction.businessSendMailRecords(items, dataBody),
                    ...actionSendMail
                }
            ];
        }
        ...
        if (actionDeletePer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_DELETE,
                    onPress: (item, dataBody) =>
                        AttSubmitTamScanLogRegisterBusinessFunction.businessDeleteRecords(
                            item ? (Array.isArray(item) ? item : [{ ...item }]) : [],
                            dataBody
                        ),
                    ...actionDelete
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    type: E_DELETE,
                    onPress: (item, dataBody) =>
                        AttSubmitTamScanLogRegisterBusinessFunction.businessDeleteRecords(item, dataBody),
                    ...actionDelete
                }
            ];
        }
        ...
        if (actionCancelPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_CANCEL,
                    onPress: (item, dataBody) =>
                        AttSubmitTamScanLogRegisterBusinessFunction.businessCancelRecords(
                            item ? (Array.isArray(item) ? item : [{ ...item }]) : [],
                            dataBody
                        ),
                    ...actionCancel
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    type: E_CANCEL,
                    onPress: (item, dataBody) =>
                        AttSubmitTamScanLogRegisterBusinessFunction.businessCancelRecords(item, dataBody),
                    ...actionCancel
                }
            ];
        }
...
export const AttSubmitTamScanLogRegisterBusinessFunction = {
    checkForReLoadScreen: {
        AttSubmitTamScanLogRegister: false,
        AttSaveTempSubmitTamScanLogRegister: false,
        AttRejectSubmitTamScanLogRegister: false,
        AttCanceledSubmitTamScanLogRegister: false,
    ...
    businessDeleteRecords: (items, dataBody) => {
        if (items.length === 0 && !dataBody) {
            ...
            HttpService.Post('[URI_CENTER]/api/Att_GetData/CheckPreventUser', {
                ListRecordID: selectedID,
                ActionMajor: 'E_TAMSCANLOG'
            }).then(res => {
                ...
                if (res && res.Status == EnumName.E_SUCCESS) {
                    if (res.Data && res.Data.length > 0) {
                        ...
                        AttSubmitTamScanLogRegisterBusinessFunction.confirmDelete({
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        AttSubmitTamScanLogRegisterBusinessFunction.setDelete(objValid);
                    }
                }
            });
        } else {
    ...
    setDelete: objValid => {
        ...
        VnrLoadingSevices.show();
        HttpService.Post('[URI_CENTER]/api/Att_TamScanLogRegister/DeleteTamScanLogRegister', {
    ...
    businessSendMailRecords: (items, dataBody) => {
        ...
        if (items.length === 0 && !dataBody) {
            ...
            if (selectedID.length == 0) {
                ...
                AttSubmitTamScanLogRegisterBusinessFunction.setSendMail({
    ...
    setSendMail: objValid => {
        ...
        VnrLoadingSevices.show();
        HttpService.Post('[URI_CENTER]/api/Att_TAMScanLogRegister/ProcessSendMailInOut', {
            Host: _uriPor,
            ListRecordID: objValid.strResultID
        }).then(res => {
            VnrLoadingSevices.hide();
    ...
    businessCancelRecords: (items, dataBody) => {
        if (items.length === 0 && !dataBody) {
            ...
            HttpService.MultiRequest([
                HttpService.Post('[URI_CENTER]/api/Att_TAMScanLogRegister/ValidateCancelRegisterV2', {
                    ListRecordID: selectedID
                }),
                HttpService.Get('[URI_CENTER]/api/Att_GetData/GetConfigNoteValidate?business=E_TAMSCANLOG')
            ]).then(resAll => {
                VnrLoadingSevices.hide();
                ...
                if (res && res.Status == EnumName.E_SUCCESS) {
                    if (res.Data && res.Data.length > 0) {
                        ...
                        AttSubmitTamScanLogRegisterBusinessFunction.confirmCancel({
                            strResultID: res.Data,
                            message: keyTrans.replace('[E_NUMBER]', numberRow)
                        }, isNote);
                    } else {
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        AttSubmitTamScanLogRegisterBusinessFunction.setCancel({ ...objValid, Comment: reason });
                    }
                }
            });
        } else {
            AttSubmitTamScanLogRegisterBusinessFunction.setCancel(objValid);
        }
    },

    setCancel: objValid => {
        VnrLoadingSevices.show();
        HttpService.Post('[URI_CENTER]/api/Att_TAMScanLogRegister/ChangeStatusCancelRegister', {
