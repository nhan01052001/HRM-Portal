...
class AttSaveTempSubmitTamScanLogRegister extends Component {
    constructor(props) {
        super(props);
    ...
    reload = paramsFilter => {
        ...
        AttSubmitTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attSaveTempSubmitTamScanLogRegister] = false;

        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: attSaveTempSubmitTamScanLogRegisterKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!attSaveTempSubmitTamScanLogRegister) {
            attSaveTempSubmitTamScanLogRegister = ScreenName.AttSaveTempSubmitTamScanLogRegister;
        }
        if (!configList[attSaveTempSubmitTamScanLogRegister]) {
            configList[attSaveTempSubmitTamScanLogRegister] = {
                Api: {
                ...
                BusinessAction: [
                    {
                        Type: 'E_MODIFY',
                        Resource: {
                            Name: 'New_Att_TamScanLogRegister_New_Index_V2',
                            Rule: 'Modify'
                        },
                        Confirm: {
                            isInputText: true,
                    ...
                    },
                    {
                        Type: 'E_SENDMAIL',
                        Resource: {
                            Name: 'New_Att_TamScanLogRegister_Index_btnSendMail',
                            Rule: 'View'
                        }
                    },
                    {
        ...
        const _configList = configList[attSaveTempSubmitTamScanLogRegister],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == attSaveTempSubmitTamScanLogRegisterKeyTask) {
    ...
    componentDidMount() {
        ...
        attSaveTempSubmitTamScanLogRegisterKeyTask = EnumTask.KT_AttSaveTempSubmitTamScanLogRegister;
        AttSubmitTamScanLogRegisterBusinessFunction.checkForReLoadScreen[attSaveTempSubmitTamScanLogRegister] = false;
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {attSaveTempSubmitTamScanLogRegister && attSubmitTamScanLogRegisterViewDetail && enumName && (
                            ...
                            {keyQuery && (
                                <AttTamScanLogRegisterList
                                    detail={{
                                        ...
                                        screenName: attSubmitTamScanLogRegister,
                                        screenNameRender: attSaveTempSubmitTamScanLogRegister
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={attSaveTempSubmitTamScanLogRegisterKeyTask}
