...
import TraineePlanList from './TraineePlanList';
...
export default class TraineePlan extends Component {
    constructor(porps) {
        super(porps);
        this.state = {
            renderRow: null,
    ...
    generaRender = () => {
        ...
        screenViewDetail = ScreenName.TraineePlanViewDetail;
                ...
                {isShowList && (
                    <View style={[styleSheets.container]}>
                        <TraineePlanList
                            ...
                            api={{
                                urlApi: '[URI_HR]/Tra_GetData/GetPlanList/',
                                type: 'E_POST',
                                dataBody: {
