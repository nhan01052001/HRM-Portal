...
export default class TraineeCertificateItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
            ...
            <View style={styles.swipeable} key={index}>
                <View style={styles.styViewItem}>
                    ...
                    <View style={styles.styContentItem}>
                        ...
                        {/* {
                            TimeCouse != '' && (
                                <View style={[styles.styLine, { marginBottom: 0 }]}>
                                    <View style={styles.valueView}>
                                        <Text numberOfLines={1}
                                            style={[styleSheets.text, styles.styTypeTime]}>
                                            {TimeCouse}
                                        </Text>
                                    </View>
                                </View>
