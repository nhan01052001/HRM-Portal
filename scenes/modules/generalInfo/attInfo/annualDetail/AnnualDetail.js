...
import AnnualDetailList from './AnnualDetailList';
import VnrTextInput from '../../../../../components/VnrTextInput/VnrTextInput';
import VnrText from '../../../../../components/VnrText/VnrText';
import moment from 'moment';
import HttpService from '../../../../../utils/HttpService';
import { ConfigList } from '../../../../../assets/configProject/ConfigList';
import ChartAnnual from './ChartAnnual';
import EmptyData from '../../../../../components/EmptyData/EmptyData';
import VnrLoading from '../../../../../components/VnrLoading/VnrLoading';
import { IconSearchOutline } from '../../../../../constants/Icons';
import { ScreenName } from '../../../../../assets/constant';
export default class AnnualDetail extends Component {
    constructor(porps) {
        super(porps);
    ...
    getDataGeneral = () => {
        const listRequest = [
            HttpService.Post('[URI_HR]/Att_GetData/GetAnnualLeaveByProfileId', {
                profileID: null,
                YearAnnual: this.state.Year
            }),
            HttpService.Post('[URI_HR]/Att_GetData/GetAnnualDetailByProfileId', {
                profileID: null,
                YearAnnual: this.state.Year
            })
        ];
    ...
    render() {
        ...
        let renderRow = ConfigList && ConfigList.value ? ConfigList.value['GeneralInfoAttAnnualDetail']['Row'] : [],
            listConfigGeneral = ConfigList && ConfigList.value ? ConfigList.value['GeneralInfoAttAnnual']['Row'] : [],
            listConfigMaster = ConfigList && ConfigList.value ? ConfigList.value['GeneralInfoAttAnnual']['Master'] : [],
            viewContent = <View />;
            ...
            viewContent = (
                <View style={CustomStyleSheet.flex(1)}>
                    ...
                    <View style={styles.containerWhite}>
                        <View style={CustomStyleSheet.flex(1)}>
                            <View style={[styleViewTitleForGroup.styleViewTitleGroup, CustomStyleSheet.marginBottom(10)]}>
                                <VnrText style={styleViewTitleForGroup.textLableGroup} i18nKey={'AnnualLeave_Tab'} />
                            </View>
                            <AnnualDetailList
                                detail={{
                                    dataLocal: false,
                                    screenDetail: ScreenName.AnnualDetailViewDetail,
                                    screenName: ScreenName.GeneralInfoAttAnnualDetail
                                }}
                                dataLocal={dataList}
                                valueField="ID"
