...
export default class AnnualDetailItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
                ...
                <View style={styles.viewButton}>
                    ...
                    <View style={styles.rightBody}>
                        <View style={styles.Line}>
                            ...
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                                    {dataItem.AvailableTotalFormat ? dataItem.AvailableTotalFormat : ''}
                                </Text>
                                <Text numberOfLines={1} style={[styleSheets.text, styles.txtDay]}>
                                    {dataItem.AvailableTotalFormat ? `(${translate('E_DAY_LOWERCASE')})` : ''}
                                </Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.Line}>
                            ...
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                                    {dataItem.RemainFormat ? dataItem.RemainFormat : ''}
                                </Text>
                                <Text numberOfLines={1} style={[styleSheets.text, styles.txtDay]}>
                                    {dataItem.RemainFormat ? `(${translate('E_DAY_LOWERCASE')})` : ''}
                                </Text>
                            </View>
                        </View>
                    </View>
