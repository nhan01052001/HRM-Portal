...
export default class AttendanceCalenderDetailHistoryItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        // if (dataItem.HoursFrom && dataItem.HoursTo && ['E_FIRSTHALFSHIFT', 'E_MIDDLEOFSHIFT', 'E_LASTHALFSHIFT'].includes(dataItem.DurationType)) {
        //   textFieldTime = `${moment(dataItem.HoursFrom).format('HH:mm')} - ${moment(
        //     dataItem.HoursTo,
        //   ).format('HH:mm')}`;
        // }
        ...
        //           style={[styleSheets.text, styles.line_value_value]}
        //           numberOfLines={1}>
        //           {dataItem.LeaveDayTypeCode != null
        //             ? dataItem.LeaveDayTypeCode
        //             : ''}
        //         </Text>
        //       </View>
        //     </View>
            ...
            <Swipeable
                ref={(ref) => {
                    ...
                    if (
                        ...
                        Array.isArray(listItemOpenSwipeOut) &&
                        listItemOpenSwipeOut.findIndex((value) => {
                            return value['ID'] == index;
                        }) < 0
                    ) {
                        listItemOpenSwipeOut.push({ ID: index, value: ref });
                    } else if (listItemOpenSwipeOut && Array.isArray(listItemOpenSwipeOut)) {
                ...
                >
                    ...
                    <View style={[styles.container]} key={index}>
                        <View style={styles.Line}>
                            <Text>
                                {translate('HRM_System_AsynTask_Summary_CutOffDuration')} :{' '}
                                {dataItem && dataItem.CutOffDurationName ? dataItem.CutOffDurationName : ''}
                            </Text>
                        </View>
                        <View style={styles.viewReason}>
                            <Text numberOflines={1} style={[styleSheets.textItalic, styles.viewReason_text]}>
                                {dataItem.RejectReason != null
                                    ? `${translate('HRM_Attendance_AttendanceTable_ReasonReject')}: ${
                            ...
                            <View style={styles.dateTimeSubmit}>
                                <Text numberOfLines={1} style={[styleSheets.textItalic, styles.dateTimeSubmit_Text]}>
                                    {dataItem.DateCreate !== null &&
                                        ...
                                        `${translate('E_AT_TIME')} ${moment(dataItem.DateCreate).format('DD/MM/YYYY')}`}
                                </Text>
                            </View>
                            <View
                                style={[
