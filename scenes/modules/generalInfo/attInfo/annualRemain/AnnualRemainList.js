...
export default class AnnualRemainList extends React.Component {
    ...
    _renderLoading = () => {
        return (
            <View style={styles.styViewLoadingFFooter}>
...
const styles = StyleSheet.create({
    styViewLoadingFFooter: { flex: 1, paddingVertical: styleSheets.p_10 }
});
