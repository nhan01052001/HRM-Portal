...
let enumName = null,
    topTabHisProfilePersonalInfo = null,
    // topTabHisProfilePersonalInfoViewDetail = null,
    topTabHisProfilePersonalInfoTask = null,
    pageSizeList = 20;

class TopTabHisProfilePersonalInfo extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            // TopTabHisProfilePersonalInfoBusinessFunction.setThisForBusiness(this);
            // if (HouseholdConfirmedBusinessFunction.checkForLoadEditDelete[ScreenName.TopTabHisProfilePersonalInfo]) {
            //   this.reload();
            // }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        // HouseholdConfirmedBusinessFunction.checkForLoadEditDelete[ScreenName.TopTabHisProfilePersonalInfo] = false;

        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: topTabHisProfilePersonalInfoTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const dataRowActionAndSelected = generateRowActionAndSelected(topTabHisProfilePersonalInfo);
        let _params = {};
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == topTabHisProfilePersonalInfoTask) {
    ...
    componentDidMount() {
        ...
        if (!ConfigList.value[ScreenName.TopTabHisProfilePersonalInfo]) {
            PermissionForAppMobile.value['HRM_HR_Profile_PersonalInfo_Grid_WaitingConfirm_btnDel'] = {
                View: true
            };
            PermissionForAppMobile.value['HRM_HR_Profile_PersonalInfo_Grid_WaitingConfirm_btnTransfer'] = {
                View: true
            };
            PermissionForAppMobile.value['HRM_HR_Profile_PersonalInfo_Grid_WaitingConfirm_btnAttachFile'] = {
                View: true
            };

            ConfigList.value[ScreenName.TopTabHisProfilePersonalInfo] = {
                Api: {
                ...
                BusinessAction: [
                    {
                        Type: 'E_DELETE',
                        Resource: {
                            Name: 'HRM_HR_Profile_PersonalInfo_Grid_WaitingConfirm_btnDel',
                            Rule: 'View'
                        },
                        Confirm: {
                            isInputText: false,
                    ...
                    },
                    {
                        Type: 'E_SENDMAIL',
                        Resource: {
                            Name: 'HRM_HR_Profile_PersonalInfo_Grid_WaitingConfirm_btnTransfer',
                            Rule: 'View'
                        }
                    },
                    {
                        Type: 'E_ATTACH_FILE',
                        Resource: {
                            Name: 'HRM_HR_Profile_PersonalInfo_Grid_WaitingConfirm_btnAttachFile',
                            Rule: 'View'
                        }
                    }
                ]
        ...
        topTabHisProfilePersonalInfo = ScreenName.TopTabHisProfilePersonalInfo;
        // topTabHisProfilePersonalInfoViewDetail = ScreenName.TopTabHisProfilePersonalInfoViewDetail;
        topTabHisProfilePersonalInfoTask = EnumTask.KT_TopTabHisProfilePersonalInfo;
    ...
    render() {
        ...
        return (
            <SafeAreaView {...styleSafeAreaView}>
                {topTabHisProfilePersonalInfo && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <TabHistoryList
                                    detail={{
                                        dataLocal: false,
                                        // screenDetail: topTabHisProfilePersonalInfoViewDetail,
                                        screenName: topTabHisProfilePersonalInfo
                                    }}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={topTabHisProfilePersonalInfoTask}
