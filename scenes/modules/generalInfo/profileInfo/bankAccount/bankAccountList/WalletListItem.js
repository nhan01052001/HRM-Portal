...
export default class WalletListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            ...
            >
                    ...
                    <View style={[styles.container]} key={index}>
                        <View style={styles.wrapAllLine}>
                            ...
                            <View style={styles.line}>
                                <View style={styles.maxW40}>
                                    <Text style={[styleSheets.text, styles.line_lable]}>
                                        {translate('HRM_Sal_EWalletInformation_EWalletNo')}
                                    </Text>
                                </View>
                                <View style={styles.maxW60}>
                                    <Text style={[styleSheets.text, styles.line_text]}>{dataItem?.EWalletNo}</Text>
                                </View>
                            </View>
                            {/* <View style={styles.line}>
                <View style={styles.maxW40}>
                  <Text style={[styleSheets.text, styles.line_lable]}>{translate("HRM_Category_Bank")}</Text>
                </View>
                <View style={styles.maxW60}>
              ...
              <View style={styles.line}>
                <View style={styles.maxW40}>
                  <Text style={[styleSheets.text, styles.line_lable]}>{translate("iBHXHD02TSTangCol47")}</Text>
                </View>
                <View style={styles.maxW60}>
                  <Text numberOfLines={2} style={[styleSheets.text, styles.line_text]}>{dataItem?.BankBrandName}</Text>
                </View>
              </View> */}
                        </View>
