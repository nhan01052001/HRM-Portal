...
export default class BankAccountListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    shouldComponentUpdate(nextProps) {
        if (
            ...
            nextProps.isFromAddOrEdit == true
        ) {
            return true;
        } else {
            return false;
            ...
            >
                <View style={[styles.swipeableLayout, isSelect && { backgroundColor: Colors.Secondary95 }]}>
                    ...
                    <View style={[styles.container]} key={index}>
                        <View style={styles.wrapAllLine}>
                            {isFromAddOrEdit && (
                                <View style={styles.line}>
                                    <View style={styles.maxW40}>
                                        <Text style={[styleSheets.lable]}>
                                            {translate('Sal_Infomation_Account') + ' ' + dataItem?.accountNumber}
                                        </Text>
                                    </View>
                                </View>
                            )}
                            ...
                            <View style={styles.line}>
                                <View style={styles.maxW40}>
                                    <Text style={[styleSheets.text, styles.line_lable]}>
                                        {translate('HRM_Category_AccountType_AccountTypeName')}
                                    </Text>
                                </View>
                                <View style={styles.maxW60}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                            ...
                            <View style={styles.line}>
                                <View style={styles.maxW40}>
                                    <Text style={[styleSheets.text, styles.line_lable]}>
                                        {translate('HRM_Category_Bank')}
                                    </Text>
                                </View>
                                <View style={styles.maxW60}>
                                    <Text style={[styleSheets.text, styles.line_text]}>{dataItem?.BankName}</Text>
                                </View>
                            </View>
                            <View style={styles.line}>
                                <View style={styles.maxW40}>
                                    <Text style={[styleSheets.text, styles.line_lable]}>
                                        {translate('iBHXHD02TSTangCol47')}
                                    </Text>
                                </View>
                                <View style={styles.maxW60}>
                                    <Text numberOfLines={2} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem?.BankBrandName}
                                    </Text>
                                </View>
                            </View>
                            {/*
              {
                (isMultipleAccounts && !isFromAddOrEdit) && (
                  <View style={styles.line}>
                    <View style={styles.maxW40}>
                      <Text style={[styleSheets.text, styles.line_lable]}>{translate("HRM_Payroll_Sal_SalaryInformation_NumberOfAccount")}</Text>
                    </View>
                    <View style={styles.maxW60}>
                      <Text style={[styleSheets.text, styles.line_text]}>{dataItem?.NumberOfAccountView}</Text>
                    </View>
                  </View>
                )
              }
 */}
                        ...
                        {dataItem.DateCreate != null && dataItem.StatusView != null && (
