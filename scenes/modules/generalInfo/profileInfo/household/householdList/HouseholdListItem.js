...
export default class HouseholdListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            <View style={[styles.lineLeft, CustomStyleSheet.borderRightWidth(0)]}>
                                <View style={styles.line_date_row}>
                                    <Text
                                        ...
                                        numberOfLines={1}
                                    >
                                        {dataItem.RelativeName ? dataItem.RelativeName : ''}
                                    </Text>
                                </View>

                                <View style={styles.line_date_row}>
                                    <VnrText
                                        i18nKey={'HRM_Hre_References_Relationship'}
                                    ...
                                    <View style={[styles.line_time_wrap]}>
                                        <Text
                                            ...
                                            numberOfLines={1}
                                        >
                                            {dataItem.HouseholdTypeName ? dataItem.HouseholdTypeName : ''}
                                        </Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.line_date_row}>
                                    <VnrText
                                        i18nKey={'HRM_HR_Relatives_RelativeDayOfBirth'}
                                        style={[styleSheets.text, styles.line_lable]}
                                    />
                                    <View style={styles.line_time_wrap}>
                                        <Text style={[styleSheets.text, styles.line_text]} numberOfLines={1}>
                                            {dataItem.DateOfBirth ? dataItem.DateOfBirth : ''}
                                        </Text>
                                    </View>
                                </View>
                            </View>
