...
import ResidenceCardListItem from './ResidenceCardListItem';
...
export default class ResidenceCardList extends React.Component {
    constructor(props) {
        super(props);
        ...
        if (isLoading) {
            ...
            contentList = (
                <FlatList
                    ...
                    style={
                        !this.isHaveFilter ? CustomStyleSheet.paddingTop(Size.defineSpace) : CustomStyleSheet.paddingTop(0)
                    }
