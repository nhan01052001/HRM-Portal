...
export default class ResidenceCardListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <View style={styles.styContentItem}>
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    ...
                                    >
                                        {translate('HRM_HR_ResidenceCard_DecisionNo')}
                                    </Text>
                                </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        ...
                                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('HRM_HR_ResidenceCard_DateAllocated')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, CustomStyleSheet.alignItems('flex-end')]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem?.DateAllocated
                                            ? moment(dataItem?.DateAllocated).format('DD/MM/YYYY')
                                            : ''}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        ...
                                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('HRM_HR_ResidenceCard_DateStart')}
                                    </Text>
                                </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        ...
                                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('HRM_HR_ResidenceCard_DateEnd')}
                                    </Text>
                                </View>
