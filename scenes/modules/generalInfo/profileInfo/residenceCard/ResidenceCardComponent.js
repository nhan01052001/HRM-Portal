...
export default class ResidenceCardComponent extends Component {
    constructor(porps) {
        super(porps);
        this.state = {
            isLoading: true,
            ...
            <View style={styles.styBlock}>
                <View style={styles.styTopTitle}>
                    ...
                    {isLoading ? (
                        ...
                        <TouchableOpacity onPress={() => DrawerServices.navigate('ResidenceCard')}>
