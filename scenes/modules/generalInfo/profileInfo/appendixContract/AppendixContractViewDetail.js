...
const configDefault = [
    ...
    {
        Name: 'AppendixContractTypeName',
        DisplayKey: 'AppendixContractName',
        DataType: 'string'
    },
    {
        Name: 'ContractNo',
    ...
    },
    {
        ...
        DisplayKey: 'HRM_Hre_ContractExtend_DateStartContract',
        DataType: 'DateTime',
        DataFormat: 'DD/MM/YYYY'
    },
    {
        Name: 'DateEndContract',
        DisplayKey: 'HRM_Hre_ContractExtend_DateEndContract',
        DataType: 'DateTime',
        DataFormat: 'DD/MM/YYYY'
    },
    {
    ...
    {
        Name: 'TypeAppendixView',
        DisplayKey: 'HRM_HR_AppendixContract_TypeAppendix',
        DataType: 'string'
    }
];

export default class AppendixContractViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
