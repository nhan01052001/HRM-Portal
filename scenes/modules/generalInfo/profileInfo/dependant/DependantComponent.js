...
export default class DependantComponent extends Component {
    constructor(porps) {
        super(porps);
        this.state = {
            isLoading: true,
    ...
    getData = () => {
        ...
        HttpService.Post('[URI_HR]/Hre_GetData/GetDependantListByProfileID', dataBody, null, this.getData).then(res => {
                ...
                <View style={styles.styTopTitle}>
                    <View style={styles.styWrap}>
                        <VnrText
                            ...
                            i18nKey={'HRM_HR_Dependant_DependantName'}
                            numberOfLines={1}
                        />
                        {length > 0 && (
                    ...
                    {isLoading ? (
                        ...
                        <TouchableOpacity onPress={() => DrawerServices.navigate('TopTabDependantInfo')}>
