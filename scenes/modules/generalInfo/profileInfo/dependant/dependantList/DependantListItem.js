...
export default class DependantListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        if (dataItem.DateOfBirth) {
            TimeCouse = moment(dataItem.DateOfBirth).format('DD/MM/YYYY');
        }
                    ...
                    <View style={[styles.container]} key={index}>
                        <View style={styles.styContentItem}>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_lable]}>
                                        {translate('HRM_Hre_References_Relationship')}
                                    </Text>
                                </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_lable]}>
                                        {translate('HRM_Payroll_Sal_TaxInformationRegister_DateOfBirth')}
                                    </Text>
                                </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text numberOfLines={2} style={[styleSheets.text, styles.line_lable]}>
                                        {translate('HRM_Hre_Relative_StartPayPeriodDecrease')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, { alignItems: 'flex-end' }]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem.StartPayPeriodDecrease
                                            ? moment(dataItem.StartPayPeriodDecrease).format('DD/MM/YYYY')
                                            : null}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text numberOfLines={2} style={[styleSheets.text, styles.line_lable]}>
                                        {translate('HRM_Hre_Relative_EndPayPeriodDecrease')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, { alignItems: 'flex-end' }]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem.EndPayPeriodDecrease
                                            ? moment(dataItem.EndPayPeriodDecrease).format('DD/MM/YYYY')
                                            : null}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_lable]}>
                                        {translate('HRM_Attendance_Pregnancy_MonthOfEffect')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, { alignItems: 'flex-end' }]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem.MonthOfEffect
                                            ? moment(dataItem.MonthOfEffect).format('DD/MM/YYYY')
                                            : null}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_lable]}>
                                        {translate('HRM_Payroll_ExpensesBudget_MonthEnd')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, { alignItems: 'flex-end' }]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem.MonthOfExpiry
                                            ? moment(dataItem.MonthOfExpiry).format('DD/MM/YYYY')
                                            : null}
                                    </Text>
                                </View>
                            </View>
