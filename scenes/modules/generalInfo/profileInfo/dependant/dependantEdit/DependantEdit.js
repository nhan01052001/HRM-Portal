...
import { generateRowActionAndSelected, DependantBusinessFunction } from '../DependantBusinessFunction';
...
export default class DependantEdit extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataBody: null,
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            DependantBusinessFunction.setThisForBusiness(this, false);
            if (DependantBusinessFunction.checkForLoadEditDelete[ScreenName.DependantEdit]) {
                this.reload();
            }
        });
    ...
    reload = paramsFilter => {
        DependantBusinessFunction.checkForLoadEditDelete[ScreenName.DependantEdit] = false;
    ...
    generaRender = () => {
        ...
        enumName = EnumName;
        screenName = ScreenName.DependantEdit;
        screenViewDetail = ScreenName.DependantEditViewDetail;
                ...
                {dataBody && (
                    <View style={[styleSheets.container]}>
                        <DependantList
                            ...
                            api={{
                                urlApi: '[URI_HR]/Hre_GetData/GetHre_DependantByDataStatus_Edit',
                                type: 'E_POST',
                                dataBody: dataBody
                            }}
                            valueField="ID"
