...
import ContractHistoryListItem from './ContractHistoryListItem';
...
export default class ContractHistoryList extends React.Component {
    constructor(props) {
        super(props);
                ...
                .then(resData => {
                    ...
                    if (res && res !== EnumName.E_EMPTYDATA) {
                        ...
                        data.forEach(item => {
                            ...
                            item.itemStatus = Vnr_Services.formatStyleStatusApp(item.StatusEva);
