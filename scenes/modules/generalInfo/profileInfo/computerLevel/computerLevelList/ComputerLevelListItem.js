...
export default class ComputerLevelListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <View style={styles.styContentItem}>
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        numberOfLines={1}
                                        style={[styleSheets.text, styles.txtLable_1, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('ComputingSpecialTypeName')}
                                    </Text>
                                </View>
                                ...
                                <View style={[styles.styLineLeft, CustomStyleSheet.alignItems('flex-end')]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.txtLable_1]}>
                                        {dataItem?.ComputingSpecialTypeName}
                                    </Text>
                                </View>
                            </View>
