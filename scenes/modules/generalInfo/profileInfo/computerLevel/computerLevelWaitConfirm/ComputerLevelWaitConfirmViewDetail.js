...
const configDefault = [
    ...
    },
    {
        ...
        DataType: 'string',
        FieldChange: 'ComputingSpecialTypeName'
    },
    {
        Name: 'Grade',
        DisplayKey: 'Grade',
...
export default class ComputerLevelWaitConfirmViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
            configListDetail: null,
            dataRowActionAndSelected: generateRowActionAndSelected(ScreenName.ComputerLevelWaitConfirm),
    ...
    getDataItem = (isReload = false) => {
        try {
            ...
            if (!Vnr_Function.CheckIsNullOrEmpty(dataId) || isReload) {
                ...
                HttpService.Get(
                    `[URI_HR]/Hre_GetDataV2/getHreRequestInfo_Common_ByOriginID?ProfileID=${profileID}&tableChange=Hre_ProfileComputingLevel`
                )
                    .then(res => {
                        if (res && res.length > 0) {
