        ...
        if (actionEditPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_MODIFY,
                    onPress: (item) => ComputerLevelConfirmedBusinessFunction.businessModifyRecord(item),
                    ...actionEdit
                }
            ];
        }
...
export const ComputerLevelConfirmedBusinessFunction = {
    ...
    businessModifyRecord: item => {
        ...
        HttpService.Get(`[URI_HR]/api/Hre_ComputerLevel/GetById?ID=${item.ID}`).then(res => {
