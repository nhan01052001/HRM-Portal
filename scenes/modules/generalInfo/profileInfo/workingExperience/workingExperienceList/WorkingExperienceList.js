...
import WorkingExperienceListItem from './WorkingExperienceListItem';
import { ConfigListFilter } from '../../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class WorkingExperienceList extends React.Component {
    constructor(props) {
        super(props);
