...
import {
    WorkingExperienceWaitConfirmBusinessFunction,
    generateRowActionAndSelected
} from './WorkingExperienceWaitConfirmBusinessFunction';
...
let enumName = null,
    workingExperienceWaitConfirm = null,
    workingExperienceWaitConfirmViewDetail = null,
    workingExperienceWaitConfirmTask = null,
    pageSizeList = 20;

class WorkingExperienceWaitConfirm extends Component {
    constructor(props) {
        super(props);
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: workingExperienceWaitConfirmTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const dataRowActionAndSelected = generateRowActionAndSelected(workingExperienceWaitConfirm),
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == workingExperienceWaitConfirmTask) {
    ...
    componentDidMount() {
        ...
        if (!ConfigList.value[ScreenName.WorkingExperienceWaitConfirm]) {
            PermissionForAppMobile.value['HRM_HR_WorkingExperience_Portal_WaitingGrid'] = {
                View: true
            };

            PermissionForAppMobile.value['HRM_HR_WorkingExperience_Portal_WaitingGrid_btnTransfer'] = {
                View: true
            };

            PermissionForAppMobile.value['HRM_HR_WorkingExperience_Portal_WaitingGrid_btnEdit'] = {
                View: true
            };

            PermissionForAppMobile.value['HRM_HR_WorkingExperience_Portal_WaitingGrid_btnDel'] = {
                View: true
            };

            ConfigList.value[ScreenName.WorkingExperienceWaitConfirm] = {
                Api: {
                    urlApi: '[URI_HR]/Hre_GetData/GetHre_WorkingExperience_Add',
                    type: 'POST',
                    pageSize: 20
                },
                Order: [
                ...
                BusinessAction: [
                    {
                        Type: 'E_SENDMAIL',
                        Resource: {
                            Name: 'HRM_HR_WorkingExperience_Portal_WaitingGrid_btnTransfer',
                            Rule: 'View'
                        }
                    },
                    {
                        Type: 'E_MODIFY',
                        Resource: {
                            Name: 'HRM_HR_WorkingExperience_Portal_WaitingGrid_btnEdit',
                            Rule: 'View'
                        },
                        Confirm: {
                            isInputText: false,
                    ...
                    },
                    {
                        Type: 'E_DELETE',
                        Resource: {
                            Name: 'HRM_HR_WorkingExperience_Portal_WaitingGrid_btnDel',
                            Rule: 'View'
                        },
                        Confirm: {
                            isInputText: false,
        ...
        workingExperienceWaitConfirmViewDetail = ScreenName.WorkingExperienceWaitConfirmViewDetail;
        workingExperienceWaitConfirmTask = EnumTask.KT_WorkingExperienceWaitConfirm;
    ...
    render() {
        ...
        return (
            <SafeAreaView {...styleSafeAreaView}>
                {workingExperienceWaitConfirm && workingExperienceWaitConfirmViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <WorkingExperienceList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: workingExperienceWaitConfirmViewDetail,
                                        screenName: workingExperienceWaitConfirm
                                    }}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={workingExperienceWaitConfirmTask}
                                    ...
                                    api={{
                                        urlApi: '[URI_HR]/Hre_GetData/GetHre_WorkingExperience',
