...
import TaxInfoListItem from './TaxInfoListItem';
...
export default class TaxInfoList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            itemSelected: [],
    ...
    handelListActionParamsScreenDetail = (dataItem) => {
        ...
        let listActions = [];
        if (!Vnr_Function.CheckIsNullOrEmpty(dataItem.BusinessAllowAction) && Array.isArray(rowActions)) {
