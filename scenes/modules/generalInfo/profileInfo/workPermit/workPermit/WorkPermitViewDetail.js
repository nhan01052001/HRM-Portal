...
import { WorkPermitBusinessFunction } from './WorkPermitBusinessFunction';
...
const configDefault = [
    ...
    {
        TypeView: 'E_GROUP',
        DisplayKey: 'HRM_PortalApp_WorkPermitInformation',
        IsBold: true,
        DataType: 'string'
    },
    {
        Name: 'WorkPermitType',
        DisplayKey: 'HRM_Hre_WorkPermit_WorkPermitType',
        DataType: 'string'
    },
    {
        Name: 'WorkPermitNo',
        DisplayKey: 'HRM_Hre_WorkPermit_WorkPermitNo',
        DataType: 'string'
    },
    {
        Name: 'WorkPermitAddress',
        DisplayKey: 'HRM_Hre_WorkPermit_WorkPermitAddress',
        DataType: 'string'
    },
    {
        Name: 'ExtendTime',
        DisplayKey: 'HRM_Hre_WorkPermit_ExtendTime',
        DataType: 'string'
    },
    {
    ...
    {
        Name: 'DateEffect',
        DisplayKey: 'HRM_HR_EffectiveDate',
        DataType: 'datetime',
        DataFormat: 'DD/MM/YYYY'
    },
    {
        Name: 'WorkPermitExpiredDate',
        DisplayKey: 'HRM_Hre_WorkPermit_WorkPermitExpiredDate',
        DataType: 'datetime',
        DataFormat: 'DD/MM/YYYY'
    },
    {
...
export default class WorkPermitViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
    ...
    // }
    componentDidMount() {
        WorkPermitBusinessFunction.setThisForBusiness(this);
        this.getDataItem();
    }
