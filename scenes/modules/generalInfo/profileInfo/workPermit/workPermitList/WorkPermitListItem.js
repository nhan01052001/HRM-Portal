...
export default class WorkPermitListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <View style={styles.styContentItem}>
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        numberOfLines={1}
                                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('HRM_Hre_WorkPermit_WorkPermitNo')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, CustomStyleSheet.alignItems('flex-end')]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem?.WorkPermitNo}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        ...
                                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('HRM_HR_Certificate_DateOfIssuance')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, CustomStyleSheet.alignItems('flex-end')]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem?.WorkPermitInsDate
                                            ? moment(dataItem?.WorkPermitInsDate).format('DD/MM/YYYY')
                                            : ''}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        ...
                                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('HRM_Tra_PlanDetail_DurationDateFrom')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, CustomStyleSheet.alignItems('flex-end')]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem?.DateFrom ? moment(dataItem?.DateFrom).format('DD/MM/YYYY') : ''}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        ...
                                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('HRM_Tra_PlanDetail_DurationDateTo')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, CustomStyleSheet.alignItems('flex-end')]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem?.DateTo ? moment(dataItem?.DateTo).format('DD/MM/YYYY') : ''}
                                    </Text>
                                </View>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    styViewRightAction: { maxWidth: 300,
        flexDirection: 'row',
        marginBottom: 0.5 },
    swipeable: {
        flex: 1,
