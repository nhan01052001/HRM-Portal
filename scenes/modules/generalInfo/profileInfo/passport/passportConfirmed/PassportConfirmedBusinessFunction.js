        ...
        if (actionEditPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_MODIFY,
                    onPress: (item) => PassportConfirmedBusinessFunction.businessModifyRecord(item),
                    ...actionEdit
                }
            ];
        }
...
export const PassportConfirmedBusinessFunction = {
    ...
    businessModifyRecord: item => {
        ...
        HttpService.Get(`[URI_HR]/api/Hre_Passport/GetById?ID=${item.ID}`).then(res => {
