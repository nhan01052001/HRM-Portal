...
import {
    ...
    PassportWaitConfirmBusinessFunction
} from './PassportWaitConfirmBusinessFunction';
...
let configList = null,
    enumName = null,
    passportWaitConfirm = null,
    passportWaitConfirmViewDetail = null,
    passportWaitConfirmKeyTask = null,
    pageSizeList = 20;

class PassportWaitConfirm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataBody: null,
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (PassportConfirmedBusinessFunction.checkForLoadEditDelete[ScreenName.PassportWaitConfirm]) {
                this.reload();
            }
        });
    ...
    reload = paramsFilter => {
        ...
        PassportConfirmedBusinessFunction.checkForLoadEditDelete[ScreenName.PassportWaitConfirm] = false;

        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: passportWaitConfirmKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!configList[passportWaitConfirm]) {
            configList[passportWaitConfirm] = {
                Api: {
                    urlApi: '[URI_HR]/Hre_GetDataV2/GetHre_Passport',
                    type: 'POST',
                    pageSize: 20
                },
                Order: [
                ...
                BusinessAction: [
                    {
                        Type: 'E_SENDMAIL',
                        Resource: {
                            Name: 'HRM_HR_Hre_Passport_Portal_Create_WaitingGrid_btnTransfer',
                            Rule: 'View'
                        }
                    },
                    {
                        Type: 'E_MODIFY',
                        Resource: {
                            Name: 'HRM_HR_Hre_Passport_Portal_Create_WaitingGrid_btnEdit',
                            Rule: 'View'
                        },
                        Confirm: {
                            isInputText: false,
                    ...
                    },
                    {
                        Type: 'E_DELETE',
                        Resource: {
                            Name: 'HRM_HR_Hre_Passport_Portal_Create_WaitingGrid_btnDel',
                            Rule: 'View'
                        },
                        Confirm: {
                            isInputText: false,
        ...
        const _configList = configList[passportWaitConfirm],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == passportWaitConfirmKeyTask) {
    ...
    componentDidMount() {
        ...
        enumName = EnumName;
        passportWaitConfirm = ScreenName.PassportWaitConfirm;
        passportWaitConfirmViewDetail = ScreenName.PassportWaitConfirmViewDetail;
        passportWaitConfirmKeyTask = EnumTask.KT_PassportWaitConfirm;

        PassportWaitConfirmBusinessFunction.setThisForBusiness(this, false);
        ...
        this.setState(ConfigListFilter.value[passportWaitConfirm] ? _paramsDefault : paramStore);
    ...
    render() {
        ...
        return (
            <SafeAreaView {...styleSafeAreaView}>
                {passportWaitConfirm && passportWaitConfirmViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <PassportList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: passportWaitConfirmViewDetail,
                                        screenName: passportWaitConfirm
                                    }}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={passportWaitConfirmKeyTask}
