...
export default class PassportListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <View style={styles.styContentItem}>
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    ...
                                    >
                                        {translate('HRM_HR_Profile_PassportNo')}
                                    </Text>
                                </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        ...
                                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('HRM_HR_Profile_PassportDateOfIssue')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, CustomStyleSheet.alignItems('flex-end')]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {moment(dataItem?.PassportDateOfIssue).format('DD/MM/YYYY')}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        ...
                                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('HRM_HR_Profile_PassportDateOfExpiry')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, CustomStyleSheet.alignItems('flex-end')]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {moment(dataItem?.PassportDateOfExpiry).format('DD/MM/YYYY')}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.styLine}>
                                <View style={styles.styLineLeft}>
                                    <Text
                                        ...
                                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.fontWeight('600')]}
                                    >
                                        {translate('HRM_HR_Profile_PassportPlaceOfIssue')}
                                    </Text>
                                </View>

                                <View style={[styles.styLineLeft, CustomStyleSheet.alignItems('flex-end')]}>
                                    <Text numberOfLines={1} style={[styleSheets.text, styles.line_text]}>
                                        {dataItem?.PassportPlaceOfIssue}
                                    </Text>
                                </View>
                            </View>
                        </View>
