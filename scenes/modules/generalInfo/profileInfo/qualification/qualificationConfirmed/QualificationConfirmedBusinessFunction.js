        ...
        if (actionEditPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_MODIFY,
                    onPress: (item) => QualificationConfirmedBusinessFunction.businessModifyRecord(item),
                    ...actionEdit
                }
            ];
        }
...
export const QualificationConfirmedBusinessFunction = {
    ...
    businessModifyRecord: item => {
        ...
        HttpService.Get(`[URI_HR]/api/Hre_ApprovedProfileQualification/GetById?ID=${item.ID}`).then(res => {
