...
import BasicSalaryDetailItem from './BasicSalaryDetailItem';
import { EnumName } from '../../../../../assets/constant';

export default class BasicSalaryDetailList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            itemSelected: [],
...
const styles = StyleSheet.create({
    styViewLoading: { flex: 1, paddingVertical: styleSheets.p_10 }
});
