...
export default class MedAnnualHealthListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <View style={[styles.container]} key={index}>
                        <View style={styles.Line}>
                            <View style={styles.line_date_row}>
                                <VnrText
                                    i18nKey={'HRM_Medical_AnnualHealth_DateReceived'}
                                ...
                                <View style={styles.line_time_wrap}>
                                    <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                        {dataItem.DateReceived
                                            ? moment(dataItem.DateReceived).format('DD/MM/YYYY')
                                            : ''}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.line_date_row}>
                                <VnrText
                                    i18nKey={'HRM_Medical_ImmunizationRecord_DiseaseName'}
                                    style={[styleSheets.text, styles.line_value_lable]}
                                />
                                <View style={styles.line_time_wrap}>
                                    <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                            ...
                            <View style={styles.line_date_row}>
                                <VnrText
                                    i18nKey={'HRM_Medical_AnnualHealth_TypeResultHealthName'}
                                    style={[styleSheets.text, styles.line_value_lable]}
                                />
                                <View style={styles.line_time_wrap}>
                                    <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                        {dataItem.TypeResultHealthName ? dataItem.TypeResultHealthName : ''}
                                    </Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={styles.viewReason}>
                            <Text numberOfLines={2} style={[styleSheets.textItalic, styles.viewReason_text]}>
                                {dataItem.Note != null
                                    ? `${translate('HRM_Medical_AnnualHealth_Note')}: ${dataItem.Note}`
                                    : `${translate('HRM_Medical_AnnualHealth_Note')}:`}
                            </Text>
                        </View>
