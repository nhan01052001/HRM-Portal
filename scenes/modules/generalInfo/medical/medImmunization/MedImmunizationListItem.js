...
export default class MedImmunizationListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <View style={[styles.container]} key={index}>
                        <View style={styles.Line}>
                            <View style={styles.line_date_row}>
                                <VnrText
                                    i18nKey={'HRM_Medical_ImmunizationRecord_InjectionDate'}
                                ...
                                <View style={styles.line_time_wrap}>
                                    <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                        {dataItem.InjectionDate
                                            ? moment(dataItem.InjectionDate).format('DD/MM/YYYY')
                                            : ''}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.line_date_row}>
                                <VnrText
                                    i18nKey={'HRM_Medical_ImmunizationRecord_MedicineName'}
                                    style={[styleSheets.text, styles.line_value_lable]}
                                />
                                <View style={styles.line_time_wrap}>
                                    <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                        {dataItem.MedicineName ? dataItem.MedicineName : ''}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.line_date_row}>
                                <VnrText
                                    i18nKey={'HRM_Medical_ImmunizationRecord_InjectionStatusView'}
                                    style={[styleSheets.text, styles.line_value_lable]}
                                />
                                <View style={styles.line_time_wrap}>
                                    <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                        {dataItem.InjectionStatusView ? dataItem.InjectionStatusView : ''}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.line_date_row}>
                                <VnrText
                                    i18nKey={'HRM_Medical_ImmunizationRecord_InjectionPlace'}
                                    style={[styleSheets.text, styles.line_value_lable]}
                                />
                                <View style={styles.line_time_wrap}>
                                    <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                        {dataItem.InjectionPlace ? dataItem.InjectionPlace : ''}
                                    </Text>
                                </View>
                            </View>
                        </View>
