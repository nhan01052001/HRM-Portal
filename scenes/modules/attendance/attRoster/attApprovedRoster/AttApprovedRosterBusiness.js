...
export const generateRowActionAndSelected = () => {
    ...
    if (ConfigList.value != null && ConfigList.value != undefined) {
        const _configList = ConfigList.value[attApprovedRoster],
            ...
            _rowActions = [
                {
                    ...
                    onPress: (item, dataBody) => {
                        if (Array.isArray(item) && item.length > 0) {
                            AttApprovedRosterBusinessFunction.businessCancelRecords(item, dataBody);
                        } else {
                            AttApprovedRosterBusinessFunction.businessCancelRecords([{ ...item }], dataBody);
                        }
                    },
            ...
            _selected = [
                {
                    ...
                    onPress: (items, dataBody) =>
                        AttApprovedRosterBusinessFunction.businessCancelRecords(items, dataBody),
                    ...actionCancel
                }
            ];
        }
...
export const AttApprovedRosterBusinessFunction = {
            ...
            HttpService.Post('[URI_HR]/Att_GetData/BusinessAllowActionCancel', {
                ...
                try {
                    if (res && typeof res === 'object') {
                        ...
                        if (isValid) {
                            AttApprovedRosterBusinessFunction.confirmCancel(res);
                            VnrLoadingSevices.hide();
                    ...
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        let strId =
                            objValid.strResultID && typeof objValid.strResultID === 'string'
                                ...
                                : '';
                        VnrLoadingSevices.show();
                        HttpService.Post('[URI_HR]/Att_GetData/ChangeStatusCancelRosterPortal', {
                            selectedIds: strId,
