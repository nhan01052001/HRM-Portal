...
import AttRosterListItemApprove from './AttRosterListItemApprove';
import AttRosterListItem from './AttRosterListItem';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttRosterList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApproveRoster || detail.screenName == ScreenName.AttApprovedRoster
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.AttApproveRoster ||
                                        detail.screenName == ScreenName.AttApprovedRoster ? (
                                                <AttRosterListItemApprove
