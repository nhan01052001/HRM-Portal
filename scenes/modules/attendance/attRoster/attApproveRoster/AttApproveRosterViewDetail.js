...
import { AttApproveRosterBusinessFunction, generateRowActionAndSelected } from './AttApproveRosterBusiness';
...
export default class AttApproveRosterViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
    ...
    componentDidMount() {
        AttApproveRosterBusinessFunction.setThisForBusiness(this);
        this.getDataItem();
    }
