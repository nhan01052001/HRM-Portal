...
import { generateRowActionAndSelected, AttSubmitRosterBusinessFunction } from './AttSubmitRosterBusiness';
...
import AttRosterListItemDetailGroup from '../attRosterList/AttRosterListItemDetailGroup';
...
const configDefault = [
    ...
    },
    {
        TypeView: 'E_COMMON',
        Name: 'TypeView',
        DisplayKey: 'HRM_Attendance_Roster_Type',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'DateStart',
        DisplayKey: 'HRM_Attendance_Roster_DateStart',
        DataType: 'DateTime',
    ...
    },
    {
        TypeView: 'E_COMMON',
        Name: 'DateEnd',
        DisplayKey: 'HRM_Attendance_Roster_DateEnd',
        DataType: 'DateTime',
        DataFormat: 'DD/MM/YYYY'
    },
    {
    ...
    },
    {
        ...
        DisplayKey: 'HRM_Attendance_Roster_DateChange',
        ConfigListDetail: [
            {
                Name: 'MonShiftName',
                DisplayKey: 'HRM_Attendance_Roster_MonShiftID',
                DataType: 'string'
            },
            {
                Name: 'TueShiftName',
                DisplayKey: 'HRM_Attendance_Roster_TueShiftID',
                DataType: 'string'
            },
            {
                Name: 'WedShiftName',
                DisplayKey: 'HRM_Attendance_Roster_WedShiftID',
                DataType: 'string'
            },
            {
                Name: 'ThuShiftName',
                DisplayKey: 'HRM_Attendance_Roster_ThuShiftID',
                DataType: 'string'
            },
            {
                Name: 'FriShiftName',
                DisplayKey: 'HRM_Attendance_Roster_FriShiftID',
                DataType: 'string'
            },
            {
                Name: 'SatShiftName',
                DisplayKey: 'HRM_Attendance_Roster_SatShiftID',
                DataType: 'string'
            },
            {
                Name: 'SunShiftName',
                DisplayKey: 'HRM_Attendance_Roster_SunShiftID',
                DataType: 'string'
            },
            {
                Name: 'MonShift2Name',
    ...
    },
    {
        ...
        DisplayKey: 'HRM_Attendance_Roster_UserApproveID',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'UserApprove3IDName',
        DisplayKey: 'HRM_Attendance_Roster_UserApproveID3',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'UserApprove4IDName',
        DisplayKey: 'HRM_Attendance_Roster_UserApproveID4',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'UserApprove2IDName',
        DisplayKey: 'HRM_Attendance_Roster_UserApproveID2',
        DataType: 'string'
    },
    {
        TypeView: 'E_STATUS',
...
export default class AttSubmitRosterViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
    ...
    getDataItem = async (isReload = false) => {
        try {
            ...
            if (!Vnr_Function.CheckIsNullOrEmpty(dataId) || isReload) {
                const response = await HttpService.Post('[URI_HR]/Att_GetData/GetRosterById', {
    ...
    reload = (E_KEEP_FILTER, actionIsDelete) => {
        ...
        if (actionIsDelete) {
            DrawerServices.navigate('AttSubmitRoster');
        } else {
    ...
    rennderListShift = () => {
        const { dataItem } = this.state,
            { dataGroupMaster } = dataItem;

        return dataGroupMaster && dataGroupMaster.length > 0 ? (
            dataGroupMaster.map((item, index) => {
                let newItem = {
                    ...item,
                    isGroup: true
                };
                return (
                    <AttRosterListItemDetailGroup
                        key={index}
                        isDisable={false}
