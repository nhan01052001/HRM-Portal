...
import AttTSLViewHistory from './attTSLViewHistory/AttTSLViewHistory';

class AttTSLCheckInOut extends Component {
    constructor(props) {
        super(props);

        this.state = {
            springBntSend: new Animated.Value(1),
    ...
    checkConstraintPhotoSaveInOut = () => {
        Animated.timing(this.state.springBntSend, {
            toValue: 1.1,
            friction: 1
        }).start();
        ...
        //   {
        //     listCatCoodinate,
        //     configCheckInCoondinate,
        //     isCheckingByCoordinates,
        //   } = configConstraintDistanceWithRadious
        //       ? configConstraintDistanceWithRadious
        //       : {},
        ...
        //   {
        //     macID,
        //     isCheckingByMACAdress,
        //     configCheckInWifi
        //   } = configConstraintWifi ? configConstraintWifi : {};
        // debugger
        ...
        //         if (geolocationCenter && this.getDistanceWithingRadious(
        //           geolocationInput,
        //           geolocationCenter,
        //           radious,
        //         )) {
        ...
        // if (configLoadWorkPlace.data !== null
        ...
        //       },
        //         radious = item.CoordinateDistance;
        //       if (this.getDistanceWithingRadious(
        //         geolocationInput,
        //         geolocationCenter,
        //         radious,
        //       )) {
    ...
    handleViewHistory = () => {
        this.setState(
            ...
            () => {
                this.getDataWorkDayHistory();
            }
        );
    };

    getDataWorkDayHistory = () => {
        VnrLoadingSevices.show();
        HttpService.Post('[URI_HR]/Att_GetData/GetListWorkdayHistoryInGPS')
            .then(res => {
                if (res.length > 0) {
                    this.setState({
                        dataWorkDayHistory: res
                    });
                    VnrLoadingSevices.hide();
                }
            })
    ...
    render() {
                ...
                <ViewShot style={styles.viewShot_map} ref="viewShot" options={{ format: 'jpg', quality: 0.1 }}>
                    ...
                    <View style={styles.viewAdress_Top}>
                        <View style={styles.viewAddress}>
                            <IconMap color={Colors.gray_7} size={Size.iconSize - 2} />
                            <View style={styles.viewAddressTime}>
                                <Text style={[styleSheets.text, styles.viewAddressText]} numberOfLines={2}>
                                    {handleAddress}
                                </Text>
                            </View>
                        </View>
            ...
            <View style={styles.viewButton}>
                <Animated.View
                    style={[
                        ...
                        styles.viewButton_circle_while
                    ]}
                >
                    <TouchableOpacity
                        activeOpacity={1}
                    ...
                    >
                        <View style={styles.viewButtonContent}>
                            <Image
                                source={require('../../../../assets/images/GPS/timerWatch.png')}
                                style={styles.styButtonIcon}
                            />

                            <Text style={[styleSheets.text, styles.viewButtonTitle]}>Chấm công</Text>

                            <Text style={[styleSheets.textItalic, styles.viewButtonLableTime]}>
                                Lần cuối vào lúc 7:50 19/12/2022
                            </Text>
                        </View>
        ...
        return (
            <SafeAreaView style={CustomStyleSheet.flex(1)}>
                <View style={[styleSheets.container, { ...CustomStyleSheet.backgroundColor(Colors.white), ...CustomStyleSheet.alignItems('center') }]}>
                    <View style={styles.viewMap}>{viewMapcomponentWithAdress}</View>
                        ...
                        <View style={styles.styTopTitle}>
                            <View style={styles.styWrap}>
                                <VnrText
                                    ...
                                    i18nKey={'HRM_ProtalApp_Wd_Attendance_Workday_History'}
                                    numberOfLines={1}
                                />
                            </View>
                            ...
                            >
                                <VnrText
                                    style={[styleSheets.text, styles.styTextMoveWorkday]}
                                    i18nKey={'HRM_PortalApp_Attendance_WorkDate'}
                                />

                                <IconArrowRight size={Size.text - 1} color={Colors.primary} />
                            </TouchableOpacity>
                        </View>

                        <AttTSLViewHistory
                            dataItems={dataWorkDayHistory}
...
const styles = StyleSheet.create({
    ...
    viewAddress: {
        ...
        width: Size.deviceWidth - Size.defineHalfSpace * 2,
    ...
    viewButton_circle_while: {
        height: SIZE_CIRCLE + 23,
        width: SIZE_CIRCLE + 23,
        borderRadius: (SIZE_CIRCLE + 23) / 2,
        backgroundColor: Colors.white,
        maxWidth: 300,
        maxHeight: 300,
    ...
    styButtonIcon: {
        width: Size.deviceheight >= 1024 ? 60 : Size.deviceWidth * 0.1,
        height: Size.deviceheight >= 1024 ? 60 : Size.deviceWidth * 0.1
    },
    viewMap: {
        flex: 2.3,
        width: '100%'
