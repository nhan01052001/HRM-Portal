...
const arrImageLangVN = [
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Vào <Text style={styles.txtBold}>cài đặt</Text> tại giao diện chính
                của điện thoại.
            </Text>
        ),
    ...
    },
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Chọn <Text style={styles.txtBold}>quyền riêng tư</Text>{' '}
            </Text>
        ),
    ...
    },
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Chọn <Text style={styles.txtBold}>dịch vụ định vị</Text> {'->'} Kéo
                để bật lên.{' '}
            </Text>
        ),
    ...
    },
    {
        ...
        title: (
            <Text style={[styleSheets.text]}>
                {' '}
                Chọn <Text style={styles.txtBold}>ứng dụng</Text> {'->'} cho phép{' '}
                <Text style={styles.txtBold}>VnResource HRM Pro</Text> cập nhật vị
                trí{' '}
            </Text>
        ),
