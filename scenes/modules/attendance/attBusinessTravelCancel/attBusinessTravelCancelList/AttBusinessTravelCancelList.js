...
import AttBusinessTravelCancelListItem from './AttBusinessTravelCancelListItem';
import AttBusinessTravelCancelListItemApprove from './AttBusinessTravelCancelListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttBusinessTravelCancelList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApproveBusinessTravelCancel ||
                detail.screenName == ScreenName.AttApprovedBusinessTravelCancel
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={styles.flex1}>
                                        {detail.screenName == ScreenName.AttApproveBusinessTravelCancel ||
                                        detail.screenName == ScreenName.AttApprovedBusinessTravelCancel ? (
                                                <AttBusinessTravelCancelListItemApprove
                                                ...
                                                <AttBusinessTravelCancelListItem
                                                    currentDetail={detail}
                                                    onClick={() => {
                                                        isOpenAction == true ? this.addItemChecked(index) : null;
                                                    }}
