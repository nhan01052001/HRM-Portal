...
import AttBusinessTripListItem from './AttBusinessTripListItem';
import AttBusinessTripListItemApprove from './AttBusinessTripListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttBusinessTripList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                ...
                style={
                    {
                        ...
                        ...CustomStyleSheet.paddingVertical(styleSheets.p_10),
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApproveBusinessTrip ||
                    detail.screenName == ScreenName.AttApprovedBusinessTrip
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.AttApproveBusinessTrip ||
                                            detail.screenName == ScreenName.AttApprovedBusinessTrip ? (
                                                <AttBusinessTripListItemApprove
