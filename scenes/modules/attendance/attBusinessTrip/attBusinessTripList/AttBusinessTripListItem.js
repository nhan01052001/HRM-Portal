...
export default class AttBusinessTripListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            >
                                <View
                                    style={[
                                        ...
                                        !this.props.isSelect && styles.borderWidth1
                                    ]}
                                >
                                    {this.props.isSelect && (
                    ...
                    <View style={[styles.container]} key={index}>
                        <View style={styles.Line}>
                                ...
                                <View style={styles.line_date_row}>
                                    ...
                                    <View style={styles.line_time_wrap}>
                                        <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                            {dataItem.TypeTripView ? dataItem.TypeTripView : ''}
                                        </Text>
                                    </View>
                                </View>

                                {dataItem.MissionPlaceInName !== '' && (
                                    <View style={styles.line_date_row}>
                                        <VnrText
                                            i18nKey={'PlaceTo'}
                                            style={[styleSheets.text, styles.line_value_lable]}
                                        ...
                                        <View style={styles.line_time_wrap}>
                                            <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                                {dataItem.MissionPlaceInName ? dataItem.MissionPlaceInName : ''}
                                            </Text>
                                        </View>
                                    </View>
                                )}
                            ...
                            <View style={styles.lineRight}>
                                <View style={styles.line_date_row}>
                                    <VnrText
                                        i18nKey={'HRM_Common_From'}
                                        style={[styleSheets.text, styles.line_value_lable]}
                                    />
                                    <View style={styles.line_time_wrap}>
                                        <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                            {dataItem.DateStart != null
                                                ? moment(dataItem.DateStart).format('DD/MM/YYYY')
                                                : ''}
                                        </Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.line_date_row}>
                                    <VnrText
                                        i18nKey={'HRM_Common_To'}
                                        style={[styleSheets.text, styles.line_value_lable]}
                                    />
                                    <View style={styles.line_time_wrap}>
                                        <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                            {dataItem.DateEnd != null
                        ...
                        <View style={styles.viewReason}>
                            <Text numberOflines={1} style={[styleSheets.textItalic, styles.viewReason_text]}>
                                {dataItem.BusinessReason != null
                                    ? `${translate('E_REASON')}: ${dataItem.BusinessReason}`
                                    : `${translate('E_REASON')}:`}
                            </Text>
                        </View>
