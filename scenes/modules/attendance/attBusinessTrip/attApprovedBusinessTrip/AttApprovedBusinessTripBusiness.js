...
let enumName = EnumName,
    attApprovedBusinessTrip = ScreenName.AttApprovedBusinessTrip;
...
export const generateRowActionAndSelected = () => {
    ...
    if (ConfigList.value != null && ConfigList.value != undefined) {
        const _configList = ConfigList.value[attApprovedBusinessTrip],
            ...
            _rowActions = [
                {
                    ...
                    onPress: (item, dataBody) =>
                        AttApprovedBusinessTripBusinessFunction.businessCancelRecords([{ ...item }], dataBody),
                    ...actionCancel
                }
            ];
            ...
            _selected = [
                {
                    ...
                    onPress: (items, dataBody) =>
                        AttApprovedBusinessTripBusinessFunction.businessCancelRecords(items, dataBody),
                    ...actionCancel
                }
            ];
        }
...
export const AttApprovedBusinessTripBusinessFunction = {
                ...
                HttpService.Post('[URI_HR]/Att_GetData/BusinessAllowActionCancel', {
                    ...
                    try {
                        if (res && typeof res === enumName.E_object) {
                            ...
                            if (isValid) {
                                AttApprovedBusinessTripBusinessFunction.confirmCancel(res);
                            }
                            //không hợp lệ
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        AttApprovedBusinessTripBusinessFunction.setStatusCancel({ Ids: strId, reason });
                    }
                }
            });
        } else {
            let strId = objValid.strResultID;
            AttApprovedBusinessTripBusinessFunction.setStatusCancel({ Ids: strId });
        }
    },
    ...
    setStatusCancel: objValid => {
        ...
        VnrLoadingSevices.show();
        HttpService.Post('[URI_HR]/Att_GetData/ChangeStatusCancelBusTravalPortal', {
            selectedIds,
