...
import {
    ...
    AttApprovedBusinessTripBusinessFunction
} from './AttApprovedBusinessTripBusiness';
...
export default class AttApprovedBusinessTripViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        AttApprovedBusinessTripBusinessFunction.setThisForBusiness(this);
        this.getDataItem();
    }
