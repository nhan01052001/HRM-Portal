...
export default class AttSubmitBusinessTripViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (E_KEEP_FILTER, actionIsDelete) => {
        ...
        if (actionIsDelete) {
            DrawerServices.navigate('AttSubmitBusinessTrip');
        } else {
    ...
    componentDidMount() {
        AttSubmitBusinessTripBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
