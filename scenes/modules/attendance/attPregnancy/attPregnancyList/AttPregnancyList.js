...
import AttPregnancyListItem from './AttPregnancyListItem';
import AttPregnancyListItemApprove from './AttPregnancyListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttPregnancyList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApprovePregnancy ||
                detail.screenName == ScreenName.AttApprovedPregnancy
