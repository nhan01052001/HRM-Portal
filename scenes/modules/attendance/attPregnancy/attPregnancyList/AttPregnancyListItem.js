...
export default class AttPregnancyListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        if (moment(dataItem.DateStart).isSame(dataItem.DateEnd, 'day')) {
            ...
            dateLeave = (
                <View style={styles.lineLeft}>
                    <View style={styles.line_date_row}>
                        <VnrText i18nKey={'HRM_Common_From'} style={[styleSheets.text, styles.line_value_lable]} />
                        <View style={styles.line_time_wrap}>
                            <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                {dataItem.DateStart ? moment(dataItem.DateStart).format('DD/MM/YYYY') : ''}
                            </Text>
                    ...
                    <View style={styles.line_date_row}>
                        <VnrText i18nKey={'HRM_Common_To'} style={[styleSheets.text, styles.line_value_lable]} />
                        <View style={styles.line_time_wrap}>
                            <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
        ...
        timeLeave = (
            <View style={styles.lineRight}>
                <View style={styles.line_date_row}>
                    <VnrText i18nKey={'HRM_Grade'} style={[styleSheets.text, styles.line_value_lable]} />
                    <View style={styles.line_time_wrap}>
                        <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                ...
                {dataItem.TypePregnancyEarlyView && (
                    <View style={styles.line_date_row}>
                        <VnrText i18nKey={'HRM_Attendance_Type'} style={[styleSheets.text, styles.line_value_lable]} />
                        <View style={styles.line_time_wrap}>
                            <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
