...
export default class AttSubmitPregnancyViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (E_KEEP_FILTER, actionIsDelete) => {
        ...
        if (actionIsDelete) {
            DrawerServices.navigate('AttSubmitPregnancy');
        } else {
    ...
    componentDidMount() {
        AttSubmitPregnancyBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
