                            ...
                            <View style={styles.Line}>
                                <View style={styles.lineLeft}>
                                    <View style={[styles.line_date_row]}>
                                        ...
                                        <View style={styles.line_date_row}>
                                            {dataItem.WorkDateRoot != undefined && (
                                                <Text
                                                    numberOfLines={1}
                                                    style={[styleSheets.text, styles.line_value_value]}
                                                >
                                                    {moment(dataItem.WorkDateRoot).format('DD/MM/YYYY')}
                                                </Text>
                                            )}
                                        </View>
                                    </View>
                                    ...
                                    <View style={[styles.line_date_row]}>
                                        <VnrText
                                            style={[styleSheets.text, styles.line_value_lable]}
                                            i18nKey={'HRM_Sys_TimeRange'}
                                        />

                                        <View style={[styles.line_time_wrap]}>
                                            {dataItem.InTime != null && dataItem.OutTime && (
                                                <Text
                                                    numberOfLines={1}
                                                    style={[styleSheets.text, styles.line_value_value]}
                                                >
                                                    {`${moment(dataItem.InTime).format('HH:mm')} - ${moment(
                                                        dataItem.OutTime
                                                    ).format('HH:mm')}`}
                                                </Text>
                                            )}
                                    ...
                                    <View style={styles.line_value}>
                                        ...
                                        <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                                            {dataItem.RegisterHours
                                                ? `${Vnr_Function.mathRoundNumber(dataItem.RegisterHours)}`
                                                : ''}
                                        </Text>
                                    </View>
                                </View>
