...
import AttPlanOvertimeListItem from './AttPlanOvertimeListItem';
import AttPlanOvertimeListItemApprove from './AttPlanOvertimeListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttPlanOvertimeList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApprovePlanOvertime ||
                detail.screenName == ScreenName.AttApprovedPlanOvertime
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.AttApprovePlanOvertime ||
                                        detail.screenName == ScreenName.AttApprovedPlanOvertime ? (
                                                <AttPlanOvertimeListItemApprove
