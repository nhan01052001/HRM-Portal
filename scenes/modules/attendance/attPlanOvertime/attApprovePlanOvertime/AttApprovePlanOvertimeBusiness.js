...
export const generateRowActionAndSelected = () => {
    ...
    if (ConfigList.value != null && ConfigList.value != undefined) {
        const _configList = ConfigList.value[attApprovePlanOvertime],
            businessAction = _configList[enumName.E_BusinessAction],
            { E_ResourceName, E_Name, E_Rule, E_APPROVE, E_REJECT, E_LIMIT_OT } = enumName;
            ...
            _rowActions = [
                {
                    ...
                    onPress: (item, dataBody) =>
                        AttApprovePlanOvertimeBusinessFunction.businessApproveRecords([{ ...item }], dataBody),
                    ...actionApprove
                }
            ];
        ...
        if (actionRejectPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_REJECT,
                    onPress: (item, dataBody) =>
                        AttApprovePlanOvertimeBusinessFunction.businessRejectRecords([{ ...item }], dataBody),
                    ...actionReject
                }
            ];
        ...
        // thêm Button xem lũy kế
        _rowActions = [
            ..._rowActions,
            ...[
                {
                    title: translate('HRM_Common_ViewLimit'),
                    type: E_LIMIT_OT,
                    onPress: (item) =>
                        AttApprovePlanOvertimeBusinessFunction.businessShowLimitOT({ ...item }),
                    ...actionReject
                }
            ]
        ];
...
export const AttApprovePlanOvertimeBusinessFunction = {
            ...
            HttpService.Post('[URI_HR]/Att_GetData/BusinessAllowActionReject', {
                ...
                try {
                    if (res && typeof res === 'object') {
                        ...
                        if (isValid) {
                            AttApprovePlanOvertimeBusinessFunction.confirmReject(res);
                        }
                        //không hợp lệ
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        AttApprovePlanOvertimeBusinessFunction.setStatusReject({ Ids: strId, reason });
                    }
                }
            });
        } else {
            let strId = objValid.strResultID;
            AttApprovePlanOvertimeBusinessFunction.setStatusReject({ Ids: strId });
        }
    },
    ...
    setStatusReject: objValid => {
        ...
        VnrLoadingSevices.show();
        HttpService.Post('[URI_HR]/Att_GetData/SetRejectOvertimePlanInPortal', {
            ...
            try {
                if (data && typeof data === 'string') {
                    if (data == enumName.E_Success) {
                        ...
                        AttApprovePlanOvertimeBusinessFunction.checkForReLoadScreen[
                        ...
                        if (!_isOnScreenNotification) DrawerServices.navigate(ScreenName.AttApprovePlanOvertime);
            ...
            HttpService.Post('[URI_HR]/Att_GetData/BusinessAllowActionApprove', {
                ...
                try {
                    if (res && typeof res === enumName.E_object) {
                        ...
                        if (isValid) {
                            AttApprovePlanOvertimeBusinessFunction.confirmApprove(res);
                        }
                        //không hợp lệ
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        let strId = objValid.strResultID;
                        AttApprovePlanOvertimeBusinessFunction.setStatusApprove({ Ids: strId, reason });
                    }
                }
            });
        } else {
            let strId = objValid.strResultID;
            AttApprovePlanOvertimeBusinessFunction.setStatusApprove({ Ids: strId });
        }
    },
    ...
    setStatusApprove: objValid => {
        ...
        VnrLoadingSevices.show();
        HttpService.Post('[URI_HR]/Att_GetData/SetApproveOvertimePlanInPortal', dataBody).then(data => {
            VnrLoadingSevices.hide();
            if (data && typeof data === 'string') {
                if (data == enumName.E_Success) {
    ...
    //#region
    businessShowLimitOT: (item) => {
        _this.openModalPlanLimit && typeof _this.openModalPlanLimit == 'function' && _this.openModalPlanLimit(item);
    }
    //#endregion
};
...
export default {
    ...
    AttApprovePlanOvertimeBusinessFunction: AttApprovePlanOvertimeBusinessFunction
};
