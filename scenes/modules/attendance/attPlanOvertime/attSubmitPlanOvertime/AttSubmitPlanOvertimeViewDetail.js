...
import { generateRowActionAndSelected, AttSubmitPlanOvertimeBusinessFunction } from './AttSubmitPlanOvertimeBusiness';
...
export default class AttSubmitPlanOvertimeViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (E_KEEP_FILTER, actionIsDelete) => {
        ...
        if (actionIsDelete) {
            DrawerServices.navigate('AttSubmitPlanOvertime');
        } else {
    ...
    componentDidMount() {
        AttSubmitPlanOvertimeBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
