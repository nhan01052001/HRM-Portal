...
export const generateRowActionAndSelected = () => {
    ...
    if (ConfigList.value != null && ConfigList.value != undefined) {
        const _configList = ConfigList.value[attApprovedPlanOvertime],
            ...
            _rowActions = [
                {
                    ...
                    onPress: (item, dataBody) =>
                        AttApprovedPlanOvertimeBusinessFunction.businessCancelRecords([{ ...item }], dataBody),
                    ...actionCancel
                }
            ];
            ...
            _selected = [
                {
                    ...
                    onPress: (items, dataBody) =>
                        AttApprovedPlanOvertimeBusinessFunction.businessCancelRecords(items, dataBody),
                    ...actionCancel
                }
            ];
        }
...
export const AttApprovedPlanOvertimeBusinessFunction = {
            ...
            HttpService.Post('[URI_HR]/Att_GetData/BusinessAllowActionCancel', {
                ...
                try {
                    if (res && typeof res === enumName.E_object) {
                        ...
                        if (isValid) {
                            AttApprovedPlanOvertimeBusinessFunction.confirmCancel(res);
                        }
                        //không hợp lệ
    ...
    confirmCancel: objValid => {
        ...
        if (isConfirm) {
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        AttApprovedPlanOvertimeBusinessFunction.setStatusCancel({ Ids: strId, reason });
                    }
                }
            });
        } else {
            //check khung giờ cho Phổ Đình
            let strId = objValid.strResultID;
            AttApprovedPlanOvertimeBusinessFunction.setStatusCancel({ Ids: strId });
        }
    },
    ...
    setStatusCancel: objValid => {
        ...
        VnrLoadingSevices.show();
        HttpService.Post('[URI_HR]/Att_GetData/ProcessCancelOvertimePlanPortal', {
            selectedIds,
            CommentCancel
        }).then(res => {
            VnrLoadingSevices.hide();
