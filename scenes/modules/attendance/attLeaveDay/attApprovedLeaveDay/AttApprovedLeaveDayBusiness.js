            ...
            _rowActions = [
                {
                    ...
                    onPress: (item, dataBody) =>
                        AttApprovedLeaveDayBusinessFunction.businessCancelRecords([{ ...item }], dataBody),
                    ...actionCancel
                }
            ];
            ...
            _selected = [
                {
                    ...
                    onPress: (items, dataBody) =>
                        AttApprovedLeaveDayBusinessFunction.businessCancelRecords(items, dataBody),
                    ...actionCancel
                }
            ];
        }
...
export const AttApprovedLeaveDayBusinessFunction = {
            ...
            HttpService.Post('[URI_HR]/Att_GetData/BusinessAllowActionCancel', {
                ...
                try {
                    if (res && typeof res === enumName.E_object) {
                        ...
                        if (isValid) {
                            AttApprovedLeaveDayBusinessFunction.confirmCancel(res);
                        }
                        //không hợp lệ
    ...
    confirmCancel: objValid => {
        ...
        if (isConfirm) {
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        AttApprovedLeaveDayBusinessFunction.checkingDataWorkingForLeaveDayCancel({
                            Ids: strId,
                            reason
                        });
                    }
            ...
            //check khung giờ cho Phổ Đình
            let strId = objValid.strResultID;
            AttApprovedLeaveDayBusinessFunction.checkingDataWorkingForLeaveDayCancel({ Ids: strId });
        }
    },
            ...
            try {
                if (res && Array.isArray(res)) {
                    ...
                    //khung giờ không hợp lệ => gọi hàm mở popup để review
                        ...
                        AttApprovedLeaveDayBusinessFunction.confirmEmpWorkingForCancel(res, objValid);
                    }
                }
                //FAIL
                else {
