...
import AttLeaveDayListItem from './AttLeaveDayListItem';
import AttLeaveDayListItemApprove from './AttLeaveDayListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttLeaveDayList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
