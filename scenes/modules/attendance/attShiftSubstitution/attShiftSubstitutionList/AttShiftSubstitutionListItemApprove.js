...
export default class AttPlanOvertimeListItemApprove extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <View style={styles.container}>
                            ...
                            <View style={styles.Line}>
                                <View style={styles.lineLeft}>
                                    <View style={[styles.line_date_row]}>
                                        ...
                                        <View style={styles.line_date_row}>
                                            <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                                                {dataItem.ChangeDate
                                                    ? moment(dataItem.ChangeDate).format('DD/MM/YYYY')
                                                    : ''}
                                            </Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={[styles.line_date_row]}>
                                        <VnrText
                                            style={[styleSheets.text, styles.line_value_lable]}
                                            i18nKey={'HRM_Att_ShiftSubstitution_SubstituteDate'}
                                        />

                                        <View style={[styles.line_time_wrap]}>
                                            <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                                                {dataItem.AlternateDate
                                                    ? moment(dataItem.AlternateDate).format('DD/MM/YYYY')
                                                    : ''}
                                            </Text>
                                        </View>
                                    </View>
                                ...
                                <View style={styles.lineRight}>
                                    <View style={styles.line_value}>
                                        <VnrText
                                            style={[styleSheets.text, styles.line_value_lable]}
                                            i18nKey={'HRM_Att_ShiftSubstitution_CurrentShift'}
                                        />
                                        <View style={[styles.line_time_wrap]}>
                                            <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                                                {dataItem.ChangeShiftName ? dataItem.ChangeShiftName : ''}
                                            </Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.line_value}>
                                        <VnrText
                                            style={[styleSheets.text, styles.line_value_lable]}
                                            i18nKey={'HRM_Att_ShiftSubstitution_SubstituteShift'}
                                        />
                                        <View style={[styles.line_time_wrap]}>
                                            <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                                                {dataItem.AlternateShiftName ? dataItem.AlternateShiftName : ''}
                                            </Text>
                                        </View>
                                    </View>
                                </View>
                        ...
                        <View style={styles.viewReason}>
                            <Text numberOfLines={2} style={[styleSheets.textItalic, styles.viewReason_text]}>
                                {dataItem.ChangeShiftReason != null
                                    ? `${translate('E_REASON')}: ${dataItem.ChangeShiftReason}`
                                    : `${translate('E_REASON')} : `}
                            </Text>
                        </View>
