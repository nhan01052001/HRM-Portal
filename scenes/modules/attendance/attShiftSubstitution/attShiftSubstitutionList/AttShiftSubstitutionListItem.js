...
export default class AttShiftSubstitutionListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                <View style={styles.line_date_row}>
                    ...
                    <View style={styles.line_time_wrap}>
                        <Text style={[styleSheets.text, styles.line_value_value]}>
                            {dataItem.ChangeDate ? moment(dataItem.ChangeDate).format('DD/MM/YYYY') : ''}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.line_date_row}>
                    ...
                    <View style={styles.line_time_wrap}>
                        <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                            {dataItem.AlternateDate ? moment(dataItem.AlternateDate).format('DD/MM/YYYY') : ''}
                        </Text>
                    </View>
                </View>
            </View>
