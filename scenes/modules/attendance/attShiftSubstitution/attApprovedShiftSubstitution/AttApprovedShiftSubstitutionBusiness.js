...
export const generateRowActionAndSelected = () => {
    ...
    if (ConfigList.value != null && ConfigList.value != undefined) {
        ...
        //                     AttApprovedShiftSubstitutionBusinessFunction.businessCancelRecords(item, dataBody)
        //                 }
        //                 else {
        //                     AttApprovedShiftSubstitutionBusinessFunction.businessCancelRecords([{ ...item }], dataBody)
        //                 }
        ...
        //             title: translate('HRM_Common_Cancel'),
        //             type: E_CANCEL,
        //             onPress: (items, dataBody) => AttApprovedShiftSubstitutionBusinessFunction.businessCancelRecords(items, dataBody),
        //             ...actionCancel
        //         }
        //     ]
        // }
...
export const AttApprovedShiftSubstitutionBusinessFunction = {
    setThisForBusiness: () => {
    ...
    //                         if (isValid) {
    //                             AttApprovedShiftSubstitutionBusinessFunction.confirmCancel(res);
    //                             VnrLoadingSevices.hide();
    //                         }
