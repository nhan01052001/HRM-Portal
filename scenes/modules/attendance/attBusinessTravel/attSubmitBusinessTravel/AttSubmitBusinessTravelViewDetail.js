...
const configDefault = [
    ...
    },
    {
        TypeView: 'E_COMMON',
        Name: 'DateFrom',
        DisplayKey: 'HRM_Attendance_DateFromTrip',
        DataType: 'DateTime',
    ...
    },
    {
        TypeView: 'E_COMMON',
        Name: 'DateTo',
        DisplayKey: 'HRM_Attendance_DateToTrip',
        DataType: 'DateTime',
        DataFormat: 'DD/MM/YYYY'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'DateStayFrom',
        NameSecond: 'DateStayTo',
        DisplayKey: 'HRM_Attendance_BusinessTravel_DateStay',
        DataType: 'DateToFrom',
        DataFormat: 'DD/MM/YYYY'
    },
    {
    ...
    {
        TypeView: 'E_COMMON',
        Name: 'PlaceFromAllView',
        DisplayKey: 'HRM_Attendance_PlaceInFrom',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'PlaceToAllView',
        DisplayKey: 'HRM_Attendance_PlaceInTo',
        DataType: 'string'
    },
    {
        TypeView: 'E_REASON',
    ...
    },
    {
        ...
        DisplayKey: 'HRM_Attendance_MidApproverName',
        DataType: 'string'
    },
    {
        TypeView: 'E_USERAPPROVE3',
        Name: 'NextApproverName',
        DisplayKey: 'HRM_Attendance_NextApproverName',
        DataType: 'string'
    },
    {
        TypeView: 'E_USERAPPROVE4',
        Name: 'LastApproverName',
        DisplayKey: 'HRM_Attendance_LastApproverName',
        DataType: 'string'
    },
    {
        TypeView: 'E_STATUS',
...
export default class AttSubmitBusinessTravelViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    getDataItem = async (isReload = false) => {
        try {
            ...
            const ID = dataId ? dataId : dataItem?.ID ? dataItem?.ID : null;
            if (ID || isReload) {
                const response = await HttpService.Post('[URI_HR]/Att_GetData/GetBusinessTravelById', {
                    id: ID,
    ...
    reload = (E_KEEP_FILTER, actionIsDelete) => {
        ...
        if (actionIsDelete) {
            DrawerServices.navigate('AttSubmitBusinessTravel');
        } else {
    ...
    componentDidMount() {
        AttSubmitBusinessTravelBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
