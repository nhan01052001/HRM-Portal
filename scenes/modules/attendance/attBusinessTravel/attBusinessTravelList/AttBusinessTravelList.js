...
import AttBusinessTravelListItem from './AttBusinessTravelListItem';
import AttBusinessTravelListItemApprove from './AttBusinessTravelListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttBusinessTravelList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                                ...
                                <View style={styles.styleViewBorderButtom}>
                                    ...
                                    >
                                        <View style={{ flex: 1 }}>
                                            {detail.screenName == ScreenName.AttApproveBusinessTravel ||
                                                detail.screenName == ScreenName.AttApprovedBusinessTravel ? (
                                                    <AttBusinessTravelListItemApprove
