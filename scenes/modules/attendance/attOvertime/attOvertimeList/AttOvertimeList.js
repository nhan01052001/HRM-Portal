...
import AttOvertimeListItem from './AttOvertimeListItem';
import AttOvertimeListItemApprove from './AttOvertimeListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttOvertimeList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApproveOvertime ||
                detail.screenName == ScreenName.AttApprovedOvertime
