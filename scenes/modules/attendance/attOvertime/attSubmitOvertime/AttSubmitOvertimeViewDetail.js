...
const configDefault = [
    ...
    {
        Name: 'WorkDate',
        DisplayKey: 'HRM_Attendance_Att_Overtime_Submit_WorkDate',
        DataType: 'DateTime',
    ...
    },
    {
        TypeView: 'E_COMMON',
        Name: 'ExpiryPeriod',
        DisplayKey: 'ExpiryPeriod',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'ExpiryDate',
        DisplayKey: 'ExpiryDate',
        DataType: 'DateTime',
        DataFormat: 'DD/MM/YYYY'
    },
    {
    ...
    },
    {
        TypeView: 'E_COMMON',
        Name: 'RegisterHours',
        DisplayKey: 'HRM_Attendance_Att_Overtime_Submit_RegisterHours',
        DataType: 'string',
        DataFormat: ''
    },
    {
        ...
        DisplayKey: 'HRM_Attendance_Overtime_DurationType',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'OvertimeTypeName',
        DisplayKey: 'HRM_Attendance_Att_Overtime_Submit_OvertimeTypeID',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
    ...
    },
    {
        ...
        DisplayKey: 'HRM_Attendance_Att_Overtime_Submit_ReasonOT',
        DataType: 'string'
    },
    {
        TypeView: 'E_GROUP',
...
export default class AttSubmitOvertimeViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (E_KEEP_FILTER, actionIsDelete) => {
        ...
        if (actionIsDelete) {
            DrawerServices.navigate('AttSubmitOvertime');
        } else {
    ...
    componentDidMount() {
        AttSubmitOvertimeBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
