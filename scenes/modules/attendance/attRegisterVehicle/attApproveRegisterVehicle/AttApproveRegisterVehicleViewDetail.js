...
export default class AttApproveRegisterVehicleViewDetail extends Component {
    constructor(props) {
        super(props);
        ...
        if (dataItem && configListDetail) {
            contentViewDetail = (
                <View style={styleSheets.container}>
                    ...
                    {/* số giờ lũy kế */}
                    {/* {
            (PermissionForAppMobile && PermissionForAppMobile.value['Att_OvertimePlan_btnViewAccumulation']
              && PermissionForAppMobile.value['Att_OvertimePlan_btnViewAccumulation']['View']) &&
            (
              <TouchableOpacity style={styles.viewTime}
                onPress={() => this.openModalPlanLimit(dataItem)}
              >
            ...
            <Modal
              ...
              <View style={stylesModalPopupBottom.viewModalTime}>
                <SafeAreaView
                  {...styleSafeAreaView}
                  style={stylesModalPopupBottom.safeRadius}>
