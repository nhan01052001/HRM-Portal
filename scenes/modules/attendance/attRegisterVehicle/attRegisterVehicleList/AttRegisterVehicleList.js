...
import { Colors, Size, CustomStyleSheet, stylesScreenDetailV2, stylesScreenDetailV3 } from '../../../../../constants/styleConfig';
...
import AttRegisterVehicleListItem from './AttRegisterVehicleListItem';
import AttRegisterVehicleListItemApprove from './AttRegisterVehicleListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttRegisterVehicleList extends React.Component {
    constructor(props) {
        super(props);
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.AttApproveRegisterVehicle ||
                                            detail.screenName == ScreenName.AttApprovedRegisterVehicle ? (
                                                <AttRegisterVehicleListItemApprove
