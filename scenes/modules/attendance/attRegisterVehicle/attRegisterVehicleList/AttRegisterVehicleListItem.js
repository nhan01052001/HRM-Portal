...
export default class AttRegisterVehicleListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <View style={[styles.lineLeft, CustomStyleSheet.borderRightWidth(0)]}>
                <View style={styles.line_date_row}>
                    <VnrText
                        ...
                        style={[styleSheets.text, styles.line_lable, CustomStyleSheet.width('50%')]}
                    />
                    <View style={[styles.line_time_wrap, CustomStyleSheet.width('50%')]}>
                        <Text style={[styleSheets.text, styles.line_text]} numberOfLines={2}>
