...
import { styleScreenDetail, styleSafeAreaView, styleSheets, CustomStyleSheet } from '../../../../../constants/styleConfig';
import Vnr_Function from '../../../../../utils/Vnr_Function';
import HttpService from '../../../../../utils/HttpService';
import {
    AttSubmitLeaveDayCancelBusinessFunction,
    generateRowActionAndSelected
} from './AttSubmitLeaveDayCancelBusiness';
...
export default class AttSubmitLeaveDayCancelViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
    ...
    getDataItem = async (isReload = false) => {
        try {
            ...
            if (!Vnr_Function.CheckIsNullOrEmpty(dataId) || isReload) {
                const response = await HttpService.Post('[URI_HR]/Por_GetData/GetLeaveDayCancelById', {
                    id: !Vnr_Function.CheckIsNullOrEmpty(dataId) ? dataId : dataItem.RecordID,
    ...
    reload = (E_KEEP_FILTER, actionIsDelete) => {
        ...
        if (actionIsDelete) {
            DrawerServices.navigate('AttSubmitLeaveDayCancel');
        } else {
    ...
    componentDidMount() {
        AttSubmitLeaveDayCancelBusinessFunction.setThisForBusiness(this);
        this.getDataItem();
    }
