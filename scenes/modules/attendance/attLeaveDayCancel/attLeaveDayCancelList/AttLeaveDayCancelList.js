...
import AttLeaveDayCancelListItem from './AttLeaveDayCancelListItem';
import AttLeaveDayCancelListItemApprove from './AttLeaveDayCancelListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttLeaveDayCancelList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApproveLeaveDay ||
                detail.screenName == ScreenName.AttApprovedLeaveDay
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.AttApproveLeaveDay ||
                                        detail.screenName == ScreenName.AttApprovedLeaveDay ? (
                                                <AttLeaveDayCancelListItemApprove
