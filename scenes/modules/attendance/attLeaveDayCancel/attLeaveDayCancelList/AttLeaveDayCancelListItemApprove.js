...
export default class AttLeaveDayCancelListItemApprove extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        if (
            dataItem.HoursFrom &&
            dataItem.HoursTo &&
            ['E_FIRSTHALFSHIFT', 'E_MIDDLEOFSHIFT', 'E_LASTHALFSHIFT'].includes(dataItem.DurationType)
        ) {
        ...
        dateLeave = (
            <View style={styles.lineLeft}>
                <View style={[styles.line_date_row]}>
                    <VnrText style={[styleSheets.text, styles.line_value_lable]} i18nKey={'E_DAY'} />
            ...
            <View style={styles.lineRight}>
                <View style={styles.line_value}>
                    ...
                    <View style={styles.line_time_wrap}>
                        <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                            {dataItem.LeaveDays != null ? `${Vnr_Function.mathRoundNumber(dataItem.LeaveDays)}` : ''}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.line_value}>
                    ...
                    <View style={styles.line_time_wrap}>
                        <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                            {/* // lay ma loai phep */}
                            {dataItem.LeaveDayTypeCode != null ? dataItem.LeaveDayTypeCode : ''}
                        </Text>
                    </View>
                </View>
            </View>
