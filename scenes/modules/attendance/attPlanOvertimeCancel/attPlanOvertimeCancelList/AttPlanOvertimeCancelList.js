...
import AttPlanOvertimeCancelListItem from './AttPlanOvertimeCancelListItem';
import AttPlanOvertimeCancelListItemApprove from './AttPlanOvertimeCancelListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttPlanOvertimeCancelList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApprovePlanOvertimeCancel ||
                detail.screenName == ScreenName.AttApprovedPlanOvertimeCancel
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.AttApprovePlanOvertimeCancel ||
                                        detail.screenName == ScreenName.AttApprovedPlanOvertimeCancel ? (
                                                <AttPlanOvertimeCancelListItemApprove
