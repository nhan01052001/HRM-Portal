...
import AttTSLRegisterListItemApprove from './AttTSLRegisterListItemApprove';
import AttTSLRegisterListItem from './AttTSLRegisterListItem';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class VnrListTSLRegister extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApproveTSLRegister ||
