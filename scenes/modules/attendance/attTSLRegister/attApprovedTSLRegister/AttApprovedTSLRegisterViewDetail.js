...
import { generateRowActionAndSelected, AttApprovedTSLRegisterBusinessFunction } from './AttApprovedTSLRegisterBusiness';
...
export default class AttApprovedTSLRegisterViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
    ...
    componentDidMount() {
        AttApprovedTSLRegisterBusinessFunction.setThisForBusiness(this);
        this.getDataItem();
    }
