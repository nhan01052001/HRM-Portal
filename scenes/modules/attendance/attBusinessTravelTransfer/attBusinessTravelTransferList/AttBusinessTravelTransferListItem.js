        ...
        viewTravelTransfer = (
            <View style={styles.line_Time}>
                <View style={styles.line_date_row}>
                    <VnrText i18nKey={'HRM_Att_TransferDate'} style={[styleSheets.text, styles.line_date_text]} />
                    <View style={styles.line_time_wrap}>
                        <Text style={[styleSheets.text, styles.line_text]} numberOfLines={1}>
                            {dataItem.TransferDate ? moment(dataItem.TransferDate).format('DD/MM/YYYY') : ''}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.line_date_row}>
                    <VnrText
                        i18nKey={'HRM_Att_BusinessTravelTransfer_TransferDate'}
