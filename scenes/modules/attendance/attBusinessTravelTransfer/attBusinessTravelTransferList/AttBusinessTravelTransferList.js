...
import { Colors, Size, styleSheets, stylesVnrLoading } from '../../../../../constants/styleConfig';
...
import { EnumName, ScreenName, EnumStatus } from '../../../../../assets/constant';
import { getDataLocal } from '../../../../../factories/LocalData';
import AttBusinessTravelTransferListItem from './AttBusinessTravelTransferListItem';
import AttBusinessTravelTransferListItemApprove from './AttBusinessTravelTransferListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttBusinessTravelTransferList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApproveBusinessTravel ||
                detail.screenName == ScreenName.AttApprovedBusinessTravel
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={styles.flex1}>
                                        {detail.screenName == ScreenName.AttApproveBusinessTravelTransfer ||
                                        detail.screenName == ScreenName.AttApprovedBusinessTravelTransfer ? (
                                                <AttBusinessTravelTransferListItemApprove
                                                ...
                                                <AttBusinessTravelTransferListItem
                                                    currentDetail={detail}
                                                    onClick={() => {
                                                        isOpenAction == true ? this.addItemChecked(index) : null;
                                                    }}
