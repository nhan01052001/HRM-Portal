...
import { Colors, Size, stylesScreenDetailV2, stylesScreenDetailV3, CustomStyleSheet } from '../../../../../constants/styleConfig';
...
import AttRosterGroupByEmpListItemApprove from './AttRosterGroupByEmpListItemApprove';
import AttRosterGroupByEmpListItem from './AttRosterGroupByEmpListItem';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttRosterGroupByEmpList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
