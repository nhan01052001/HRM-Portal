...
export const generateRowActionAndSelected = () => {
    ...
    if (ConfigList.value != null && ConfigList.value != undefined) {
        const _configList = ConfigList.value[attApprovedRosterGroupByEmp],
            ...
            _rowActions = [
                {
                    ...
                    onPress: (item, dataBody) => {
                        if (Array.isArray(item) && item.length > 0) {
                            AttApprovedRosterGroupByEmpBusinessFunction.businessCancelRecords(item, dataBody);
                        } else {
                            AttApprovedRosterGroupByEmpBusinessFunction.businessCancelRecords([{ ...item }], dataBody);
                        }
                    },
            ...
            _selected = [
                {
                    ...
                    onPress: (items, dataBody) =>
                        AttApprovedRosterGroupByEmpBusinessFunction.businessCancelRecords(items, dataBody),
                    ...actionCancel
                }
            ];
        }
...
export const AttApprovedRosterGroupByEmpBusinessFunction = {
            ...
            HttpService.Post('[URI_HR]/Att_GetData/BusinessAllowActionCancel', {
                ...
                try {
                    if (res && typeof res === 'object') {
                        ...
                        if (isValid) {
                            AttApprovedRosterGroupByEmpBusinessFunction.confirmCancel(res);
                            VnrLoadingSevices.hide();
                    ...
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        let strId =
                            objValid.strResultID && typeof objValid.strResultID === 'string'
                                ...
                                : '';
                        VnrLoadingSevices.show();
                        HttpService.Post('[URI_HR]/Att_GetData/ChangeStatusCancelRosterGroupByEmpPortal', {
                            selectedIds: strId,
