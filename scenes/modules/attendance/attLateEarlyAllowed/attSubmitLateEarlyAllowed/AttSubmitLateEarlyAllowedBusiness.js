...
const enumName = EnumName,
    attSubmitLateEarlyAllowed = ScreenName.AttSubmitLateEarlyAllowed,
    attSubmitLateEarlyAllowedAddOrEdit = ScreenName.AttSubmitLateEarlyAllowedAddOrEdit;
...
export const generateRowActionAndSelected = () => {
    ...
    if (ConfigList.value != null && ConfigList.value != undefined) {
        const _configList = ConfigList.value[attSubmitLateEarlyAllowed],
        ...
        if (actionEditPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_MODIFY,
                    onPress: item => AttSubmitLateEarlyAllowedBusinessFunction.businessModifyRecord({ ...item }),
                    ...actionEdit
                }
            ];
        }
            ...
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    onPress: (item, dataBody) =>
                        AttSubmitLateEarlyAllowedBusinessFunction.businessSendMailRecords([{ ...item }], dataBody),
                    ...actionSendMail
                }
            ];
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    onPress: (items, dataBody) =>
                        AttSubmitLateEarlyAllowedBusinessFunction.businessSendMailRecords(items, dataBody),
                    ...actionSendMail
                }
            ];
        }
        ...
        if (actionDeletePer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_DELETE,
                    onPress: (item, dataBody) =>
                        AttSubmitLateEarlyAllowedBusinessFunction.businessDeleteRecords([{ ...item }], dataBody),
                    ...actionDelete
                }
            ];
        ...
        if (actionCancelPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_CANCEL,
                    onPress: (item, dataBody) =>
                        AttSubmitLateEarlyAllowedBusinessFunction.businessCancelRecords([{ ...item }], dataBody),
                    ...actionCancel
                }
            ];
...
export const AttSubmitLateEarlyAllowedBusinessFunction = {
    ...
    businessSendMailRecords: (items, dataBody) => {
        if (items.length === 0 && !dataBody) {
            ...
            if (selectedID.length === 1) {
                ...
                HttpService.Post('[URI_HR]/Att_GetData/GetLateEarlyAllowedById', {
                    id: selectedID[0],
                            ...
                            HttpService.Post('[URI_HR]/Att_GetData/BusinessAllowActionSendEmail', {
                                ...
                                try {
                                    if (res && typeof res === enumName.E_object) {
                                        ...
                                        if (isValid == true) {
                                            AttSubmitLateEarlyAllowedBusinessFunction.confirmSendMail(res);
                                        } else if (
                                            isValid == false &&
                                            res.message &&
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        HttpService.Post('[URI_HR]/Att_GetData/ProcessSendMailLateEarlyAllowed', {
                            host: _uriPor,
                            selectedIds: arrId,
                            reason
                        }).then(res => {
                            ...
                            try {
                                ...
                                } else if (res && res.mess && res.mess.Key == 'Hrm_Locked') {
                                    ToasterSevice.showWarning('Hrm_Locked', 4000);
                                } else if (res && res.mess && typeof res.mess == 'string') {
                            ...
                            HttpService.Post('[URI_HR]/Att_GetData/BusinessAllowActionDelete', {
                                ...
                                try {
                                    if (res && typeof res === enumName.E_object) {
                                        ...
                                        if (isValid) {
                                            AttSubmitLateEarlyAllowedBusinessFunction.confirmDelete(res);
                                        }
                                        //không hợp lệ
                                        else if (
                                            isValid == false &&
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        AttSubmitLateEarlyAllowedBusinessFunction.setIsDelete({ Ids: strId, reason });
                    }
                }
            });
        } else {
            let strId = objValid.strResultID;
            AttSubmitLateEarlyAllowedBusinessFunction.setIsDelete({ Ids: strId });
        }
    },
        ...
        HttpService.Post('[URI_HR]/Att_GetData/GetLateEarlyAllowedById', {
            ...
            try {
                if (res && res.BusinessAllowAction && res.BusinessAllowAction.indexOf('E_MODIFY') >= 0) {
                    const { reload } = _this;
                    _this.props.navigation.navigate(attSubmitLateEarlyAllowedAddOrEdit, { record: item, reload });
                } else {
                    ToasterSevice.showWarning('StatusNotAction');
                }
            } catch (error) {
                            ...
                            HttpService.Post('[URI_HR]/Att_GetData/BusinessAllowActionCancel', {
                                ...
                                try {
                                    if (res && typeof res === enumName.E_object) {
                                        ...
                                        if (isValid) {
                                            AttSubmitLateEarlyAllowedBusinessFunction.confirmCancel(res);
                                        }
                                        //không hợp lệ
                                        else if (
                                            isValid == false &&
    ...
    confirmCancel: objValid => {
        ...
        if (isConfirm) {
            ...
            AlertSevice.alert({
                ...
                onConfirm: reason => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        let strId = objValid.strResultID;
                        AttSubmitLateEarlyAllowedBusinessFunction.setStatusCancel({ Ids: strId, reason });
                    }
                }
            });
        } else {
            //check khung giờ cho Phổ Đình
            let strId = objValid.strResultID;
            AttSubmitLateEarlyAllowedBusinessFunction.setStatusCancel({ Ids: strId });
        }
    },
    ...
    setStatusCancel: objValid => {
        ...
        VnrLoadingSevices.show();
        HttpService.Post('[URI_HR]/Att_GetData/ChangeStatusCancelLateEarlyPortal', {
            selectedIds: Ids,
            host: _uriMain,
            CommentCancel,
            ...
            try {
                if (res && res !== '') {
                    if (typeof res == 'string' && res.includes('Success')) {
                        ToasterSevice.showSuccess('Hrm_Succeed', 4000);
                        _this.reload('E_KEEP_FILTER');
                    } else if (res.indexOf('FieldInvalidMaxLenght') > -1) {
                        const mesError = res.split('|')[0];
