...
import { Colors, Size, stylesScreenDetailV3, stylesScreenDetailV2, CustomStyleSheet } from '../../../../../constants/styleConfig';
...
import AttLateEarlyAllowedListItem from './AttLateEarlyAllowedListItem';
import AttLateEarlyAllowedListItemApprove from './AttLateEarlyAllowedListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class AttLateEarlyAllowedList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.AttApproveLateEarlyAllowed ||
                detail.screenName == ScreenName.AttApprovedLateEarlyAllowed
            ...
            contentList = (
                <FlatList
                    ...
                    style={!isHaveFilter ? CustomStyleSheet.paddingTop(Size.defineSpace) : CustomStyleSheet.paddingTop(0)}
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.AttApproveLateEarlyAllowed ||
                                        detail.screenName == ScreenName.AttApprovedLateEarlyAllowed ? (
                                                <AttLateEarlyAllowedListItemApprove
