...
export default class HreApproveEvaluationDocDocument extends Component {
    ...
    renderCommentList = (commentList) => {
        if (commentList && commentList.length > 0) {
            ...
            return commentList.map((item, index) => {
                ...
                return (
                    <View key={index} style={contentViewControl}>
                        <View style={styles.styViewControl}>
                            <View style={styles.styViewImageWrap}>
                                <Image style={styles.styViewImageAvatar} source={imageAvatar} />
                            </View>

                            <VnrText
                                style={[styleSheets.text, styles.styTextCreatorExtend]}
                                i18nKey={item.CreatorName}
                            />

                            <VnrText style={[styleSheets.text, styles.styTextTimeView]} i18nKey={timeView} />
                        </View>

                        <VnrText style={[styleSheets.text, styles.styTexxtContent]} i18nKey={item.Content} />
                    </View>
                );
            });
        } else {
            return (
                <VnrText
                    style={[styleSheets.text, styles.styTextEmptyComment]}
                    i18nKey={'HRM_Sys_Comment_EmptyComment'}
                />
            );
        }
    };
                ...
                <View style={styleSheets.container}>
                    ...
                    >
                        ...
                        >
                            <View
                                style={[
                                    styleSheets.viewLable,
                                    styles.styViewTabComment
                                ]}
                            >
                                <VnrText
...
const styles = StyleSheet.create({
    styViewTabComment: { borderBottomWidth: 1,
        borderBottomColor: Colors.primary_7 },
    styTextEmptyComment: { fontStyle: 'italic' },
    styTexxtContent: { backgroundColor: Colors.gray_3, paddingHorizontal: 7, paddingVertical: 7, marginTop: 7 },
    styTextTimeView: {
        fontStyle: 'italic',
        marginLeft: 5
    },
    styTextCreatorExtend: { fontWeight: '600' },
    styViewImageAvatar: {
    ...
    styViewImageWrap: { borderRadius: 5, maxWidth: 20, maxHeight: 20, marginRight: 5 },
    styViewControl: { flexDirection: 'row', alignItems: 'center' }
});
