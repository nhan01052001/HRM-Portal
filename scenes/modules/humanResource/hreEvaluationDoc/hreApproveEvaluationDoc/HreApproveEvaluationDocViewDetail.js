...
const configDefault = [
    ...
    {
        TypeView: 'E_COMMON',
        Name: 'EvaDocEvaluationType',
        DisplayKey: 'HRM_Evaluation_Result',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'EvaDocContractTypeName',
        DisplayKey: 'EvaDocContractTypeName',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'AssessmentNote1',
        DisplayKey: 'HRM_Hre_EvaluationDoc_AssessmentNote1',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'AssessmentNote2',
        DisplayKey: 'HRM_Hre_EvaluationDoc_AssessmentNote2',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'AssessmentNote3',
        DisplayKey: 'HRM_Hre_EvaluationDoc_AssessmentNote3',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
        Name: 'AssessmentNote4',
        DisplayKey: 'HRM_Hre_EvaluationDoc_AssessmentNote4',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
...
export default class HreApproveEvaluationDocViewDetail extends Component {
    constructor(props) {
        super(props);
