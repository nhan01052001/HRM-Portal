...
import HreEvaluationDocListItem from './HreEvaluationDocListItem';
import HreEvaluationDocListItemApprove from './HreEvaluationDocListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class HreEvaluationDocList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={{ flex: 1 }}>
                                        {detail.screenName == ScreenName.HreApproveEvaluationDoc ||
                                        detail.screenName == ScreenName.HreApprovedEvaluationDoc ? (
                                                <HreEvaluationDocListItemApprove
