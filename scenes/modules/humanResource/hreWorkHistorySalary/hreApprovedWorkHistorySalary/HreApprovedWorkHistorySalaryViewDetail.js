...
export default class HreApprovedWorkHistorySalaryViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
                ...
                <View style={styleSheets.container}>
                    <ScrollView style={CustomStyleSheet.flexGrow(1)}>
                        <View
                            style={[
                                containerItemDetail,
                                dataItem.isGroup && styles.styViewListDetail
                            ]}
                        >
...
const styles = StyleSheet.create({
    styViewListDetail: { paddingHorizontal: 0,
