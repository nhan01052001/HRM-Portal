...
let configList = null,
    enumName = null,
    hreApproveWorkHistorySalary = null,
    hreApproveWorkHistorySalaryViewDetail = null,
    hreApproveWorkHistorySalaryKeyTask = null,
    pageSizeList = 20;

class HreApproveWorkHistorySalary extends Component {
    constructor(props) {
        super(props);
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreApproveWorkHistorySalaryKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreApproveWorkHistorySalary],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreApproveWorkHistorySalaryKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreApproveWorkHistorySalary]) {
            ...
            ConfigList.value[ScreenName.HreApproveWorkHistorySalary] = {
                Api: {
                    urlApi: '/Por_GetData/NewPortal_GetWorkHistoryListApprove',
                    type: 'POST',
                    pageSize: 20
                },
                Order: [
        ...
        hreApproveWorkHistorySalaryViewDetail = ScreenName.HreApproveWorkHistorySalaryViewDetail;
        hreApproveWorkHistorySalaryKeyTask = EnumTask.KT_HreApproveWorkHistorySalary;
    ...
    render() {
        ...
        return (
            <SafeAreaView {...styleSafeAreaView}>
                {hreApproveWorkHistorySalary && hreApproveWorkHistorySalaryViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HreWorkHistorySalaryList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreApproveWorkHistorySalaryViewDetail,
                                        screenName: hreApproveWorkHistorySalary
                                    }}
                                    ...
                                    keyDataLocal={hreApproveWorkHistorySalaryKeyTask}
