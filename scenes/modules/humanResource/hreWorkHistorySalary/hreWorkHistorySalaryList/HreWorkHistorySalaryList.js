...
import HreWorkHistorySalaryListItem from './HreWorkHistorySalaryListItem';
import HreWorkHistorySalaryListItemApprove from './HreWorkHistorySalaryListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class HreWorkHistorySalaryList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    _renderFooterLoading = () => {
        return (
            <View style={stylesVnrLoading.loadingInLists}>
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.HreApproveWorkHistorySalary ||
                                        detail.screenName == ScreenName.HreApprovedWorkHistorySalary ? (
                                                <HreWorkHistorySalaryListItemApprove
