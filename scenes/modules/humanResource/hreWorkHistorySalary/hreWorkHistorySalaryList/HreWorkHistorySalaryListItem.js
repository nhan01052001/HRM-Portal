...
export default class HreWorkHistorySalaryListItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        //   textFieldTime = `${moment(dataItem.HourFrom).format('HH:mm')} - ${moment(
        //     dataItem.HourTo,
        //   ).format('HH:mm')}`;
        // }
            ...
            >
                <View
                    style={[
                        ...
                        dataItem.WarningWorkHistorySalary && { borderColor: Colors.red }
                    ]}
                >
                    {isOpenAction && (
                            ...
                            <View style={styles.Line}>
                                <View style={styles.lineLeft}>
                                    <View style={[styles.line_date_row]}>
                                        <VnrText
                                            i18nKey={'HRM_Category_Cat_HRPlanningPeriod_DateEffective'}
                                    ...
                                    <View style={[styles.line_date_row]}>
                                        <VnrText
                                            i18nKey={'TypeOfTransferName'}
                                            style={[styleSheets.text, styles.line_value_lable]}
                                        />
                                        <View style={styles.line_time_wrap}>
                                            <Text style={[styleSheets.text, styles.line_value_value]} numberOfLines={1}>
                                                {dataItem.TypeOfTransferName}
                                            </Text>
                                        </View>
                                    </View>

                                    {dataItem.WorkHistorySalaryMonth && (
                                        <View style={styles.line_value}>
                                            ...
                                            <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                                                {`${moment(dataItem.WorkHistorySalaryMonth).format('DD/MM/YYYY')}`}
                                            </Text>
                                        </View>
                                    )}
                    ...
                    dataItem.lstFileAttach && dataItem.lstFileAttach.length > 0 && (
                      <View style={[styles.line_date_row]}>
                        ...
                        <View style={styles.line_time_wrap}>
                          <TouchableOpacity
                            onPress={() => Vnr_Function.downloadFileAttach(dataItem.lstFileAttach[0].path)}>
                            <Text
                              numberOfLines={1}
                              style={[
                                {
                                ...
                                styleSheets.text, styles.line_value_value,
                              ]}>
                  ...
                  <Text
                    ...
                    {(noteAssessment != '' && noteAssessment != '')
                      ...
                      : `${translate(keyNoteAssessment)} : `}
                        ...
                        {dataItem.WarningWorkHistorySalary && (
