...
let configList = null,
    enumName = null,
    hreAllTerminationOfWork = null,
    hreApproveTerminationOfWork = null,
    hreApproveTerminationOfWorkViewDetail = null,
    keyListTask = null,
    pageSizeList = 20;

class HreAllTerminationOfWork extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (HreApproveTerminationOfWorkBusinessFunction.checkForReLoadScreen[hreAllTerminationOfWork]) {
                this.reload();
            }
        });
    }
    ...
    reload = paramsFilter => {
        ...
        HreApproveTerminationOfWorkBusinessFunction.checkForReLoadScreen[hreAllTerminationOfWork] = false;
    ...
    paramsDefault = () => {
        if (!hreAllTerminationOfWork) {
            hreAllTerminationOfWork = ScreenName.HreAllTerminationOfWork;
        }
        if (!configList[hreAllTerminationOfWork] || 1 == 1) {
            ...
            configList[hreAllTerminationOfWork] = {
                Api: {
        ...
        const _configList = configList[hreAllTerminationOfWork],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(hreAllTerminationOfWork);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_HreAllTerminationOfWork;
        HreApproveTerminationOfWorkBusinessFunction.checkForReLoadScreen[hreAllTerminationOfWork] = false;
        //set by config
        ...
        this.setState(ConfigListFilter.value[hreAllTerminationOfWork] ? _paramsDefault : paramStore);
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllTerminationOfWork && hreApproveTerminationOfWorkViewDetail && enumName && (
