...
let configList = null,
    enumName = null,
    hreCanceledTerminationOfWork = null,
    hreCanceledTerminationOfWorkViewDetail = null,
    hreApproveTerminationOfWork = null,
    keyListTask = null,
    pageSizeList = 20;

class HreCanceledTerminationOfWork extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (HreApproveTerminationOfWorkBusinessFunction.checkForReLoadScreen[hreCanceledTerminationOfWork]) {
                this.reload();
            }
        });
    }
    ...
    reload = (paramsFilter) => {
        ...
        HreApproveTerminationOfWorkBusinessFunction.checkForReLoadScreen[hreCanceledTerminationOfWork] = false;
    ...
    paramsDefault = () => {
        if (!hreCanceledTerminationOfWork) {
            hreCanceledTerminationOfWork = ScreenName.HreCanceledTerminationOfWork;
        }
        if (!configList[hreCanceledTerminationOfWork]) {
            configList[hreCanceledTerminationOfWork] = {
                Api: {
        ...
        const _configList = configList[hreCanceledTerminationOfWork],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(hreCanceledTerminationOfWork);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    componentDidMount() {
        ...
        hreCanceledTerminationOfWorkViewDetail = ScreenName.HreApproveTerminationOfWorkViewDetail;
        keyListTask = EnumTask.KT_HreCanceledTerminationOfWork;
        HreApproveTerminationOfWorkBusinessFunction.checkForReLoadScreen[hreCanceledTerminationOfWork] = false;
        //set by config
        ...
        this.setState(ConfigListFilter.value[hreCanceledTerminationOfWork] ? _paramsDefault : paramStore);
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreCanceledTerminationOfWork && hreCanceledTerminationOfWorkViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HreTerminationOfWorkList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreCanceledTerminationOfWorkViewDetail,
                                        screenName: hreApproveTerminationOfWork
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
...
export default connect(mapStateToProps, null)(HreCanceledTerminationOfWork);
