...
let configList = null,
    enumName = null,
    hreApprovedTerminationOfWork = null,
    hreApproveTerminationOfWorkViewDetail = null,
    keyListTask = null,
    pageSizeList = 20;

class HreApprovedTerminationOfWork extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (HreApproveTerminationOfWorkBusinessFunction.checkForReLoadScreen[hreApprovedTerminationOfWork]) {
                this.reload();
            }
        });
    }
    ...
    reload = (paramsFilter) => {
        ...
        HreApproveTerminationOfWorkBusinessFunction.checkForReLoadScreen[hreApprovedTerminationOfWork] = false;
    ...
    paramsDefault = () => {
        if (!hreApprovedTerminationOfWork) {
            hreApprovedTerminationOfWork = ScreenName.HreApprovedTerminationOfWork;
        }
        if (!configList[hreApprovedTerminationOfWork]) {
            configList[hreApprovedTerminationOfWork] = {
                Api: {
        ...
        const _configList = configList[hreApprovedTerminationOfWork],
            renderRow = _configList[enumName.E_Row],
            filter = _configList[enumName.E_Filter],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(hreApprovedTerminationOfWork);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
            pageSize: pageSizeList,
            StatusSyn: 'E_APPROVED',
            tabAll: false,
            tabEnum: 'HR_TAB_APPROVED'
        };
    ...
    componentDidMount() {
        ...
        keyListTask = EnumTask.KT_HreApprovedTerminationOfWork;
        HreApproveTerminationOfWorkBusinessFunction.checkForReLoadScreen[hreApprovedTerminationOfWork] = false;
        //set by config
        ...
        this.setState(ConfigListFilter.value[hreApprovedTerminationOfWork] ? _paramsDefault : paramStore);
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreApprovedTerminationOfWork && hreApproveTerminationOfWorkViewDetail && enumName && (
...
export default connect(mapStateToProps, null)(HreApprovedTerminationOfWork);
