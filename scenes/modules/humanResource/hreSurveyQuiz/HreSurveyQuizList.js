...
import HreSurveyQuizItem from './HreSurveyQuizItem';
...
export default class HreSurveyQuizList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            itemSelected: [],
    ...
    remoteData = () => {
        ...
        let uri = `${api.urlApi}&Page=${page}&PageSize=${this.pageSize}`;
        HttpService.Get(uri, null, this.reload).then(res => {
    ...
    _renderLoading = () => {
        return (
            <View style={styles.styLoadinFOoter}>
