...
import HreViolationListItem from './HreViolationListItem';
import HreViolationListItemApprove from './HreViolationListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class HreViolationList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.HreApproveViolation ||
                detail.screenName == ScreenName.HreApprovedViolation
