...
export default class HreViolationListItemApprove extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    ...
    render() {
        ...
        if (
            ...
            screenName == ScreenName.HreApprovedViolation
        ) {
                                ...
                                <View style={styles.lineLeft}>
                                    <View style={[styles.line_date_row]}>
                                        <VnrText
                                            ...
                                            i18nKey={'HRM_Hre_Violation_ViolationTypeID'}
                                        />
                                        <View style={[styles.line_time_wrap]}>
                                            <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                                                {dataItem.ViolationTypeName != null ? dataItem.ViolationTypeName : ''}
                                            </Text>
                                        </View>
                                    </View>

                                    {dataItem.ViolationMonth && (
                                        <View style={styles.line_value}>
                                            <VnrText
                                                style={[styleSheets.text, styles.line_value_lable]}
                                                i18nKey={'HRM_HreViolation_ViolationMonth'}
                                            />
                                            <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                                                {`${moment(dataItem.ViolationMonth).format('DD/MM/YYYY')}`}
                                            </Text>
                                        </View>
                                    )}
...
const styles = StyleSheet.create({
    styTextListFile: { color: Colors.primary,
