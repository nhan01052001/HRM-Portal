                ...
                >
                    <View style={styles.contentRight}>
                        <View style={styles.Line}>
                            <View style={styles.IconView}>
                                <VnrText
                                    ...
                                    i18nKey={'HRM_HR_Task_CodeTask'}
                                />
                            </View>
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                                    {dataItem.Code ? dataItem.Code : ''}
                                </Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.Line}>
                            <View style={styles.IconView}>
                                <VnrText
                                    numberOfLines={1}
                                    style={[styleSheets.lable, styles.txtLable]}
                                    i18nKey={'HRM_System_Resource_Att_Task'}
                                />
                            </View>
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                                    {dataItem.TaskName ? dataItem.TaskName : ''}
                                </Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.Line}>
                            <View style={styles.IconView}>
                                <VnrText
                                    numberOfLines={1}
                                    style={[styleSheets.lable, styles.txtLable]}
                                    i18nKey={'HRM_Human_Task_Feild_WorkGroup'}
                                />
                            </View>
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                                    {dataItem.TaskGroupName ? dataItem.TaskGroupName : ''}
                                </Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.Line}>
                            ...
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                                    {dataItem.AssignmentDate
                                        ? moment(dataItem.AssignmentDate).format('DD/MM/YYYY')
                                        : ''}
                                </Text>
                            </View>
                        </View>
