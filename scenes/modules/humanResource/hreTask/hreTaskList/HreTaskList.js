...
import { View, FlatList, RefreshControl, TouchableWithoutFeedback, TouchableOpacity, StyleSheet } from 'react-native';
...
class CheckBoxComponent extends Component {
    ...
    render() {
        const { isDisable, isOpenAction, dataItem } = this.props;
        if (isOpenAction) {
            return (
                <View
                    style={[
            ...
            return <View style={[styles.leftContent, { backgroundColor: dataItem.colorStatus }]} />;
        }
    }
}
...
export default class HreTaskList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            itemSelected: [],
    ...
    _renderLoading = () => {
        return (
            <View style={styles.styViewLaoding}>
    ...
    openAction = (index) => {
        ...
        if (!isOpenAction && Array.isArray(stateProps.selected) && stateProps.selected.length > 0) {
