...
export default class HreTaskFollow extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (TaskBusinessBusinessFunction.checkForLoadEditDelete[ScreenName.HreTaskFollow]) {
                this.reload();
            }
        });
    }
    ...
    moveTaskCreate = () => {
        DrawerServices.navigate('HreTaskCreateConfirm');
    };
    ...
    reload = paramsFilter => {
        ...
        TaskBusinessBusinessFunction.checkForLoadEditDelete[ScreenName.HreTaskFollow] = false;
    ...
    paramsDefault = screenName => {
        ...
        const dataRowActionAndSelected = generateRowActionAndSelected(screenName, this.props.navigation);
        let _params = {
            sort: orderBy
        };
        return {
    ...
    componentDidMount() {
        ...
        hreTaskFollow = ScreenName.HreTaskFollow;
        hreTaskViewDetail = ScreenName.HreTaskViewDetail;

        //TaskBusinessBusinessFunction.setThisForBusiness(this, this.props.navigation, hreTaskFollow);
        let _paramsDefault = this.paramsDefault(hreTaskFollow);
    ...
    render() {
        ...
        return (
            <SafeAreaView {...styleSafeAreaView}>
                {hreTaskFollow && hreTaskViewDetail && enumName && (
                    <View style={styleSheets.container}>
                        <VnrFilterCommon
                            style={styleContentFilterDesign}
                            screenName={hreTaskFollow}
