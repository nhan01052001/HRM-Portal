...
export default class RenderItemAction extends React.Component {
    ...
    setRightAction = thisProps => {
        ...
        dataItem.BusinessAllowAction = ['E_DELETE'];
        this.sheetActions = [
            {
    ...
    render() {
        ...
        //                 />
        //             </View>
        //             {this.formatStringType(dataItem, { Name: "WorkDate", DataType: "datetime", DataFormat: "DD/MM/YY" })}
        //         </View>
        //     );
        // }
        return (
                        ...
                        <View style={styles.Line}>
                            <View style={styles.IconView}>
                                <VnrText
                                    numberOfLines={1}
                                    style={[styleSheets.lable, styles.txtLable]}
                                    i18nKey={'HRM_HR_Profile_OrgStructureID'}
                                />
                            </View>
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                        ...
                        <View style={styles.Line}>
                            <View style={styles.IconView}>
                                <VnrText
                                    numberOfLines={1}
                                    style={[styleSheets.lable, styles.txtLable]}
                                    i18nKey={'HRM_Eva_Performance_PositionName'}
                                />
                            </View>
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                        ...
                        <View style={styles.Line}>
                            <View style={styles.IconView}>
                                <VnrText
                                    numberOfLines={1}
                                    style={[styleSheets.lable, styles.txtLable]}
                                    i18nKey={'HRM_HR_Profile_JobTitleName'}
                                />
                            </View>
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                                    {dataItem.JobTitleName ? dataItem.JobTitleName : ''}
                                </Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.Line}>
                            <View style={styles.IconView}>
                                <VnrText
                                    numberOfLines={1}
                                    style={[styleSheets.lable, styles.txtLable]}
                                    i18nKey={'HRM_Category_Role_Title'}
                                />
                            </View>
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                                    {dataItem.RoleView ? dataItem.RoleView : ''}
                                </Text>
                            </View>
                        </View>
