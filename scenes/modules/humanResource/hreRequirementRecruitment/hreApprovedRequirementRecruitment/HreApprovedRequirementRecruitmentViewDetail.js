...
const configDefault = [
    ...
    {
        TypeView: 'E_COMMON',
        Name: 'RequirementRecruitmentCode',
    ...
    },
    {
        TypeView: 'E_COMMON',
        Name: 'Reason',
        DisplayKey: 'HRM_Rec_RequirementRecruitment_Reason',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
...
export default class HreApprovedRequirementRecruitmentViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
            ...
            contentViewDetail = (
                <View style={styleSheets.container}>
                    <ScrollView style={CustomStyleSheet.flexGrow(1)}>
                        <View style={[containerItemDetail, dataItem.isGroup && styles.styViewFormatWrap]}>
...
const styles = StyleSheet.create({
    styViewFormatWrap: { paddingHorizontal: 0, paddingTop: Size.defineSpace }
});
