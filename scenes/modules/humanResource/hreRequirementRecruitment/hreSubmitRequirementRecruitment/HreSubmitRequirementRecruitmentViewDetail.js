...
export default class AttSubmitRequirementRecruitmentViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        HreSubmitRequirementRecruitmentBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
