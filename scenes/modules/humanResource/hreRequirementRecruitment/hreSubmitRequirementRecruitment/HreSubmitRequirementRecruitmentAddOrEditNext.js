...
export default class HreSubmitRequirementRecruitmentAddOrEditNext extends Component {
    constructor(props) {
        super(props);
    ...
    saveRequirementRecruitment = () => {
        ...
        let params = {
            ...
            RequirementRecruitmentID: objConfig.RequirementRecruitmentID,
            ContractTypeID: objConfig.ContractTypeID,
            UpdateRequiredDocumentRequirementRecruitment: objConfig.UpdateRequiredDocumentRequirementRecruitment,
            ...
            TypeRequirementRecruitment: 'E_Actual',
            StopWorkType: 'E_STOP',
        ...
        HttpService.Post('[URI_HR]/Hre_GetData/SaveStopWorking', lstModel).then((data) => {
            ...
            try {
                if (
                    ...
                    DrawerServices.navigate('HreSubmitRequirementRecruitment');
            ...
            <SafeAreaView {...styleSafeAreaView}>
                <View style={styleSheets.container}>
                    ...
                    <View style={styleButtonAddOrEdit.groupButton}>
                        ...
                        <TouchableOpacity
                            onPress={() => this.saveRequirementRecruitment()}
