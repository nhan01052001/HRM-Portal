...
export const generateRowActionAndSelected = () => {
    ...
    if (ConfigList.value != null && ConfigList.value != undefined) {
        const _configList = ConfigList.value[hreApproveRequirementRecruitment],
        ...
        if (actionApprovePer) {
            _rowActions = [
                {
                    ...
                    onPress: (item, dataBody) =>
                        HreApproveRequirementRecruitmentBusinessFunction.businessApproveRecords(
                            [{ ...item }],
                            dataBody
                        ),
                    ...actionApprove
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    type: E_APPROVE,
                    onPress: (item, dataBody) =>
                        HreApproveRequirementRecruitmentBusinessFunction.businessApproveRecords(item, dataBody),
                    ...actionApprove
                }
            ];
        }
        ...
        if (actionRejectPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_REJECT,
                    onPress: (item, dataBody) =>
                        HreApproveRequirementRecruitmentBusinessFunction.businessRejectRecords([{ ...item }], dataBody),
                    ...actionReject
                }
            ];
        ...
        if (actionCancelPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_CANCEL,
                    onPress: (item, dataBody) =>
                        HreApproveRequirementRecruitmentBusinessFunction.businessCancelRecords([{ ...item }], dataBody),
                    ...actionCancel
                }
            ];
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    onPress: (items, dataBody) =>
                        HreApproveRequirementRecruitmentBusinessFunction.businessCancelRecords(items, dataBody),
                    ...actionCancel
                }
            ];
        }
...
export const HreApproveRequirementRecruitmentBusinessFunction = {
    // Đối tượng checkForReLoadScreen để check có refresh ListApprovedStopWorking không
    checkForReLoadScreen: {
        [ScreenName.HreApprovedRequirementRecruitment]: false
    },
            ...
            HttpService.Post('[URI_HR]/Por_GetData/BusinessAllowActionApprove', {
                ...
                try {
                    if (res && typeof res === enumName.E_object) {
                        ...
                        if (isValid) {
                            HreApproveRequirementRecruitmentBusinessFunction.confirmApprove(res);
                        }
                        //không hợp lệ
            ...
            AlertSevice.alert({
                ...
                onConfirm: (reason) => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        HreApproveRequirementRecruitmentBusinessFunction.setStatusApprove({ Ids: strId, reason });
                    }
                }
            });
        } else {
            let strId = objValid.strResultID;
            HreApproveRequirementRecruitmentBusinessFunction.setStatusApprove({ Ids: strId });
        }
    },
    ...
    setStatusApprove: (objValid) => {
        ...
        VnrLoadingSevices.show();
        HttpService.Post('[URI_HR]/Rec_GetData/ApprovedRecRequireRecruitPortal', dataBody).then((data) => {
            VnrLoadingSevices.hide();
            if (data && typeof data === 'string') {
                if (data == enumName.E_Success) {
                    ...
                    if (!_isOnScreenNotification) DrawerServices.navigate(ScreenName.HreApproveRequirementRecruitment);
            ...
            HttpService.Post('[URI_HR]/Por_GetData/BusinessAllowActionReject', {
                ...
                try {
                    if (res && typeof res === 'object') {
                        ...
                        if (isValid) {
                            HreApproveRequirementRecruitmentBusinessFunction.confirmReject(res);
                        }
                        //không hợp lệ
            ...
            AlertSevice.alert({
                ...
                onConfirm: (reason) => {
                    if (isValidInputText && (!reason || reason === '')) {
                        ...
                        let strId = objValid.strResultID;
                        HreApproveRequirementRecruitmentBusinessFunction.setStatusReject({ Ids: strId, reason });
                    }
                }
            });
        } else {
            let strId = objValid.strResultID;
            HreApproveRequirementRecruitmentBusinessFunction.setStatusReject({ Ids: strId });
        }
    },
    ...
    setStatusReject: (objValid) => {
        ...
        VnrLoadingSevices.show();
        HttpService.Post('[URI_HR]/Rec_GetData/ProcessRejectRecruitmentRequest', {
            selectedIds,
                ...
                if (data && typeof data === 'string') {
                    if (data == enumName.E_Success) {
                        ...
                        if (!_isOnScreenNotification)
                            DrawerServices.navigate(ScreenName.HreApproveRequirementRecruitment);
                    } else if (data.indexOf('VaildateMaxLengthError|') > -1) {
                        const mesError = data.split('|')[1];
                        ToasterSevice.showWarning(mesError ? mesError : 'HRM_Common_SendRequest_Error');
...
export default {
    ...
    HreApproveRequirementRecruitmentBusinessFunction: HreApproveRequirementRecruitmentBusinessFunction
};
