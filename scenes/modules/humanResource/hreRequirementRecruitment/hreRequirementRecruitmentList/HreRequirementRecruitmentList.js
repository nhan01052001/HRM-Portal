...
import HreRequirementRecruitmentListItem from './HreRequirementRecruitmentListItem';
import HreRequirementRecruitmentListItemApprove from './HreRequirementRecruitmentListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class HreRequirementRecruitmentList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    render() {
        ...
        } else if (dataSource == EnumName.E_EMPTYDATA) {
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.HreApproveRequirementRecruitment ||
                                        detail.screenName == ScreenName.HreApprovedRequirementRecruitment ? (
                                                <HreRequirementRecruitmentListItemApprove
                                                ...
                                                <HreRequirementRecruitmentListItem
                                                    currentDetail={detail}
                                                    onClick={() => {
                                                        isOpenAction == true ? this.addItemChecked(index) : null;
                                                    }}
