    ...
    render() {
        ...
        return (
            ...
            >
                  ...
                  <View style={styles.leftContentIconView}>
                    ...
                    <View style={styles.circle}>
                      {this.props.isSelect && (
                        ...
                        <View style={[styles.leftContent, styleSheets.flex1flexDirectionRow]}>
                            <TouchableOpacity
                                activeOpacity={isDisable ? 1 : 0.8}
                                onPress={() => {
                                    !isDisable ? this.props.onClick() : null;
                        ...
                        <View style={[styles.leftContent, styles.styViewLeftContent]}>
                            {
              ...
              <Text
                numberOfLines={1}
                style={[styleSheets.lable, styles.profileText]}>
                {dataItem.ProfileName}
              </Text>
              <Text
                numberOfLines={1}
                style={[styleSheets.text, styles.positionText]}>
                {dataItem.PositionName}
              </Text>
                ...
                <View style={styles.Line}>
                  <View style={styles.viewDateNotWorking}>
                    <VnrText
                      style={[
                        styleSheets.text,
                        styles.viewDateNotWorking_lable,
                      ]}
                      i18nKey={'HRM_HR_Profile_DateStop'}
                    />

                    <View style={[styles.viewValue, { alignItems: 'flex-end' }]}>

                      <Text
                        numberOfLines={1}
                        style={[
                          styleSheets.text,
                          styles.viewDateNotWorking_value,
                        ]}>
                        {moment(dataItem.DateStop).format('DD/MM/YYYY')}
                      </Text>
                    </View>
