...
export default class HreApprovedStopWorkingViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (E_KEEP_FILTER, actionIsDelete) => {
        ...
        if (actionIsDelete) {
            DrawerServices.navigate('HreApprovedStopWorking');
        } else {
    ...
    componentDidMount() {
        HreApprovedStopWorkingBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
