...
export default class HreSubmitStopWorkingViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    getDataItem = async (isReload = false) => {
        try {
            ...
            if (!Vnr_Function.CheckIsNullOrEmpty(dataId) || isReload) {
                const response = await HttpService.Post('[URI_HR]/Hre_GetData/NewPortalGetStopWorkingById', {
            ...
            } else if (dataItem != null && dataItem != undefined) {
    ...
    componentDidMount() {
        HreSubmitStopWorkingBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
