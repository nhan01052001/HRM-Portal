...
export default class HreSubmitStopWorkingAddOrEditNext extends Component {
    constructor(props) {
        super(props);
    ...
    saveAndSend = isSend => {
        this.saveStopWorking(null, null, isSend);
    };

    //lưu
    saveStopWorking = (navigation, isSend = null) => {
        ...
        let params = {
            ...
            stopWorkingID: objConfig.stopWorkingID,
            ContractTypeID: objConfig.ContractTypeID,
            UpdateRequiredDocumentStopWorking: objConfig.UpdateRequiredDocumentStopWorking,
        ...
        HttpService.Post('[URI_HR]/Hre_GetData/SaveStopWorking', lstModel).then(data => {
            ...
            try {
                if (
                    ...
                    DrawerServices.navigate('HreSubmitStopWorking');
    ...
    render() {
        ...
        let listActions = [
            {
                type: null,
                title: translate('HRM_Common_GoBack'),
                onPress: () => DrawerServices.goBack()
            },
            {
                type: EnumName.E_SAVE_CLOSE,
                title: translate('HRM_Common_Save'),
                onPress: () => this.saveStopWorking(null, null, null)
            }
        ];

        if (
            PermissionForAppMobile &&
            PermissionForAppMobile.value['New_Hre_PersonalSubmitStopWorking_btnSaveAndSendMail'] &&
            PermissionForAppMobile.value['New_Hre_PersonalSubmitStopWorking_btnSaveAndSendMail']['View']
        ) {
            listActions = [
                {
                    type: EnumName.E_SAVE_SENMAIL,
                    title: translate('HRM_Common_SaveAndEmail'),
                    onPress: () => this.saveAndSend(true)
                },
                ...listActions
            ];
        }
        ...
        return (
            <SafeAreaView {...styleSafeAreaView}>
                <View style={styleSheets.container}>
                    ...
                    {/* task: 0171218: [Hotfix_SOTRANS_v8.10.44.01.12]APP: Thêm nút Lưu và gửi mail cho mh DS Đăng ký nghỉ việc */}
            ...
            <TouchableOpacity
              ...
              <VnrText
                style={[
                  styleSheets.lable, styleButtonAddOrEdit.groupButton__text,
