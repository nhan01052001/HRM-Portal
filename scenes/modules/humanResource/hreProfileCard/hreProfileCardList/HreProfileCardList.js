...
import HreProfileCardListItem from './HreProfileCardListItem';
import HreProfileCardListItemApprove from './HreProfileCardListItemApprove';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
const heightActionBottom = 45;

export default class HreProfileCardList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                ...
                                >
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail.screenName == ScreenName.HreApproveProfileCard ||
                                        detail.screenName == ScreenName.HreApprovedProfileCard ? (
                                                <HreProfileCardListItemApprove
