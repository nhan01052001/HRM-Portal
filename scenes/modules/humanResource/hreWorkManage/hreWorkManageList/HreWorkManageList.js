...
import HreWorkManageListItem from './HreWorkManageListItem';
import HreWorkManageListItemManage from './HreWorkManageListItemManage';
import { ConfigListFilter } from '../../../../../assets/configProject/ConfigListFilter';
import Vnr_Services from '../../../../../utils/Vnr_Services';
import { ToasterSevice } from '../../../../../components/Toaster/Toaster';
const heightActionBottom = 45;

export default class HreWorkManageList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                ...
                .then((resData) => {
                    ...
                    if (res && res !== EnumName.E_EMPTYDATA) {
                        ...
                        data.forEach((item) => {
                            ...
                            item.itemStatus = Vnr_Services.formatStyleStatusApp(item.WorkListStatus);
    ...
    _renderFooterLoading = () => {
        return (
            <View style={stylesScreenDetailV3.loadingFooter}>
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                <TouchableWithoutFeedback>
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {detail?.screenNameRender === 'Manage' ? (
                                            <HreWorkManageListItemManage
                                                key={index}
