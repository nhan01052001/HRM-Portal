...
let configList = null,
    enumName = null,
    hreDoneWorkManage = null,
    hreDoneWorkManageViewDetail = null,
    hreDoneWorkManageKeyTask = null,
    pageSizeList = 50;

class HreDoneWorkManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreDoneWorkManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreDoneWorkManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!configList[hreDoneWorkManage]) {
            configList[hreDoneWorkManage] = {
                Api: {
        ...
        const _configList = configList[hreDoneWorkManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreDoneWorkManageKeyTask) {
    ...
    componentDidMount() {
        hreDoneWorkManage = ScreenName.HreDoneWorkManage;
        hreDoneWorkManageViewDetail = ScreenName.HreWorkManageViewDetail;
        hreDoneWorkManageKeyTask = EnumTask.KT_HreDoneWorkManage;
        // AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreDoneWorkManage] = false;
        //set by config
        ...
        this.setState(ConfigListFilter.value[hreDoneWorkManage] ? _paramsDefault : paramStore);
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreDoneWorkManage && hreDoneWorkManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HreWorkBoardList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreDoneWorkManageViewDetail,
                                        screenName: hreDoneWorkManage,
                                    ...
                                    keyDataLocal={hreDoneWorkManageKeyTask}
