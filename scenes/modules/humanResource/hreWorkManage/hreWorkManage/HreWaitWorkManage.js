...
let configList = null,
    enumName = null,
    hreWaitWorkManage = null,
    hreWorkManageViewDetail = null,
    hreWaitWorkManageKeyTask = null,
    pageSizeList = 50;

class HreWaitWorkManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreWaitWorkManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreWaitWorkManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreWaitWorkManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreWaitWorkManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreWaitWorkManage]) {
            ConfigList.value[ScreenName.HreWaitWorkManage] = {
                Api: {
        ...
        hreWaitWorkManage = ScreenName.HreWaitWorkManage;
        hreWorkManageViewDetail = ScreenName.HreWorkManageViewDetail;
        hreWaitWorkManageKeyTask = EnumTask.KT_HreWaitWorkManage;
        // AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreWaitWorkManage] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreWaitWorkManage && hreWorkManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HreWorkBoardList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreWorkManageViewDetail,
                                        screenName: hreWaitWorkManage,
                                    ...
                                    keyDataLocal={hreWaitWorkManageKeyTask}
