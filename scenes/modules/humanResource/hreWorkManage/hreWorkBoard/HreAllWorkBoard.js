...
let configList = null,
    enumName = null,
    hreAllWorkBoard = null,
    hreAllWorkBoardViewDetail = null,
    hreAllWorkBoardKeyTask = null,
    pageSizeList = 50;

class HreAllWorkBoard extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllWorkBoard]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreAllWorkBoardKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreAllWorkBoard],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreAllWorkBoardKeyTask) {
    ...
    componentDidMount() {
        hreAllWorkBoard = ScreenName.HreAllWorkBoard;
        hreAllWorkBoardViewDetail = ScreenName.HreWorkBoardViewDetail;
        hreAllWorkBoardKeyTask = EnumTask.KT_HreAllWorkBoard;
        // AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllWorkBoard] = false;
        //set by config
        ...
        this.setState(ConfigListFilter.value[hreAllWorkBoard] ? _paramsDefault : paramStore);
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllWorkBoard && hreAllWorkBoardViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HreWorkBoardList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreAllWorkBoardViewDetail,
                                        screenName: hreAllWorkBoard,
                                        screenNameRender: hreAllWorkBoard
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreAllWorkBoardKeyTask}
