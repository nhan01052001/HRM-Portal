...
let configList = null,
    enumName = null,
    hreWaitWorkBoard = null,
    hreWaitWorkBoardViewDetail = null,
    hreWaitWorkBoardKeyTask = null,
    pageSizeList = 50;

class HreWaitWorkBoard extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreWaitWorkBoard]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = (paramsFilter) => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreWaitWorkBoardKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreWaitWorkBoard],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreWaitWorkBoardKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreWaitWorkBoard]) {
            ConfigList.value[ScreenName.HreWaitWorkBoard] = {
                Api: {
        ...
        hreWaitWorkBoard = ScreenName.HreWaitWorkBoard;
        hreWaitWorkBoardViewDetail = ScreenName.HreWorkBoardViewDetail;
        hreWaitWorkBoardKeyTask = EnumTask.KT_HreWaitWorkBoard;
        // AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreWaitWorkBoard] = false;
        //set by config
        ...
        this.setState(ConfigListFilter.value[hreWaitWorkBoard] ? _paramsDefault : paramStore);
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreWaitWorkBoard && hreWaitWorkBoardViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HreWorkBoardList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreWaitWorkBoardViewDetail,
                                        screenName: hreWaitWorkBoard,
                                        screenNameRender: hreWaitWorkBoard
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreWaitWorkBoardKeyTask}
...
export default connect(mapStateToProps, null)(HreWaitWorkBoard);
