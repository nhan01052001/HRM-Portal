...
let configList = null,
    enumName = null,
    hreDoneWorkBoard = null,
    hreDoneWorkBoardViewDetail = null,
    hreDoneWorkBoardKeyTask = null,
    pageSizeList = 50;

class HreDoneWorkBoard extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreDoneWorkBoard]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = (paramsFilter) => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreDoneWorkBoardKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreDoneWorkBoard],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreDoneWorkBoardKeyTask) {
    ...
    componentDidMount() {
        hreDoneWorkBoard = ScreenName.HreDoneWorkBoard;
        hreDoneWorkBoardViewDetail = ScreenName.HreWorkBoardViewDetail;
        hreDoneWorkBoardKeyTask = EnumTask.KT_HreDoneWorkBoard;
        // AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreDoneWorkBoard] = false;
        //set by config
        ...
        this.setState(ConfigListFilter.value[hreDoneWorkBoard] ? _paramsDefault : paramStore);
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreDoneWorkBoard && hreDoneWorkBoardViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HreWorkBoardList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreDoneWorkBoardViewDetail,
                                        screenName: hreDoneWorkBoard,
                                        screenNameRender: hreDoneWorkBoard
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreDoneWorkBoardKeyTask}
...
export default connect(mapStateToProps, null)(HreDoneWorkBoard);
