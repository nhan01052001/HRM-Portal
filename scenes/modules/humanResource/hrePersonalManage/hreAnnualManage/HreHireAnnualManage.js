...
let configList = null,
    enumName = null,
    hreHireAnnualManage = null,
    hreHireAnnualManageViewDetail = null,
    hreHireAnnualManageKeyTask = null,
    pageSizeList = 50;

class HreHireAnnualManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreHireAnnualManage]) {
            //     this.reload();
            // } else {
            // }
        });
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreHireAnnualManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreHireAnnualManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreHireAnnualManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreHireAnnualManage]) {
            ConfigList.value[ScreenName.HreHireAnnualManage] = {
                Api: {
        ...
        hreHireAnnualManage = ScreenName.HreHireAnnualManage;
        hreHireAnnualManageViewDetail = ScreenName.HreAnnualManageViewDetail;
        hreHireAnnualManageKeyTask = EnumTask.KT_HreHireAnnualManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreHireAnnualManage && hreHireAnnualManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreHireAnnualManageViewDetail,
                                        screenName: hreHireAnnualManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreHireAnnualManageKeyTask}
