...
let configList = null,
    enumName = null,
    hreStopAnnualManage = null,
    hreStopAnnualManageViewDetail = null,
    hreStopAnnualManageKeyTask = null,
    pageSizeList = 50;

class HreStopAnnualManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreStopAnnualManage]) {
            //     this.reload();
            // } else {
            // }
        });
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreStopAnnualManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreStopAnnualManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreStopAnnualManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreStopAnnualManage]) {
            ConfigList.value[ScreenName.HreStopAnnualManage] = {
                Api: {
        ...
        hreStopAnnualManage = ScreenName.HreStopAnnualManage;
        hreStopAnnualManageViewDetail = ScreenName.HreAnnualManageViewDetail;
        hreStopAnnualManageKeyTask = EnumTask.KT_HreStopAnnualManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreStopAnnualManage && hreStopAnnualManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreStopAnnualManageViewDetail,
                                        screenName: hreStopAnnualManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreStopAnnualManageKeyTask}
