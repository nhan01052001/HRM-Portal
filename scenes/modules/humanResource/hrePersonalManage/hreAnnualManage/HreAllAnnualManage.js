...
let configList = null,
    enumName = null,
    hreAllAnnualManage = null,
    hreAllAnnualManageViewDetail = null,
    hreAllAnnualManageKeyTask = null,
    pageSizeList = 20;

class HreAllAnnualManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllAnnualManage]) {
            //     this.reload();
            // } else {
            // }
        });
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreAllAnnualManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        ...
        const _configList = configList[hreAllAnnualManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreAllAnnualManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreAllAnnualManage]) {
            ConfigList.value[ScreenName.HreAllAnnualManage] = {
                Api: {
        ...
        hreAllAnnualManage = ScreenName.HreAllAnnualManage;
        hreAllAnnualManageViewDetail = ScreenName.HreAnnualManageViewDetail;
        hreAllAnnualManageKeyTask = EnumTask.KT_HreAllAnnualManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllAnnualManage && hreAllAnnualManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreAllAnnualManageViewDetail,
                                        screenName: hreAllAnnualManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreAllAnnualManageKeyTask}
