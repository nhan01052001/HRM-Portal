...
const configDefault = [
    ...
    {
        TypeView: 'E_GROUP',
        DisplayKey: 'HRM_PortalApp_HreCompensationManage_InfoDetail',
        DataType: 'string'
    },
    {
        TypeView: 'E_COMMON',
    ...
    {
        TypeView: 'E_GROUP',
        DisplayKey: 'HRM_PortalApp_HreCompensationManage_LeaveInMonth',
        DataType: 'string'
    }
];

export default class HreCompensationManageViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
    ...
    getDataItem = async () => {
        try {
            const _params = this.props.navigation.state.params,
                ...
                _configListDetail =
                    ConfigListDetail.value[ScreenName.HreCompensationManageViewDetail] != null
                        ? ConfigListDetail.value[ScreenName.HreCompensationManageViewDetail]
                        : configDefault;
