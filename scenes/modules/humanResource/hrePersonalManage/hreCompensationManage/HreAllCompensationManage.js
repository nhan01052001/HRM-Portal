...
let configList = null,
    enumName = null,
    hreAllCompensationManage = null,
    hreAllCompensationManageViewDetail = null,
    hreAllCompensationManageKeyTask = null,
    pageSizeList = 50;

class HreAllCompensationManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllCompensationManage]) {
            //     this.reload();
            // } else {
            // }
        });
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreAllCompensationManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        ...
        const _configList = configList[hreAllCompensationManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreAllCompensationManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreAllCompensationManage]) {
            ConfigList.value[ScreenName.HreAllCompensationManage] = {
                Api: {
        ...
        hreAllCompensationManage = ScreenName.HreAllCompensationManage;
        hreAllCompensationManageViewDetail = ScreenName.HreCompensationManageViewDetail;
        hreAllCompensationManageKeyTask = EnumTask.KT_HreAllCompensationManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllCompensationManage && hreAllCompensationManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreAllCompensationManageViewDetail,
                                        screenName: hreAllCompensationManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreAllCompensationManageKeyTask}
