...
let configList = null,
    enumName = null,
    hreHireCompensationManage = null,
    hreHireCompensationManageViewDetail = null,
    hreHireCompensationManageKeyTask = null,
    pageSizeList = 50;

class HreHireCompensationManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreHireCompensationManage]) {
            //     this.reload();
            // } else {
            // }
        });
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreHireCompensationManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreHireCompensationManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreHireCompensationManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreHireCompensationManage]) {
            ConfigList.value[ScreenName.HreHireCompensationManage] = {
                Api: {
        ...
        hreHireCompensationManage = ScreenName.HreHireCompensationManage;
        hreHireCompensationManageViewDetail = ScreenName.HreCompensationManageViewDetail;
        hreHireCompensationManageKeyTask = EnumTask.KT_HreHireCompensationManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreHireCompensationManage && hreHireCompensationManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreHireCompensationManageViewDetail,
                                        screenName: hreHireCompensationManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreHireCompensationManageKeyTask}
