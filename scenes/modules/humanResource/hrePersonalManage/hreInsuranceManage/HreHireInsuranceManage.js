...
let configList = null,
    enumName = null,
    hreHireInsuranceManage = null,
    hreHireInsuranceManageViewDetail = null,
    hreHireInsuranceManageKeyTask = null,
    pageSizeList = 50;

class HreHireInsuranceManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreHireInsuranceManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreHireInsuranceManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreHireInsuranceManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreHireInsuranceManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreHireInsuranceManage]) {
            ConfigList.value[ScreenName.HreHireInsuranceManage] = {
                Api: {
        ...
        hreHireInsuranceManage = ScreenName.HreHireInsuranceManage;
        hreHireInsuranceManageViewDetail = ScreenName.HreInsuranceManageViewDetail;
        hreHireInsuranceManageKeyTask = EnumTask.KT_HreHireInsuranceManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreHireInsuranceManage && hreHireInsuranceManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreHireInsuranceManageViewDetail,
                                        screenName: hreHireInsuranceManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreHireInsuranceManageKeyTask}
