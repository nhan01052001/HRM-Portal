...
let configList = null,
    enumName = null,
    hreAllInsuranceManage = null,
    hreAllInsuranceManageViewDetail = null,
    hreAllInsuranceManageKeyTask = null,
    pageSizeList = 50;

class HreAllInsuranceManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllInsuranceManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreAllInsuranceManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        ...
        const _configList = configList[hreAllInsuranceManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreAllInsuranceManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreAllInsuranceManage]) {
            ConfigList.value[ScreenName.HreAllInsuranceManage] = {
                Api: {
        ...
        hreAllInsuranceManage = ScreenName.HreAllInsuranceManage;
        hreAllInsuranceManageViewDetail = ScreenName.HreInsuranceManageViewDetail;
        hreAllInsuranceManageKeyTask = EnumTask.KT_HreAllInsuranceManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllInsuranceManage && hreAllInsuranceManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreAllInsuranceManageViewDetail,
                                        screenName: hreAllInsuranceManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreAllInsuranceManageKeyTask}
