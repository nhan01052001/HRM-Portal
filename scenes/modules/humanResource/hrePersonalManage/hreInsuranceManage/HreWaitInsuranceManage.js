...
let configList = null,
    enumName = null,
    hreWaitInsuranceManage = null,
    hreWaitInsuranceManageViewDetail = null,
    hreWaitInsuranceManageKeyTask = null,
    pageSizeList = 50;

class HreWaitInsuranceManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreWaitInsuranceManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreWaitInsuranceManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreWaitInsuranceManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreWaitInsuranceManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreWaitInsuranceManage]) {
            ConfigList.value[ScreenName.HreWaitInsuranceManage] = {
                Api: {
        ...
        hreWaitInsuranceManage = ScreenName.HreWaitInsuranceManage;
        hreWaitInsuranceManageViewDetail = ScreenName.HreInsuranceManageViewDetail;
        hreWaitInsuranceManageKeyTask = EnumTask.KT_HreWaitInsuranceManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreWaitInsuranceManage && hreWaitInsuranceManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreWaitInsuranceManageViewDetail,
                                        screenName: hreWaitInsuranceManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreWaitInsuranceManageKeyTask}
