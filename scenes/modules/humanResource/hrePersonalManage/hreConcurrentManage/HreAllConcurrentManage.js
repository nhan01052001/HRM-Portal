...
let configList = null,
    enumName = null,
    hreAllConcurrentManage = null,
    hreAllConcurrentManageViewDetail = null,
    hreAllConcurrentManageKeyTask = null,
    pageSizeList = 50;

class HreAllConcurrentManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllConcurrentManage]) {
            //     this.reload();
            // } else {
            // }
        });
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreAllConcurrentManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        ...
        const _configList = configList[hreAllConcurrentManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreAllConcurrentManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreAllConcurrentManage]) {
            ConfigList.value[ScreenName.HreAllConcurrentManage] = {
                Api: {
        ...
        hreAllConcurrentManage = ScreenName.HreAllConcurrentManage;
        hreAllConcurrentManageViewDetail = ScreenName.HreConcurrentManageViewDetail;
        hreAllConcurrentManageKeyTask = EnumTask.KT_HreAllConcurrentManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllConcurrentManage && hreAllConcurrentManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreAllConcurrentManageViewDetail,
                                        screenName: hreAllConcurrentManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreAllConcurrentManageKeyTask}
