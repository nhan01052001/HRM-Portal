...
let configList = null,
    enumName = null,
    hreStopConcurrentManage = null,
    hreStopConcurrentManageViewDetail = null,
    hreStopConcurrentManageKeyTask = null,
    pageSizeList = 50;

class HreStopConcurrentManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreStopConcurrentManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreStopConcurrentManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreStopConcurrentManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreStopConcurrentManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreStopConcurrentManage]) {
            ConfigList.value[ScreenName.HreStopConcurrentManage] = {
                Api: {
        ...
        hreStopConcurrentManage = ScreenName.HreStopConcurrentManage;
        hreStopConcurrentManageViewDetail = ScreenName.HreConcurrentManageViewDetail;
        hreStopConcurrentManageKeyTask = EnumTask.KT_HreStopConcurrentManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreStopConcurrentManage && hreStopConcurrentManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreStopConcurrentManageViewDetail,
                                        screenName: hreStopConcurrentManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreStopConcurrentManageKeyTask}
