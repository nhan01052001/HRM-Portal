...
let configList = null,
    enumName = null,
    hreWaitConcurrentManage = null,
    hreWaitConcurrentManageViewDetail = null,
    hreWaitConcurrentManageKeyTask = null,
    pageSizeList = 50;

class HreWaitConcurrentManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreWaitConcurrentManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreWaitConcurrentManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreWaitConcurrentManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreWaitConcurrentManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreWaitConcurrentManage]) {
            ConfigList.value[ScreenName.HreWaitConcurrentManage] = {
                Api: {
        ...
        hreWaitConcurrentManage = ScreenName.HreWaitConcurrentManage;
        hreWaitConcurrentManageViewDetail = ScreenName.HreConcurrentManageViewDetail;
        hreWaitConcurrentManageKeyTask = EnumTask.KT_HreWaitConcurrentManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreWaitConcurrentManage && hreWaitConcurrentManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreWaitConcurrentManageViewDetail,
                                        screenName: hreWaitConcurrentManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreWaitConcurrentManageKeyTask}
