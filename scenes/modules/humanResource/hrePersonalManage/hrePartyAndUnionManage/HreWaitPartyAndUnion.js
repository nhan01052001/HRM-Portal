...
let configList = null,
    enumName = null,
    hreWaitPartyAndUnion = null,
    hrePartyAndUnionViewDetail = null,
    hreWaitPartyAndUnionKeyTask = null,
    pageSizeList = 50;

class HreWaitPartyAndUnion extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreWaitPartyAndUnion]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreWaitPartyAndUnionKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreWaitPartyAndUnion],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreWaitPartyAndUnionKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreWaitPartyAndUnion]) {
            ConfigList.value[ScreenName.HreWaitPartyAndUnion] = {
                Api: {
        ...
        hreWaitPartyAndUnion = ScreenName.HreWaitPartyAndUnion;
        hrePartyAndUnionViewDetail = ScreenName.HrePartyAndUnionViewDetail;
        hreWaitPartyAndUnionKeyTask = EnumTask.KT_HreWaitPartyAndUnion;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreWaitPartyAndUnion && hrePartyAndUnionViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    ...
                                    keyDataLocal={hreWaitPartyAndUnionKeyTask}
