...
let configList = null,
    enumName = null,
    hreStopPartyAndUnion = null,
    hrePartyAndUnionViewDetail = null,
    hreStopPartyAndUnionKeyTask = null,
    pageSizeList = 50;

class HreStopPartyAndUnion extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreStopPartyAndUnion]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreStopPartyAndUnionKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreStopPartyAndUnion],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreStopPartyAndUnionKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreStopPartyAndUnion]) {
            ConfigList.value[ScreenName.HreStopPartyAndUnion] = {
                Api: {
        ...
        hreStopPartyAndUnion = ScreenName.HreStopPartyAndUnion;
        hrePartyAndUnionViewDetail = ScreenName.HrePartyAndUnionViewDetail;
        hreStopPartyAndUnionKeyTask = EnumTask.KT_HreStopPartyAndUnion;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreStopPartyAndUnion && hrePartyAndUnionViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hrePartyAndUnionViewDetail,
                                        screenName: hreStopPartyAndUnion
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreStopPartyAndUnionKeyTask}
