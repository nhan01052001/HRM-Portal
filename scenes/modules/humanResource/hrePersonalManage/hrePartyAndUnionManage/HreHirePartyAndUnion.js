...
let configList = null,
    enumName = null,
    hreHirePartyAndUnion = null,
    hrePartyAndUnionViewDetail = null,
    hreHirePartyAndUnionKeyTask = null,
    pageSizeList = 50;

class HreHirePartyAndUnion extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreHirePartyAndUnion]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreHirePartyAndUnionKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreHirePartyAndUnion],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreHirePartyAndUnionKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreHirePartyAndUnion]) {
            ConfigList.value[ScreenName.HreHirePartyAndUnion] = {
                Api: {
        ...
        hreHirePartyAndUnion = ScreenName.HreHirePartyAndUnion;
        hrePartyAndUnionViewDetail = ScreenName.HrePartyAndUnionViewDetail;
        hreHirePartyAndUnionKeyTask = EnumTask.KT_HreHirePartyAndUnion;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreHirePartyAndUnion && hrePartyAndUnionViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    ...
                                    keyDataLocal={hreHirePartyAndUnionKeyTask}
