...
let configList = null,
    enumName = null,
    hreStopMovementHistory = null,
    hreStopMovementHistoryViewDetail = null,
    hreStopMovementHistoryKeyTask = null,
    pageSizeList = 50;

class HreStopMovementHistory extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreStopMovementHistory]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreStopMovementHistoryKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreStopMovementHistory],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreStopMovementHistoryKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreStopMovementHistory]) {
            ConfigList.value[ScreenName.HreStopMovementHistory] = {
                Api: {
                    urlApi: '[URI_CENTER]/api/Hre_ProfileAPI/New_GetProfileWorkHistoryPortal',
                    type: 'POST',
                    pageSize: 20
                },
                Order: [
        ...
        hreStopMovementHistory = ScreenName.HreStopMovementHistory;
        hreStopMovementHistoryViewDetail = ScreenName.HreMovementHistoryViewDetail;
        hreStopMovementHistoryKeyTask = EnumTask.KT_HreStopMovementHistory;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreStopMovementHistory && hreStopMovementHistoryViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreStopMovementHistoryViewDetail,
                                        screenName: hreStopMovementHistory
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreStopMovementHistoryKeyTask}
