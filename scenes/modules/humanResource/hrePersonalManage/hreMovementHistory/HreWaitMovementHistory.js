...
let configList = null,
    enumName = null,
    hreWaitMovementHistory = null,
    hreWaitMovementHistoryViewDetail = null,
    hreStopRelativeManageKeyTask = null,
    pageSizeList = 50;

class HreWaitMovementHistory extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreWaitMovementHistory]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreStopRelativeManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreWaitMovementHistory],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreStopRelativeManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreWaitMovementHistory]) {
            ConfigList.value[ScreenName.HreWaitMovementHistory] = {
                Api: {
        ...
        hreWaitMovementHistory = ScreenName.HreWaitMovementHistory;
        hreWaitMovementHistoryViewDetail = ScreenName.HreMovementHistoryViewDetail;
        hreStopRelativeManageKeyTask = EnumTask.KT_HreWaitMovementHistory;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreWaitMovementHistory && hreWaitMovementHistoryViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreWaitMovementHistoryViewDetail,
                                        screenName: hreWaitMovementHistory
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreStopRelativeManageKeyTask}
