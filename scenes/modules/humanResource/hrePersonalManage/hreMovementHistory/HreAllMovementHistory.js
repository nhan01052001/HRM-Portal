...
let configList = null,
    enumName = null,
    hreAllMovementHistory = null,
    hreAllMovementHistoryViewDetail = null,
    hreAllRelativeManageKeyTask = null,
    pageSizeList = 50;

class HreAllMovementHistory extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllMovementHistory]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreAllRelativeManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        ...
        const _configList = configList[hreAllMovementHistory],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreAllRelativeManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreAllMovementHistory]) {
            ConfigList.value[ScreenName.HreAllMovementHistory] = {
                Api: {
        ...
        hreAllMovementHistory = ScreenName.HreAllMovementHistory;
        hreAllMovementHistoryViewDetail = ScreenName.HreMovementHistoryViewDetail;
        hreAllRelativeManageKeyTask = EnumTask.KT_HreAllMovementHistory;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllMovementHistory && hreAllMovementHistoryViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreAllMovementHistoryViewDetail,
                                        screenName: hreAllMovementHistory
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreAllRelativeManageKeyTask}
