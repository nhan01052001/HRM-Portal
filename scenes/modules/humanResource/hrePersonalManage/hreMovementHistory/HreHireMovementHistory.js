...
let configList = null,
    enumName = null,
    hreHireMovementHistory = null,
    hreHireMovementHistoryViewDetail = null,
    hreHireMovementHistoryKeyTask = null,
    pageSizeList = 50;

class HreHireMovementHistory extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreHireMovementHistory]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreHireMovementHistoryKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreHireMovementHistory],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreHireMovementHistoryKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreHireMovementHistory]) {
            ConfigList.value[ScreenName.HreHireMovementHistory] = {
                Api: {
        ...
        hreHireMovementHistory = ScreenName.HreHireMovementHistory;
        hreHireMovementHistoryViewDetail = ScreenName.HreMovementHistoryViewDetail;
        hreHireMovementHistoryKeyTask = EnumTask.KT_HreHireMovementHistory;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreHireMovementHistory && hreHireMovementHistoryViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreHireMovementHistoryViewDetail,
                                        screenName: hreHireMovementHistory
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreHireMovementHistoryKeyTask}
