...
let configList = null,
    enumName = null,
    hreStopAccidentManage = null,
    hreStopAccidentManageViewDetail = null,
    hreStopAccidentManageKeyTask = null,
    pageSizeList = 50;

class HreStopAccidentManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreStopAccidentManage]) {
            //     this.reload();
            // } else {
            // }
        });
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreStopAccidentManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreStopAccidentManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreStopAccidentManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreStopAccidentManage]) {
            ConfigList.value[ScreenName.HreStopAccidentManage] = {
                Api: {
                    urlApi: '[URI_CENTER]/api/Hre_ProfileAPI/New_GetProfileAccidentPortal',
                    type: 'POST',
                    pageSize: 20
                },
                Order: [
        ...
        hreStopAccidentManage = ScreenName.HreStopAccidentManage;
        hreStopAccidentManageViewDetail = ScreenName.HreAccidentManageViewDetail;
        hreStopAccidentManageKeyTask = EnumTask.KT_HreStopAccidentManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreStopAccidentManage && hreStopAccidentManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreStopAccidentManageViewDetail,
                                        screenName: hreStopAccidentManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreStopAccidentManageKeyTask}
