...
let configList = null,
    enumName = null,
    hreHireAccidentManage = null,
    hreHireAccidentManageViewDetail = null,
    hreHireAccidentManageKeyTask = null,
    pageSizeList = 50;

class HreHireAccidentManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreHireAccidentManage]) {
            //     this.reload();
            // } else {
            // }
        });
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreHireAccidentManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreHireAccidentManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreHireAccidentManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreHireAccidentManage]) {
            ConfigList.value[ScreenName.HreHireAccidentManage] = {
                Api: {
        ...
        hreHireAccidentManage = ScreenName.HreHireAccidentManage;
        hreHireAccidentManageViewDetail = ScreenName.HreAccidentManageViewDetail;
        hreHireAccidentManageKeyTask = EnumTask.KT_HreHireAccidentManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreHireAccidentManage && hreHireAccidentManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreHireAccidentManageViewDetail,
                                        screenName: hreHireAccidentManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreHireAccidentManageKeyTask}
