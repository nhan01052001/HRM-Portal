...
let configList = null,
    enumName = null,
    hreAllAccidentManage = null,
    hreAllAccidentManageViewDetail = null,
    hreAllAccidentManageKeyTask = null,
    pageSizeList = 50;

class HreAllAccidentManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllAccidentManage]) {
            //     this.reload();
            // } else {
            //
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreAllAccidentManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        ...
        const _configList = configList[hreAllAccidentManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreAllAccidentManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreAllAccidentManage]) {
            ConfigList.value[ScreenName.HreAllAccidentManage] = {
                Api: {
        ...
        hreAllAccidentManage = ScreenName.HreAllAccidentManage;
        hreAllAccidentManageViewDetail = ScreenName.HreAccidentManageViewDetail;
        hreAllAccidentManageKeyTask = EnumTask.KT_HreAllAccidentManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllAccidentManage && hreAllAccidentManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreAllAccidentManageViewDetail,
                                        screenName: hreAllAccidentManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreAllAccidentManageKeyTask}
