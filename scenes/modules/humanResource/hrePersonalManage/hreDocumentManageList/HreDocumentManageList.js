...
import HreDocumentManageListItem from './HreDocumentManageListItem';
...
export default class HreDocumentManageList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                ...
                .then(resData => {
                    ...
                    if (res && res !== EnumName.E_EMPTYDATA) {
                        ...
                        data.forEach(item => {
                            ...
                            item.lstFileAttach = ManageFileSevice.setFileAttachApp(item.FileAttach);
                        });
                    ...
                    return (
                        <View
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                <TouchableWithoutFeedback>
                                    <View style={CustomStyleSheet(1)}>
                                        <HreDocumentManageListItem
