...
let configList = null,
    enumName = null,
    hreHireRewardManage = null,
    hreHireRewardManageViewDetail = null,
    hreHireRewardManageKeyTask = null,
    pageSizeList = 50;

class HreHireRewardManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreHireRewardManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreHireRewardManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreHireRewardManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreHireRewardManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreHireRewardManage]) {
            ConfigList.value[ScreenName.HreHireRewardManage] = {
                Api: {
        ...
        hreHireRewardManage = ScreenName.HreHireRewardManage;
        hreHireRewardManageViewDetail = ScreenName.HreRewardManageViewDetail;
        hreHireRewardManageKeyTask = EnumTask.KT_HreHireRewardManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreHireRewardManage && hreHireRewardManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreHireRewardManageViewDetail,
                                        screenName: hreHireRewardManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreHireRewardManageKeyTask}
