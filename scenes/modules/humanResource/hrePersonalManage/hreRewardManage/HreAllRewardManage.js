...
let configList = null,
    enumName = null,
    hreAllRewardManage = null,
    hreAllRewardManageViewDetail = null,
    hreAllRewardManageKeyTask = null,
    pageSizeList = 50;

class HreAllRewardManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllRewardManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreAllRewardManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreAllRewardManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreAllRewardManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreAllRewardManage]) {
            ConfigList.value[ScreenName.HreAllRewardManage] = {
                Api: {
                ...
                Row: [
                    {
                        ...
                        DisplayKey: 'HRM_HR_Reward_DateOfEffective',
                        DataType: 'Datetime',
        ...
        hreAllRewardManage = ScreenName.HreAllRewardManage;
        hreAllRewardManageViewDetail = ScreenName.HreRewardManageViewDetail;
        hreAllRewardManageKeyTask = EnumTask.KT_HreAllRewardManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllRewardManage && hreAllRewardManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreAllRewardManageViewDetail,
                                        screenName: hreAllRewardManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreAllRewardManageKeyTask}
