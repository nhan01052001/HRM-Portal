...
let configList = null,
    enumName = null,
    hreStopDisciplineManage = null,
    hreStopDisciplineManageViewDetail = null,
    hreStopDisciplineManageKeyTask = null,
    pageSizeList = 50;

class HreStopDisciplineManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreStopDisciplineManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreStopDisciplineManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreStopDisciplineManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreStopDisciplineManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreStopDisciplineManage]) {
            ConfigList.value[ScreenName.HreStopDisciplineManage] = {
                Api: {
                    urlApi: '[URI_CENTER]/api/Hre_Discipline/New_GetDisciplinePortal',
                    type: 'POST',
                    pageSize: 20
                },
                Order: [
        ...
        hreStopDisciplineManage = ScreenName.HreStopDisciplineManage;
        hreStopDisciplineManageViewDetail = ScreenName.HreDisciplineManageViewDetail;
        hreStopDisciplineManageKeyTask = EnumTask.KT_HreStopDisciplineManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreStopDisciplineManage && hreStopDisciplineManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreStopDisciplineManageViewDetail,
                                        screenName: hreStopDisciplineManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreStopDisciplineManageKeyTask}
