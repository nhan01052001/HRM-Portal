...
let configList = null,
    enumName = null,
    hreAllDisciplineManage = null,
    hreAllDisciplineManageViewDetail = null,
    hreAllDisciplineManageKeyTask = null,
    pageSizeList = 50;

class HreAllDisciplineManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllDisciplineManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreAllDisciplineManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        ...
        const _configList = configList[hreAllDisciplineManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreAllDisciplineManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreAllDisciplineManage]) {
            ConfigList.value[ScreenName.HreAllDisciplineManage] = {
                Api: {
        ...
        hreAllDisciplineManage = ScreenName.HreAllDisciplineManage;
        hreAllDisciplineManageViewDetail = ScreenName.HreDisciplineManageViewDetail;
        hreAllDisciplineManageKeyTask = EnumTask.KT_HreAllDisciplineManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllDisciplineManage && hreAllDisciplineManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreAllDisciplineManageViewDetail,
                                        screenName: hreAllDisciplineManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreAllDisciplineManageKeyTask}
