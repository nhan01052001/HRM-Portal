...
let configList = null,
    enumName = null,
    hreHireDisciplineManage = null,
    hreHireDisciplineManageViewDetail = null,
    hreHireDisciplineManageKeyTask = null,
    pageSizeList = 50;

class HreHireDisciplineManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreHireDisciplineManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreHireDisciplineManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreHireDisciplineManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreHireDisciplineManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreHireDisciplineManage]) {
            ConfigList.value[ScreenName.HreHireDisciplineManage] = {
                Api: {
        ...
        hreHireDisciplineManage = ScreenName.HreHireDisciplineManage;
        hreHireDisciplineManageViewDetail = ScreenName.HreDisciplineManageViewDetail;
        hreHireDisciplineManageKeyTask = EnumTask.KT_HreHireDisciplineManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreHireDisciplineManage && hreHireDisciplineManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreHireDisciplineManageViewDetail,
                                        screenName: hreHireDisciplineManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreHireDisciplineManageKeyTask}
