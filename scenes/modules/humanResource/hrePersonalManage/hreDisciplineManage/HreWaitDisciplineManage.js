...
let configList = null,
    enumName = null,
    hreWaitDisciplineManage = null,
    hreWaitDisciplineManageViewDetail = null,
    hreWaitDisciplineManageKeyTask = null,
    pageSizeList = 50;

class HreWaitDisciplineManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreWaitDisciplineManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreWaitDisciplineManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreWaitDisciplineManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreWaitDisciplineManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreWaitDisciplineManage]) {
            ConfigList.value[ScreenName.HreWaitDisciplineManage] = {
                Api: {
        ...
        hreWaitDisciplineManage = ScreenName.HreWaitDisciplineManage;
        hreWaitDisciplineManageViewDetail = ScreenName.HreDisciplineManageViewDetail;
        hreWaitDisciplineManageKeyTask = EnumTask.KT_HreWaitDisciplineManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreWaitDisciplineManage && hreWaitDisciplineManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreWaitDisciplineManageViewDetail,
                                        screenName: hreWaitDisciplineManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreWaitDisciplineManageKeyTask}
