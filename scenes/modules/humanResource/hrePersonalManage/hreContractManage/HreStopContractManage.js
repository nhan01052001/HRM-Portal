...
let configList = null,
    enumName = null,
    hreStopContractManage = null,
    hreStopContractManageViewDetail = null,
    hreStopContractManageKeyTask = null,
    pageSizeList = 50;

class HreStopContractManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreStopContractManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreStopContractManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreStopContractManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreStopContractManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreStopContractManage]) {
            ConfigList.value[ScreenName.HreStopContractManage] = {
                Api: {
        ...
        hreStopContractManage = ScreenName.HreStopContractManage;
        hreStopContractManageViewDetail = ScreenName.HreContractManageViewDetail;
        hreStopContractManageKeyTask = EnumTask.KT_HreStopContractManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreStopContractManage && hreStopContractManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreStopContractManageViewDetail,
                                        screenName: hreStopContractManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreStopContractManageKeyTask}
