...
let configList = null,
    enumName = null,
    hreAllContractManage = null,
    hreAllContractManageViewDetail = null,
    hreAllContractManageKeyTask = null,
    pageSizeList = 50;

class HreAllContractManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreAllContractManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreAllContractManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        ...
        const _configList = configList[hreAllContractManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreAllContractManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreAllContractManage]) {
            ConfigList.value[ScreenName.HreAllContractManage] = {
                Api: {
        ...
        hreAllContractManage = ScreenName.HreAllContractManage;
        hreAllContractManageViewDetail = ScreenName.HreContractManageViewDetail;
        hreAllContractManageKeyTask = EnumTask.KT_HreAllContractManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreAllContractManage && hreAllContractManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreAllContractManageViewDetail,
                                        screenName: hreAllContractManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreAllContractManageKeyTask}
