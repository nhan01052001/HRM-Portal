...
let configList = null,
    enumName = null,
    hreHireContractManage = null,
    hreHireContractManageViewDetail = null,
    hreHireContractManageKeyTask = null,
    pageSizeList = 50;

class HreHireContractManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreHireContractManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreHireContractManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreHireContractManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreHireContractManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreHireContractManage]) {
            ConfigList.value[ScreenName.HreHireContractManage] = {
                Api: {
        ...
        hreHireContractManage = ScreenName.HreHireContractManage;
        hreHireContractManageViewDetail = ScreenName.HreContractManageViewDetail;
        hreHireContractManageKeyTask = EnumTask.KT_HreHireContractManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreHireContractManage && hreHireContractManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreHireContractManageViewDetail,
                                        screenName: hreHireContractManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreHireContractManageKeyTask}
