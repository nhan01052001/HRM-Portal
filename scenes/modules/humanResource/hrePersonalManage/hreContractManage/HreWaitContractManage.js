...
let configList = null,
    enumName = null,
    hreWaitContractManage = null,
    hreWaitContractManageViewDetail = null,
    hreWaitContractManageKeyTask = null,
    pageSizeList = 50;

class HreWaitContractManage extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hreWaitContractManage]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hreWaitContractManageKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreWaitContractManage],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreWaitContractManageKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreWaitContractManage]) {
            ConfigList.value[ScreenName.HreWaitContractManage] = {
                Api: {
                    urlApi: '[URI_CENTER]/api/Hre_Contract/New_GetContractNewPortal',
                    type: 'POST',
                    pageSize: 20
                },
                Order: [
        ...
        hreWaitContractManage = ScreenName.HreWaitContractManage;
        hreWaitContractManageViewDetail = ScreenName.HreContractManageViewDetail;
        hreWaitContractManageKeyTask = EnumTask.KT_HreWaitContractManage;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreWaitContractManage && hreWaitContractManageViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HrePersonalManageList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hreWaitContractManageViewDetail,
                                        screenName: hreWaitContractManage
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hreWaitContractManageKeyTask}
