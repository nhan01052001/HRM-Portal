...
let configList = null,
    enumName = null,
    salSubmitPITFinalization = null,
    salSubmitPITFinalizationViewDetail = null,
    salSubmitPITFinalizationKeyTask = null,
    pageSizeList = 20;

class SalSubmitPITFinalization extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (SalSubmitPITFinalizationBusinessFunction.checkForReLoadScreen[salSubmitPITFinalization]) {
                this.reload();
            }
        });
    }
    ...
    reload = async (paramsFilter) => {
        ...
        SalSubmitPITFinalizationBusinessFunction.checkForReLoadScreen[salSubmitPITFinalization] = false;
        ...
        this.setState(
            ...
            () => {
                ...
                startTask({
                    keyTask: salSubmitPITFinalizationKeyTask,
                    payload: {
                        ...dataBody,
                        keyQuery: keyQuery,
                        isCompare: false,
    ...
    paramsDefault = () => {
        if (!configList[salSubmitPITFinalization] || 1 === 1) {
            configList[salSubmitPITFinalization] = {
                Api: {
        ...
        const _configList = configList[salSubmitPITFinalization],
            filter = _configList[enumName.E_Filter],
            renderRow = _configList[enumName.E_Row],
            dataFromParams = this.checkDataFormNotify();

        const dataRowActionAndSelected = generateRowActionAndSelected(salSubmitPITFinalization);
        let _params = {
            ...dataFromParams,
            IsPortalNew: true,
            filter: filter,
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == salSubmitPITFinalizationKeyTask) {
    ...
    componentDidMount() {
        salSubmitPITFinalization = ScreenName.SalSubmitPITFinalization;
        salSubmitPITFinalizationViewDetail = ScreenName.SalSubmitPITFinalizationViewDetail;
        salSubmitPITFinalizationKeyTask = EnumTask.KT_SalSubmitPITFinalization;
        SalSubmitPITFinalizationBusinessFunction.checkForReLoadScreen[salSubmitPITFinalization] = false;
        //set by config
        ...
        this.setState(ConfigListFilter.value[salSubmitPITFinalization] ? _paramsDefault : paramStore);
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {salSubmitPITFinalization && salSubmitPITFinalizationViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <SalPITFinalizationList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: salSubmitPITFinalizationViewDetail,
                                        screenName: salSubmitPITFinalization,
                                    ...
                                    keyDataLocal={salSubmitPITFinalizationKeyTask}
...
export default connect(mapStateToProps, null)(SalSubmitPITFinalization);
