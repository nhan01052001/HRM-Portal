...
import EvaPerformanceTargetItem from './EvaPerformanceTargetItem';
import EvaPerformanceGroupTargetItem from './EvaPerformanceGroupTargetItem';
import { ScreenName } from '../../../../../../assets/constant';

export default class EvaPerformanceTargetList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    renderItemFromScreenName = (screenName, dataProps) => {
        switch (screenName) {
            case ScreenName.EvaPerformanceGroupTarget:
                return <EvaPerformanceGroupTargetItem {...dataProps} />;
            case ScreenName.EvaPerformanceTarget:
                return <EvaPerformanceTargetItem {...dataProps} />;
            default:
                break;
        }
    };
                ...
                {isLoading ? (
                    ...
                    <FlatList
                        ...
                        renderItem={({ item, index }) => (
                            <View style={[styles.styItemcontent]}>
                                <TouchableWithoutFeedback onPress={() => this.moveToDetail(item)}>
                                    <View style={CustomStyleSheet.flex(1)}>
                                        {this.renderItemFromScreenName(screenName, {
...
const styles = StyleSheet.create({
    ...
    styLoadingView: { flex: 1, paddingVertical: styleSheets.p_10 }
});
