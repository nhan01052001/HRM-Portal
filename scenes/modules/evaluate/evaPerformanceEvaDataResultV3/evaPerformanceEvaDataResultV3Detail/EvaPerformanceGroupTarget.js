...
class EvaPerformanceGroupTarget extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null
            ...
            <SafeAreaView {...styleSafeAreaView}>
                {dataItem && (
                    <EvaPerformanceTargetList
                        detail={{
                            dataLocal: false,
                            screenName: ScreenName.EvaPerformanceGroupTarget,
                            screenDetail: ScreenName.EvaPerformanceGroupTargetViewDetail
                        }}
                        api={{
                            urlApi: '[URI_HR]/Eva_GetData/PerformanceEvaDataResultV3GetDetailGroup_Portal',
...
export default connect(mapStateToProps, mapDispatchToProps)(EvaPerformanceGroupTarget);
