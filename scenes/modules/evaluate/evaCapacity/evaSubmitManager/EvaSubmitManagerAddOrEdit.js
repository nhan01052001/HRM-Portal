...
import { IconDown, IconPublish, IconUp, IconColse } from '../../../../../constants/Icons';
...
export default class EvaSubmitManagerAddOrEdit extends Component {
    constructor(props) {
        super(props);
    ...
    getRelativeChild = () => {
        ...
        if (profileId && (type == 'E_NEW_BORN_CHILD' || type == 'E_CHILDCARECOMPENSATION')) {
            VnrLoadingSevices.show();
    ...
    handleSetState = (record, resAll) => {
        ...
        if (dataRelativeChild) {
            dataSourceRelativeChild = [...dataRelativeChild];
        }
                        ...
                        {Type.visibleConfig && Type.visible && (
                            <View style={contentViewControl}>
                                ...
                                <View style={viewControl}>
                                    <VnrPickerQuickly
                                        api={{
                                            urlApi: '[URI_SYS]/Sys_GetData/GetEnumForAtt?text=PregnancyTypeRegister&filterConfig=E_PORTAL',
                                            type: 'E_GET'
                                        }}
                                        refresh={Type.refresh}
                                        autoBind={true}
                        ...
                        >
                            <View style={stylesModalPopupBottom.viewModal}>
                                <SafeAreaView {...styleSafeAreaView} style={stylesModalPopupBottom.safeRadius}>
                                    ...
                                    <ScrollView style={styles.styViewErrorDetail}>
...
const styles = StyleSheet.create({
    styViewErrorDetail: { flexGrow: 1, flexDirection: 'column' },
