...
export default class EvaEmployeeViewDetail extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (E_KEEP_FILTER, actionIsDelete) => {
        ...
        if (actionIsDelete) {
            DrawerServices.navigate('EvaEmployee');
        } else {
    ...
    componentDidMount() {
        EvaEmployeeBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
