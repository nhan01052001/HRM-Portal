...
import { generateRowActionAndSelected, EvaEmployeeBusinessFunction } from './EvaEmployeeBusiness';
...
let configList = null,
    enumName = null,
    evaEmployee = null,
    evaEmployeeViewDetail = null,
    evaEmployeeKeyTask = null,
    pageSizeList = 20;

class EvaEmployee extends Component {
    constructor(props) {
        super(props);
    ...
    paramsDefault = () => {
        if (!configList[evaEmployee]) {
            configList[evaEmployee] = {
                Api: {
        ...
        const _configList = configList[evaEmployee],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == evaEmployeeKeyTask) {
    ...
    componentDidMount() {
        ...
        // evaEmployeeViewDetail = ScreenName.EvaEmployeeViewDetail;
        evaEmployeeViewDetail = ScreenName.EvaCapacityDetailWatting;
        evaEmployeeKeyTask = EnumTask.KT_EvaEmployee;
        EvaEmployeeBusinessFunction.setThisForBusiness(this);
    ...
    render() {
        ...
        return (
            <SafeAreaView {...styleSafeAreaView}>
                {evaEmployee && evaEmployeeViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <EvaCapacityList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: evaEmployeeViewDetail,
                                        screenName: evaEmployee
                                    }}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={evaEmployeeKeyTask}
...
export default connect(mapStateToProps, null)(EvaEmployee);
