...
export default class EvaCapacityListItemApprove extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    ...
    render() {
        ...
        if (moment(dataItem.DateStart).isSame(dataItem.DateEnd, 'day')) {
            dateLeave = (
                <View style={styles.lineLeft}>
                    <View style={styles.line_date_row}>
                        ...
                        <View style={styles.line_time_wrap}>
                            <Text style={[styleSheets.text, styles.line_value_lable]} numberOfLines={1}>
                                {dataItem.DateStart ? moment(dataItem.DateStart).format('DD/MM/YYYY') : ''}
                            </Text>
                        </View>
                    </View>
                </View>
            ...
            dateLeave = (
                <View style={styles.lineLeft}>
                    <View style={[styles.line_date_row]}>
                        <VnrText style={[styleSheets.text, styles.line_value_lable]} i18nKey={'HRM_Common_From'} />
                    ...
                    <View style={[styles.line_date_row]}>
                        <VnrText style={[styleSheets.text, styles.line_value_lable]} i18nKey={'HRM_Common_To'} />

                        <View style={[styles.line_date_row]}>
                            <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                                {dataItem.DateEnd ? moment(dataItem.DateEnd).format('DD/MM/YYYY') : ''}
                            </Text>
                        </View>
                    </View>
                </View>
        ...
        timeLeave = (
            <View style={styles.lineRight}>
                <View style={styles.line_value}>
                    <VnrText style={[styleSheets.text, styles.line_value_lable]} i18nKey={'HRM_Grade'} />
                    <View style={styles.line_time_wrap}>
                        <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                            {dataItem.TypeView != null ? dataItem.TypeView : ''}
                        </Text>
                    </View>
                </View>

                {dataItem.TypePregnancyEarlyView && (
                    <View style={styles.line_value}>
                        <VnrText style={[styleSheets.text, styles.line_value_lable]} i18nKey={'HRM_Attendance_Type'} />
                        <View style={styles.line_time_wrap}>
                            <Text numberOfLines={1} style={[styleSheets.text, styles.line_value_value]}>
                                {dataItem.TypePregnancyEarlyView != null ? dataItem.TypePregnancyEarlyView : ''}
                            </Text>
                        </View>
                    </View>
                )}
            ...
            >
                            ...
                            >
                                <View
                                    style={[
                                        ...
                                        !this.props.isSelect && styles.styIsSeleted
                                    ]}
                                >
                                    {this.props.isSelect && (
              ...
              <Text
                ...
                {dataItem.Comment != null
                  ? `${translate('E_REASON')}: ${dataItem.Comment}`
                  : `${translate('E_REASON')} : `}
              </Text>
            </View> */}
                        <View style={styles.viewStatusBottom}>
                            ...
                            >
                                ...
                                >
                                    {dataItem.StatusView ? 'Chờ đánh giá' : 'Chờ đánh giá'}
                                </Text>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    styIsSeleted: { borderColor: Colors.primary,
        borderWidth: 1
    },
    swipeable: {
        flex: 1,
