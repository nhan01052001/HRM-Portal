...
export default class EvaCapacityEmployeeViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
    ...
    onPessDelete = () => {
        // EvaCapacityDetailBusinessFunction.businessDeleteSalPaymentCost([item])
    };
    ...
    componentDidMount() {
        EvaCapacityDetailBusinessFunction.setThisForBusiness(this, true);
        this.getDataItem();
    }
                ...
                <View style={styles.styContentData}>
                    ...
                    <View style={styles.styItemData}>
                        <View style={[viewLable, CustomStyleSheet.minWidth(160)]}>
                            {timeCouse && (
                                <VnrText
                                    style={[styTextValue, styles.styTextValueCus, styles.styTextCouseTime]}
                                    i18nKey={timeCouse}
                                />
                            )}
                        </View>
        ...
        if (dataItem && dataItem.listDataCost && configListDetail) {
            contentViewDetail = (
                <View style={styleSheets.containerGrey}>
                    <ScrollView style={styles.styViewRenderDetaill}>
...
const styles = StyleSheet.create({
    styViewRenderDetaill: {
        flexGrow: 1,
        paddingTop: Size.defineHalfSpace
    },
    styTextCouseTime: { textAlign: 'left' },
    styViewRightAction: {
        maxWidth: 300,
        flexDirection: 'row',
        alignItems: 'center'
