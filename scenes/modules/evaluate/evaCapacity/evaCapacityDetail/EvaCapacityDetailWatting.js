...
let configList = null,
    enumName = null,
    evaCapacityDetailWatting = null,
    evaCapacityDetailWattingViewDetail = null,
    evaCapacityDetailWattingKeyTask = null,
    pageSizeList = 20;

class EvaCapacityDetailWatting extends Component {
    constructor(props) {
        super(props);
    ...
    reload = (paramsFilter) => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: evaCapacityDetailWattingKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        if (!configList[evaCapacityDetailWatting]) {
            configList[evaCapacityDetailWatting] = {
                Api: {
        ...
        const _configList = configList[evaCapacityDetailWatting],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == evaCapacityDetailWattingKeyTask) {
    ...
    componentDidMount() {
        ...
        enumName = EnumName;
        evaCapacityDetailWatting = ScreenName.EvaCapacityDetailWatting;
        evaCapacityDetailWattingViewDetail = ScreenName.EvaCapacityEmployeeViewDetail;
        evaCapacityDetailWattingKeyTask = EnumTask.KT_EvaCapacityDetailWatting;
    ...
    render() {
        ...
        return (
            <SafeAreaView {...styleSafeAreaView}>
                {evaCapacityDetailWatting && evaCapacityDetailWattingViewDetail && enumName && (
                    <View style={[styleSheets.container]}>
                        <VnrFilterCommon
                            dataBody={dataBody}
                            style={styleContentFilterDesign}
                            screenName={evaCapacityDetailWatting}
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <EvaCapacityList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: evaCapacityDetailWattingViewDetail,
                                        screenName: evaCapacityDetailWatting
                                    }}
                                    rowActions={rowActions}
                                    selected={selected}
                                    reloadScreenList={this.reload.bind(this)}
                                    keyDataLocal={evaCapacityDetailWattingKeyTask}
...
export default connect(mapStateToProps, null)(EvaCapacityDetailWatting);
