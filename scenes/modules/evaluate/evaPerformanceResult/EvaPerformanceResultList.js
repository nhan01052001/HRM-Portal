...
import EvaPerformanceResultItem from './EvaPerformanceResultItem';
import { EnumName, EnumStatus } from '../../../../assets/constant';
import VnrLoadingScreen from '../../../../components/VnrLoading/VnrLoadingScreen';

export default class EvaPerformanceResultList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            itemSelected: [],
