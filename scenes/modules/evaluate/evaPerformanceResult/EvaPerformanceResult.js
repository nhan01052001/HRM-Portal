...
import EvaPerformanceResultList from './EvaPerformanceResultList';
...
export default class EvaPerformanceResult extends Component {
    constructor(porps) {
        super(porps);
        this.state = {
            renderRow: null,
    ...
    generaRender = () => {
        ...
        screenName = ScreenName.EvaPerformanceResult;
        screenViewDetail = ScreenName.EvaPerformanceResultViewDetail;
                ...
                {isShowList && (
                    <View style={[styleSheets.container]}>
                        <EvaPerformanceResultList
                            ...
                            api={{
                                urlApi: '[URI_HR]/Eva_GetData/GetPerformanceByProfileProtal',
                                type: 'E_POST',
                                dataBody: {
