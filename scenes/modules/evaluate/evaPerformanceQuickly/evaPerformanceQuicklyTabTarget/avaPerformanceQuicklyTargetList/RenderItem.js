...
export default class RenderItem extends React.Component {
    ...
    setRightAction = (thisProps) => {
        ...
        dataItem.BusinessAllowAction = ['E_MODIFY_SERIES'];
        this.sheetActions = [
            {
    ...
    render() {
        ...
        let actionView = <View />,
            firstItem = null,
            listProfileName = null;

        // lấy phần tử đầu tiên
        if (dataItem && dataItem.listPerformanceQuicklyModel && dataItem.listPerformanceQuicklyModel[0]) {
            firstItem = dataItem.listPerformanceQuicklyModel[0];
            listProfileName = dataItem.listPerformanceQuicklyModel.map((item) => item.ProfileName).join(', ');
        }
            ...
            >
                ...
                >
                    ...
                    <View style={styles.contentRight}>
                        ...
                        <View style={styles.Line}>
                            <View style={styles.IconView}>
                                <VnrText i18nKey={'HRM_Tas_Task_Evaluationdate'} style={[styleSheets.lable]} />
                            </View>
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={styleSheets.text}>
                                    {moment(firstItem.DateEvaluation).format('DD/MM/YYYY')}
                                </Text>
                            </View>
                        </View>
                        ...
                        <View style={[styles.Line, CustomStyleSheet.marginBottom(0)]}>
                            <View style={styles.IconView}>
                                <VnrText i18nKey={'HRM_Common_List_Profile'} style={[styleSheets.lable]} />
                            </View>
                            <View style={styles.valueView}>
                                <Text numberOfLines={1} style={[styleSheets.text]}>
                                    {listProfileName}
