...
export default class EvaPerformanceQuicklyTargetList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
                        ...
                        renderItem={({ item, index }) => (
                            <View
                                style={[
                                    ...
                                    index == 0 ? CustomStyleSheet.marginTop(10) : CustomStyleSheet.marginTop(0)
                                ]}
                            >
                                <View
                                    style={[
...
const styles = StyleSheet.create({
    styLoadingFooter: { flex: 1, paddingVertical: styleSheets.p_10 },
    containBotton: {
        flex: 1,
