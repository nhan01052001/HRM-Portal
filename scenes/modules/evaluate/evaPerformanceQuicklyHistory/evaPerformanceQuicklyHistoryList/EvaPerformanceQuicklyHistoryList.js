...
export default class EvaPerformanceQuicklyHistoryList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    _renderLoading = () => {
        return (
            <View style={styles.styLoadingFooterView}>
    ...
    render() {
        const { dataSource, isLoading, refreshing, isPullToRefresh, isOpenAction, totalRow, messageEmptyData } =
            this.state;
...
const styles = StyleSheet.create({
    styLoadingFooterView: { flex: 1, paddingVertical: styleSheets.p_10 }
});
