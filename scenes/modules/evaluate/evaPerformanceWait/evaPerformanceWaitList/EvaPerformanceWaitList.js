...
import EvaPerformanceWaitItem from './EvaPerformanceWaitItem';
...
export default class EvaPerformanceWaitList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            itemSelected: [],
    ...
    _renderLoading = () => {
        return (
            <View style={styles.styLoadingViewFooter}>
...
const styles = StyleSheet.create({
    styLoadingViewFooter: { flex: 1, paddingVertical: styleSheets.p_10 },
    containBotton: {
        flex: 1
    },
    containerGrey: {
