...
export default class HreJobPostingListItem extends VnrRenderListItem {
                    ...
                    itemConfig?.TypeView === 'E_PROFILE' && (
                        <View style={[styles.wh56]}>
                            ...
                            <View style={[CustomStyleSheet.justifyContent('center')]}>
                                <Text numberOfLines={2} style={[styleSheets.lable, CustomStyleSheet.fontSize(16)]}>{dataItem?.TitlePosting}</Text>
