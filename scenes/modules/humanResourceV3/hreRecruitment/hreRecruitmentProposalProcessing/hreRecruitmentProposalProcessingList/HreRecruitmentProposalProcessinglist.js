...
import HreRecruitmentProposalProcessingListItem from './HreRecruitmentProposalProcessingListItem';

const heightActionBottom = 45;
export default class HreRecruitmentProposalProcessinglist extends VnrRenderList {
    remoteData = (param = {}) => {
                ...
                .then(resData => {
                    ...
                    if (res && res !== EnumName.E_EMPTYDATA) {
                        ...
                        data.map(item => {
                            ...
                            if (item.Status === 'E_WAIT_APPROVED') {
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                <TouchableWithoutFeedback>
                                    <View style={CustomStyleSheet.flex(1)}>
                                        <HreRecruitmentProposalProcessingListItem
                    ...
                    renderItem={({ item, index }) => (
                        <View style={[styles.containBotton]}>
                            ...
                            {item?.isGroup ? (
                                ...
                                >
                                    <View style={[styles.styleViewBorderButtom, CustomStyleSheet.borderBottomWidth(10), CustomStyleSheet.borderBottomColor(Colors.gray_3)]}>
                                        <View style={CustomStyleSheet.flex(1)}>
                                            <HreRecruitmentProposalProcessingListItem
                                                renderConfig={renderConfig}
                                                key={index}
