...
export default class HreProcessingCandidateApplicationsListItem extends VnrRenderListItem {
        ...
        return (
            <View
                style={[
                    styles.lineSatus,
                    {
                        backgroundColor: dataItem?.Color && this.hexToRgbA(dataItem?.Color) ? this.hexToRgbA(dataItem?.Color) : Colors.white
                    }
                ]}
            >
                <Text
        ...
        return (
            <View style={styles.styViewTop}>
                ...
                <View style={[styles.viewContentTopRight, CustomStyleSheet.justifyContent('flex-start')]}>
                    ...
                    {/* render status */}
                    {dataItem?.TagName && this.renderStatusView(dataItem, renderConfig)}
                </View>
            </View>
        )
    }
