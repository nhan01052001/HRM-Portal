...
import HreProcessingJobPostingListItem from './HreProcessingJobPostingListItem';

const heightActionBottom = 45;
export default class HreProcessingJobPostingList extends VnrRenderList {
    remoteData = (param = {}) => {
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                <TouchableWithoutFeedback>
                                    <View style={CustomStyleSheet.flex(1)}>
                                        <HreProcessingJobPostingListItem
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading = detail.screenName == ScreenName.HreDoneProcessingJobPosting
