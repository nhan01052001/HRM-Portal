...
let configList = null,
    enumName = null,
    hreDoneProcessingJobPosting = null,
    hreProcessingJobPostingViewDetail = null,
    hreDoneProcessingJobPostingKeyTask = null,
    pageSizeList = 50;

class HreDoneProcessingJobPosting extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (HreProcessingJobPostingBusiness.checkForReLoadScreen[hreDoneProcessingJobPosting]) {
                this.reload();
            }
        });
    }
    ...
    reload = (paramsFilter) => {
        ...
        HreProcessingJobPostingBusiness.checkForReLoadScreen[hreDoneProcessingJobPosting] = false;
        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: hreDoneProcessingJobPostingKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreDoneProcessingJobPosting],
        ...
        const dataRowActionAndSelected = generateRowActionAndSelected(hreDoneProcessingJobPosting);
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreDoneProcessingJobPostingKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreDoneProcessingJobPosting]) {
            ConfigList.value[ScreenName.HreDoneProcessingJobPosting] = {
                'Api': {
        ...
        hreDoneProcessingJobPosting = ScreenName.HreDoneProcessingJobPosting;
        hreProcessingJobPostingViewDetail = ScreenName.HreProcessingJobPostingViewDetail;
        hreDoneProcessingJobPostingKeyTask = EnumTask.KT_HreDoneProcessingJobPosting;
        HreProcessingJobPostingBusiness.checkForReLoadScreen[hreDoneProcessingJobPosting] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreDoneProcessingJobPosting && hreProcessingJobPostingViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HreProcessingJobPostingList
                                    ...
                                    keyDataLocal={hreDoneProcessingJobPostingKeyTask}
...
export default connect(mapStateToProps, null)(HreDoneProcessingJobPosting);
