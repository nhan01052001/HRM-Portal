...
import { IconShowDownChevron, IconShowUpChevron, IconStar } from '../../../../../constants/Icons';
import moment from 'moment';

class ViewAcademicQualificationInfo extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isShow: true
                                ...
                                <View style={styles.styRowdata} key={i}>
                                    <View style={styles.styLeftRow}>
                                        <View style={styles.circle}>
                                            <Image
                                                source={require('../../../../../assets/images/hreRecruitment/academic.png')}
                                    ...
                                    <View style={styles.styRightRow}>
                                        <View style={styles.wrapTextDateStartDateEnd_Line}>
                                            <View style={styles.wrapTextDateStartDateEnd}>
                                                ...
                                                <Text style={[styleSheets.text]}>
                                                    {value?.DateFinish
                                                        ? moment(value?.DateFinish).format('MM/YYYY')
                                                        : ''}
                                                </Text>
                                            </View>
...
export default ViewAcademicQualificationInfo;
