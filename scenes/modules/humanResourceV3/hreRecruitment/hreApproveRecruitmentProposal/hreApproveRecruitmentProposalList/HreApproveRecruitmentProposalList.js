...
import HreApproveRecruitmentProposalListItem from './HreApproveRecruitmentProposalListItem';

const heightActionBottom = 45;
export default class HreApproveRecruitmentProposalList extends VnrRenderList {
    remoteData = (param = {}) => {
                ...
                .then(resData => {
                    ...
                    if (res && res !== EnumName.E_EMPTYDATA) {
                        ...
                        data.map(item => {
                            ...
                            if (item.Status === 'E_WAITAPPROVE' || item.Status === 'E_WAIT_APPROVED') {
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                <TouchableWithoutFeedback>
                                    <View style={CustomStyleSheet.flex(1)}>
                                        <HreApproveRecruitmentProposalListItem
