...
import HrePendingApproveRecruitmentProposal from './hrePendingApproveRecruitmentProposal/HrePendingApproveRecruitmentProposal';
import HreProcesedApproveRecruitmentProposal from './hreProcesedApproveRecruitmentProposal/HreProcesedApproveRecruitmentProposal';
...
const data = [
    {
        ...
        screenName: ScreenName.HrePendingApproveRecruitmentProposal
    },
    {
        title: 'HRM_PortalApp_HreRecruitmentProposal_ProcessedApproved',
        screenName: ScreenName.HreProcesedApproveRecruitmentProposal
    }
];

//#region [tạo tab màn hình Edit (công việc, người liên quan, đánh giá)]
const TopTabHreApproveRecruitmentProposal = createMaterialTopTabNavigator(
    {
        HrePendingApproveRecruitmentProposal: {
            screen: HrePendingApproveRecruitmentProposal,
        ...
        HreProcesedApproveRecruitmentProposal: {
            screen: HreProcesedApproveRecruitmentProposal,
            navigationOptions: ({ navigation }) =>
...
export default TopTabHreApproveRecruitmentProposal;
