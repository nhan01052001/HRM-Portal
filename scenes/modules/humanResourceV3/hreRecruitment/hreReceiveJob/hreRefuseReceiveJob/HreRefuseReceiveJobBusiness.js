            ...
            _rowActions = [
                {
                    ...
                    onPress: (item, dataBody) =>
                        HreRefuseReceiveJobBusiness.businessApproveRecords(
            ...
            _selected = [
                {
                    ...
                    type: E_APPROVE,
                    onPress: (item, dataBody) =>
                        HreRefuseReceiveJobBusiness.businessApproveRecords(item, dataBody),
                    ...actionApprove
                }
            ];
        }
        ...
        if (actionRejectPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_REJECT,
                    onPress: (item, dataBody) =>
                        HreRefuseReceiveJobBusiness.businessRejectRecords(
                            Array.isArray(item) ? item : [{ ...item }],
                            dataBody
                        ),
                    ...actionReject
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    type: E_REJECT,
                    onPress: (item, dataBody) =>
                        HreRefuseReceiveJobBusiness.businessRejectRecords(item, dataBody),
                    ...actionReject
                }
            ];
        }
        ...
        if (actionCancelPer) {
            _rowActions = [
                ..._rowActions,
                {
                    ...
                    type: E_CANCEL,
                    onPress: (item, dataBody) =>
                        HreRefuseReceiveJobBusiness.businessCancelRecords(
                            Array.isArray(item) ? item : [{ ...item }],
                            dataBody
                        ),
                    ...actionCancel
            ...
            _selected = [
                ..._selected,
                {
                    ...
                    onPress: (items, dataBody) =>
                        HreRefuseReceiveJobBusiness.businessCancelRecords(items, dataBody),
                    ...actionCancel
                }
            ];
        }
...
export const HreRefuseReceiveJobBusiness = {
