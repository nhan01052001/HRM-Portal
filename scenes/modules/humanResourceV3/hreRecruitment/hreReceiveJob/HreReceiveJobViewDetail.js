...
import { generateRowActionAndSelected, HreWaitingReceiveJobBusiness } from './hreWaitingReceiveJob/HreWaitingReceiveJobBusiness';
...
export default class HreReceiveJobViewDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataItem: null,
    ...
    getDataItem = async () => {
        try {
            const _params = this.props.navigation.state.params,
                ...
                _configListDetail = ConfigListDetail.value['HreReceiveJobViewDetail'] ?? configDefault;
            // ConfigListDetail.value = {
            //     ...ConfigListDetail.value,
            //     HreReceiveJobViewDetail: [
            //         ...configDefault
            //     ],
            //     E_POSITIONAPPLIED: [
            //         ...E_POSITIONAPPLIED
