...
let configList = null,
    enumName = null,
    hrePendingRecruitmentReport = null,
    hrePendingRecruitmentReportViewDetail = null,
    hrePendingRecruitmentReportKeyTask = null,
    pageSizeList = 50;

class HrePendingRecruitmentReport extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            // if (AttSubmitWorkingOvertimeBusinessFunction.checkForReLoadScreen[hrePendingRecruitmentReport]) {
            //     this.reload();
            // } else {
            //     
            // }
    ...
    reload = paramsFilter => {
        ...
        this.setState(_paramsDefault, () => {
            ...
            startTask({
                keyTask: hrePendingRecruitmentReportKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hrePendingRecruitmentReport],
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hrePendingRecruitmentReportKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HrePendingRecruitmentReport]) {
            ConfigList.value[ScreenName.HrePendingRecruitmentReport] = {
                Api: {
        ...
        hrePendingRecruitmentReport = ScreenName.HrePendingRecruitmentReport;
        hrePendingRecruitmentReportViewDetail = ScreenName.HreRecruitmentReportViewDetail
        hrePendingRecruitmentReportKeyTask = EnumTask.KT_AttSubmitWorkingOvertime;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hrePendingRecruitmentReport && hrePendingRecruitmentReportViewDetail && enumName && (
                    <View style={[styleSheets.containerGrey]}>
                        <VnrFilterCommon
                            ...
                            screenName={hrePendingRecruitmentReport}
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <VnrRenderList
                                    detail={{
                                        dataLocal: false,
                                        screenDetail: hrePendingRecruitmentReportViewDetail,
                                        screenName: hrePendingRecruitmentReport
                                    }}
                                    scrollYAnimatedValue={this.scrollYAnimatedValue}
                                    ...
                                    keyDataLocal={hrePendingRecruitmentReportKeyTask}
