...
import { IconCancel, IconCheck, IconQrcodeSharp } from '../../../../../../constants/Icons';
import { VnrBtnCreate } from '../../../../../../componentsV3/VnrBtnCreate/VnrBtnCreate';
import HreCandidateProfileListItem from './HreCandidateProfileListItem';

const heightActionBottom = 45;
export default class HreCandidateProfileList extends VnrRenderList {
    remoteData = (param = {}) => {
    ...
    render() {
        const {
            ...
            { api, detail, rowActions, onCreate, scrollYAnimatedValue, renderConfig, onCreateQR } = this.props,
            permissionBtnCreate =
        ...
        if (isLoading) {
            let typeLoading =
                detail.screenName == ScreenName.HreProcesedProcessingCandidateApplications
                                ...
                                >
                                    <View
                                        style={[
                                            ...
                                            CustomStyleSheet.borderBottomWidth(10),
                                            CustomStyleSheet.borderBottomColor(Colors.gray_3)
                                        ]}
                                    >
                                        <View style={CustomStyleSheet.flex(1)}>
                                            <HreCandidateProfileListItem
        ...
        return (
            ...
            >
                ...
                <View>
                    ...
                    <View style={[styles.wrapBtnCreate]}>
                        <TouchableOpacity
                            style={{
                            ...
                            activeOpacity={0.7}
                            onPress={() => {
                                if (typeof onCreateQR == 'function' && onCreateQR) onCreateQR();
                            }}
                        >
                            <IconQrcodeSharp size={Size.iconSizeHeader - 6} color={Colors.white} />
                            <Text
                                style={[
                                    styleSheets.text,
                                    CustomStyleSheet.color(Colors.white),
