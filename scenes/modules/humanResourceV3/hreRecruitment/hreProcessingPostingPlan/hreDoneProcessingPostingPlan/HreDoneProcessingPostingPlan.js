...
let configList = null,
    enumName = null,
    hreDoneProcessingPostingPlan = null,
    hreProcessingPostingPlan = null,
    hreProcessingPostingPlanViewDetail = null,
    hreDoneProcessingPostingPlanKeyTask = null,
    pageSizeList = 50;

class HreDoneProcessingPostingPlan extends Component {
    constructor(props) {
        super(props);
        ...
        this.willFocusScreen = this.props.navigation.addListener('willFocus', () => {
            ...
            if (HreProcessingPostingPlanBusiness.checkForReLoadScreen[hreDoneProcessingPostingPlan]) {
                this.reload();
            }
        });
    }
    ...
    reload = (paramsFilter) => {
        ...
        HreProcessingPostingPlanBusiness.checkForReLoadScreen[hreDoneProcessingPostingPlan] = false;
        // Gửi yêu cầu lọc dữ liệu
        this.setState(_paramsDefault, () => {
            const { dataBody, keyQuery } = this.state;
            startTask({
                keyTask: hreDoneProcessingPostingPlanKeyTask,
                payload: {
                    ...dataBody,
                    keyQuery: keyQuery,
                    isCompare: false,
    ...
    paramsDefault = () => {
        const _configList = configList[hreDoneProcessingPostingPlan],
        ...
        const dataRowActionAndSelected = generateRowActionAndSelected(hreDoneProcessingPostingPlan);
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.reloadScreenName == hreDoneProcessingPostingPlanKeyTask) {
    ...
    componentDidMount() {
        if (!ConfigList.value[ScreenName.HreDoneProcessingPostingPlan]) {
            ConfigList.value[ScreenName.HreDoneProcessingPostingPlan] = {
                Api: {
        ...
        hreDoneProcessingPostingPlan = ScreenName.HreDoneProcessingPostingPlan;
        ...
        hreDoneProcessingPostingPlanKeyTask = EnumTask.KT_HreDoneProcessingPostingPlan;
        HreProcessingPostingPlanBusiness.checkForReLoadScreen[hreDoneProcessingPostingPlan] = false;
        //set by config
    ...
    render() {
        ...
        return (
            <SafeAreaViewDetail style={styleSafeAreaView.style}>
                {hreDoneProcessingPostingPlan && hreProcessingPostingPlanViewDetail && enumName && (
                        ...
                        <View style={[styleSheets.container]}>
                            {keyQuery && (
                                <HreProcessingPostingPlanList
                                    ...
                                    keyDataLocal={hreDoneProcessingPostingPlanKeyTask}
...
export default connect(mapStateToProps, null)(HreDoneProcessingPostingPlan);
