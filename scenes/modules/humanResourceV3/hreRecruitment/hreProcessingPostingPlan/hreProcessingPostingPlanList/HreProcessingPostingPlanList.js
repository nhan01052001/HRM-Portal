...
import HreProcessingPostingPlanListItem from './HreProcessingPostingPlanListItem';

const heightActionBottom = 45;
export default class HreProcessingPostingPlanList extends VnrRenderList {
    remoteData = (param = {}) => {
                            ...
                            <View style={styles.styleViewBorderButtom}>
                                <TouchableWithoutFeedback>
                                    <View style={CustomStyleSheet.flex(1)}>
                                        <HreProcessingPostingPlanListItem
    ...
    render() {
        ...
        if (isLoading) {
            let typeLoading = detail.screenName == ScreenName.HreDoneProcessingPostingPlan
        ...
        let isShowBtn =
            permissionBtnCreate &&
            (detail.screenNameRender === ScreenName.HreDoneProcessingPostingPlan ||
                detail.screenNameRender === ScreenName.HreWaitProcessingPostingPlan);
        return (
            <View
                style={[
