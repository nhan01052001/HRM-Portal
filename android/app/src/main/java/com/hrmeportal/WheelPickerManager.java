...
public class WheelPickerManager extends SimpleViewManager<LoopView> implements LoopListener{
    ...
    protected LoopView createViewInstance(ThemedReactContext context) {
        ...
        wheelPicker.setItemCount(11);
        return wheelPicker;
    }

    @ReactProp(name = "maxItemCount")
    public void setItemCount(LoopView wheelPicker, int maxItemCount) {
        if (wheelPicker!=null){
            wheelPicker.setItemCount(maxItemCount);
        }
    }
    ...
    @ReactProp(name = "maxTextHeight")
    public void setMaxTextHeight(LoopView wheelPicker, int maxTextHeight) {
        if (wheelPicker!=null){
            wheelPicker.setMaxTextHeight(maxTextHeight);
        }
    }
