    ...
    constructor(props, context) {
        ...
        this.state = {
            ...
            transformSwitch: new Animated.Value(
                props.value ? props.switchWidth / props.switchLeftPx : -props.switchWidth / props.switchRightPx
            ),
                ...
                >
                    ...
                    >
                        ...
                        {!value && renderInActiveText && (
                            <Text style={[styles.text, styles.paddingLeft, inactiveTextStyle]}>{inActiveText}</Text>
                        )}
                    </Animated.View>
                </Animated.View>
