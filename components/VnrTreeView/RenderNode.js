    ...
    render() {
        ...
        return cloneNode.hasChildren ? (
            ...
            <View style={{ marginLeft: level * 15, flexDirection: 'row' }}>
                ...
                >
                    <View style={styles.styCodeExpanded}>
                        ...
                        {cloneNode.Inactive ? (
                            <Text style={[styleSheets.text, CustomStyleSheet.color(Colors.orange)]}>{display}</Text>
                        ) : (
...
const styles = StyleSheet.create({
    ...
    styCodeExpanded : { flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }
});
