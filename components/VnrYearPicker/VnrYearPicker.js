...
export default class VnrYearPicker extends Component {
    ...
    initYears = () => {
        ...
        if (valueYear == null) {
            valueYear = parseInt(moment().format('YYYY'));
        }
        ...
        this.setDataConfirm({ data: valueYear, index: indexItemSelected });
            ...
            <View style={CustomStyleSheet.flex(1)}>
                {children ? (
                    ...
                    <TouchableOpacity
                        ...
                        disabled={disable}
                    >
                        <TouchableOpacity onPress={this.preYear} style={styles.styBntNextPre} disabled={disable}>
                            <IconBack size={Size.iconSize} color={colorItems ? colorItems : Colors.primary} />
                        </TouchableOpacity>
                        <Text style={[styleSheets.text, styles.styValuePicker, colorItems && { color: colorItems }]}>
                            {!isOnlyDisplayYear ? translate('E_YEAR') : ''} {value}
                        </Text>
                        <TouchableOpacity disabled={disable} onPress={this.nextYear} style={styles.styBntNextPre}>
                            <IconNext size={Size.iconSize} color={colorItems ? colorItems : Colors.primary} />
                        </TouchableOpacity>
                    </TouchableOpacity>
                )}
                <View style={CustomStyleSheet.flex(1)}>
