                    ...
                    listActions.map((item, index) => {
                        ...
                        switch (typeStatus) {
                            ...
                            case EnumName.E_REQUEST_CANCEL:
                                ...
                                break;
                            case EnumName.E_REQUEST_CHANGE:
                                buttonColor = Colors.purple;
                                textColor = Colors.white;
                                iconName = <IconBackRadious size={Size.iconSize} color={Colors.white} />;
                                break;
                        ...
                        //if (index <= 1) {
                        return (
                            <View style={styles.viewIcon} key={index} accessibilityLabel={`ListButtonMenuRight-${item.type}`}>
                                <TouchableOpacity
                                    onPress={() => item.onPress(_dataItem)}
                                    style={[styles.bnt_icon, { backgroundColor: buttonColor }]}
                                >
                                    <View style={styles.icon}>{iconName}</View>
                                    <Text style={[styleSheets.text, { color: textColor ? textColor : Colors.white }]}>
                                        {item.title}
                                    </Text>
                                </TouchableOpacity>
                            </View>
