...
import MedImmunizationListItem from '../../scenes/modules/generalInfo/medical/medImmunization/MedImmunizationListItem';
import MedAnnualHealthListItem from '../../scenes/modules/generalInfo/medical/medAnnualHealth/MedAnnualHealthListItem';
import MedHistoryMedicalListItem from '../../scenes/modules/generalInfo/medical/medHistoryMedical/MedHistoryMedicalListItem';
const heightActionBottom = 45;

export default class VnrListCommon extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //valueField: "ID",
    ...
    renderItemByScreen = screenName => {
        if (screenName == ScreenName.MedImmunization) {
            return MedImmunizationListItem;
        } else if (screenName == ScreenName.MedAnnualHealth) {
            return MedAnnualHealthListItem;
        } else if (screenName == ScreenName.MedHistoryMedical) {
            return MedHistoryMedicalListItem;
        }
    };
    ...
    render() {
        ...
        let RenderItem = this.renderItemByScreen(detail.screenName);
